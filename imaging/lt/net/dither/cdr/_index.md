---
title: Skirstyti CDR dokumentus per .NET 
weight: 3920
url: /lt/net/dither/cdr/ 
lang: lt
langdirlevel: 2
...
{{% blocks/products/pf/agp/content h2="Kaip suskaidyti CDR failus naudojant C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Veiksmai, kaip dither CDRs naudojant C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Dither CDR vaizdai – .NET" offSpacer="" %}}
