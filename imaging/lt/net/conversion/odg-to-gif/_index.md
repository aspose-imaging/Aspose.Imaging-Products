...
{{% blocks/products/pf/agp/feature-section-col title="Veiksmai konvertuoti ODG į GIF naudojant C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Konvertuoti ODG į GIF – .NET" offSpacer="" %}}
...
{{< blocks/imaging-app-widget
        sectionTitle="Nemokama programa konvertuoti ODG į GIF"
        appName="Conversion"
        ...
        checkFreeAppLabel="Peržiūrėkite mūsų [tiesiogines demonstracines versijas, kaip konvertuoti ODG į GIF]"
        checkFreeAppLabelUrl="(https://products.aspose.app/imaging/lt/conversion/ODG-to-GIF)"
        showPreview="true">}}
