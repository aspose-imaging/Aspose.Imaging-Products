...
{{% blocks/products/pf/agp/content h2="Kaip konvertuoti BMP į SVG naudojant C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Veiksmai konvertuoti BMP į SVG naudojant C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Konvertuoti BMP į SVG – .NET" offSpacer="" %}}
