...
{{% blocks/products/pf/agp/content h2="Kaip konvertuoti ODG į DICOM naudojant C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Veiksmai konvertuoti ODG į DICOM naudojant C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Konvertuoti ODG į DICOM – .NET" offSpacer="" %}}
