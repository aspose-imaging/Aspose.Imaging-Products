...
{{% blocks/products/pf/agp/feature-section-col title="Veiksmai konvertuoti BMP į PDF naudojant C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Konvertuoti BMP į PDF – .NET" offSpacer="" %}}
...
{{< blocks/imaging-app-widget
        sectionTitle="Nemokama programa konvertuoti BMP į PDF"
        appName="Conversion"
        ...
        checkFreeAppLabel="Peržiūrėkite mūsų [tiesiogines demonstracines versijas, kaip konvertuoti BMP į PDF]"
        checkFreeAppLabelUrl="(https://products.aspose.app/imaging/lt/conversion/BMP-to-PDF)"
        showPreview="true">}}
