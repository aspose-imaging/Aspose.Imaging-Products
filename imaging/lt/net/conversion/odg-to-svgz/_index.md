...
{{% blocks/products/pf/agp/feature-section-col title="Veiksmai konvertuoti ODG į SVGZ naudojant C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Konvertuoti ODG į SVGZ – .NET" offSpacer="" %}}
