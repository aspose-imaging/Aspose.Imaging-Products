...
{{% blocks/products/pf/agp/feature-section-col title="Veiksmai konvertuoti BMP į WEBP naudojant C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Konvertuoti BMP į WEBP – .NET" offSpacer="" %}}
...
{{< blocks/imaging-app-widget
        sectionTitle="Nemokama programa konvertuoti BMP į WEBP"
        appName="Conversion"
        ...
        checkFreeAppLabel="Peržiūrėkite mūsų [tiesiogines demonstracines versijas, kaip konvertuoti BMP į WEBP]"
        checkFreeAppLabelUrl="(https://products.aspose.app/imaging/lt/conversion/BMP-to-WEBP)"
        showPreview="true">}}
