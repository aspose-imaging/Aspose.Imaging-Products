...
{{% blocks/products/pf/agp/content h2="Kaip konvertuoti AVIF į SVGZ naudojant C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Veiksmai konvertuoti AVIF į SVGZ naudojant C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Konvertuoti AVIF į SVGZ – .NET" offSpacer="true" %}}
