...
{{% blocks/products/pf/agp/feature-section-col title="Veiksmai konvertuoti BMP į DICOM naudojant C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Konvertuoti BMP į DICOM – .NET" offSpacer="" %}}
