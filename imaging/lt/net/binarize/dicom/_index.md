---
title: Sudvejinkite DICOM dokumentus naudodami .NET 
weight: 3920
url: /lt/net/binarize/dicom/ 
lang: lt
langdirlevel: 2
locales: zh-hans,ja,it,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko,zh-hant
description: Išbandykite mūsų „On-Premise“ dokumentų API, kad sudvejintumėte DICOM failus .NET Framework, .NET Core, Windows Application, ASP.NET Web Application.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Sudvejinkite DICOM per C#" h2="Kurkite savo .NET programas, kad sudvejintumėte DICOM failus naudodami serverio API." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/imaging/aspose_imaging-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="DICOM" pfName="Aspose.Imaging" subTitlepfName="skirta .NET" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/content h2="Kaip sudvejinti DICOM failus naudojant C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Veiksmai DICOM dvejetainiam formatavimui naudojant C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Sudvejinti DICOM vaizdus – .NET" offSpacer="" %}}
