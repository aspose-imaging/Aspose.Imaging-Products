---
title: Karikatūrizuoti CDR dokumentus per .NET 
weight: 3920
url: /lt/net/cartoonify/cdr/ 
lang: lt
langdirlevel: 2
locales: zh-hans,ja,it,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko,zh-hant
description: Išbandykite mūsų „On-Premise“ dokumentų API, kad sukurtumėte „Cartoonify“ CDR failus .NET Framework, .NET Core, Windows Application, ASP.NET Web Application.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Cartoonify CDR per C#" h2="Sukurkite savo .NET programas, kad galėtumėte Cartoonify CDR failus naudodami serverio API." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/imaging/aspose_imaging-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="CDR" pfName="Aspose.Imaging" subTitlepfName="skirta .NET" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Karikatūrizavimo CDR veiksmai naudojant C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Cartoonify CDR vaizdai – .NET" offSpacer="" %}}
