---
title: Pakeiskite DIB dokumentų dydį naudodami .NET 
weight: 3920
url: /lt/net/resize/dib/ 
lang: lt
langdirlevel: 2
locales: ja,it,zh-hant,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko,zh-hans,ar,hi,th,sv,cs,uk,he
description: Išbandykite „On-Premise“ dokumentų API, kad pakeistumėte DIB failų dydį .NET Framework, .NET Core, Windows Application, ASP.NET Web Application.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Pakeiskite DIB dydį naudodami C#" h2="Sukurkite savo .NET programas, kad pakeistumėte DIB failų dydį naudodami serverio API." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/imaging/aspose_imaging-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="DIB" pfName="Aspose.Imaging" subTitlepfName="skirta .NET" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Veiksmai DIB dydžio keitimui naudojant C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Pakeisti DIB vaizdų dydį – .NET" offSpacer="" %}}
