---
title: Peržiūrėkite SVG dokumentus naudodami .NET 
weight: 3920
url: /lt/net/viewer/svg/ 
lang: lt
langdirlevel: 2
locales: zh-hans,ja,it,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko,zh-hant,ar,hi,th,sv,cs,uk,he
description: Išbandykite mūsų „On-Premise“ dokumentų API, kad peržiūrėtumėte SVG failus .NET Framework, .NET Core, Windows Application, ASP.NET Web Application.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Peržiūrėkite SVG per C#" h2="Sukurkite savo .NET programas, kad peržiūrėtumėte SVG failus naudodami serverio API." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/imaging/aspose_imaging-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="SVG" pfName="Aspose.Imaging" subTitlepfName="skirta .NET" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Veiksmai norint peržiūrėti SVG naudojant C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Peržiūrėti SVG vaizdus – .NET" offSpacer="" %}}
...
{{< blocks/imaging-app-widget
        sectionTitle="Nemokama programa, skirta peržiūrėti SVG" 
        appName="Viewer" 
        extension="SVG"
        label1="Pasirinkite arba vilkite ir numeskite SVG vaizdą" 
