---
title: Peržiūrėkite WMF dokumentus naudodami .NET 
weight: 3920
url: /lt/net/viewer/wmf/ 
lang: lt
langdirlevel: 2
...
{{% blocks/products/pf/agp/content h2="Kaip peržiūrėti WMF vaizdus naudojant C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Veiksmai norint peržiūrėti WMF naudojant C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Peržiūrėti WMF vaizdus – .NET" offSpacer="" %}}
