---
title: Peržiūrėkite DICOM dokumentus naudodami .NET 
weight: 3920
url: /lt/net/viewer/dicom/ 
lang: lt
langdirlevel: 2
...
{{< blocks/products/pf/upper-banner h1="Peržiūrėkite DICOM per C#" h2="Sukurkite savo .NET programas, kad peržiūrėtumėte DICOM failus naudodami serverio API." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/imaging/aspose_imaging-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="DICOM" pfName="Aspose.Imaging" subTitlepfName="skirta .NET" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/content h2="Kaip peržiūrėti DICOM vaizdus naudojant C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Veiksmai norint peržiūrėti DICOM naudojant C#" %}}
