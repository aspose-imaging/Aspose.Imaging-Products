...
{{% blocks/products/pf/agp/content h2="Kaip pažymėti SVG failą vandenženkliu naudojant C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Veiksmai, kaip pridėti vandenženklį prie SVG naudojant C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Vandenženklio SVG vaizdas – .NET" offSpacer="" %}}
