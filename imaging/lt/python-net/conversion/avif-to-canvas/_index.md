...
{{% blocks/products/pf/agp/feature-section-col title="Veiksmai konvertuoti AVIF į CANVAS naudojant Python" %}}
...
{{% blocks/products/pf/agp/code-block title="Konvertuoti AVIF į CANVAS – Python" offSpacer="true" %}}
