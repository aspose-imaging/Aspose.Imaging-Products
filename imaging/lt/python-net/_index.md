---
title: Python Imaging API | Aspose.Imaging, skirtas Python per .NET – pieškite manipuliuoti ir transformuoti vaizdus 
weight: 960
url: /lt/python-net/ 
lang: lt
langdirlevel: 2
locales: zh-hans,ja,it,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko,zh-hant,ar,hi,th,sv,cs,uk,he
description: Python vaizdų apdorojimo ir manipuliavimo biblioteka. Aspose.Imaging for Python per .NET leidžia kurti, įkelti, peržiūrėti, redaguoti, piešti arba konvertuoti vaizdus į kelis formatus programose be jokios vaizdų rengyklės
---
...
{{< blocks/products/pf/carousel-item h3="" description="API apžvalga." >}}
<div class="diagram1 d1-python">
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="Vaizdo Python API" src="/imaging/images/imaging/aspose_imaging-for-python-net.svg"/>
  <header>
   Aspose.Imaging
  </header>
  <footer>
...
{{< blocks/products/pf/carousel-item h3="" description="Aspose.Imaging for Python per .NET galima:" >}}
<div class="diagram1 d1-python">
 <div class="d1-row">
  <div class="d1-col d1-left">
   <header>
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="Python Vaizdo apdorojimo API" src="/imaging/images/imaging/aspose_imaging-for-python-net.svg"/>
  <header>
   Aspose.Imaging
  </header>
  <footer>
...
{{< blocks/products/pf/carousel-item h3="" description="„Aspose.Imaging“, skirta Python, palaiko įvairius vaizdų [failų formatus](https://docs.aspose.com/imaging/python-net/supported-file-formats/)." >}}
<div class="diagram1 d2 d1-python">
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="Vaizdo procesorius C# Redaguoti nuotrauką Redaguoti vaizdą" src="/imaging/images/imaging/aspose_imaging-for-python-net.svg"/>
  <header>
   Aspose.Imaging
  </header>
  <footer>
...
<div class="container-fluid features-section bg-gray singleproduct">
 ...
 <div class="row">
  <div class="container">
   <h2 class="pr-ft">
    Išplėstinės vaizdo apdorojimo API funkcijos
   </h2>
   <p>
   </p>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Kurkite, įkelkite ir redaguokite vaizdus
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
    <a href="/imaging/lt/python-net/conversion/">
     Konvertuokite vaizdus į įvairius formatus
    </a>
    </p>
   </div>
   <div class="col-lg-4">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Palaikykite animuotus kelių kadrų vaizdus
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Vienodas vaizdo puslapio (rėmo) apdorojimas
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Pieškite vaizdus naudodami grafiką (grafikos kelią ir įvairias geometrines figūras)
    </p>
   </div>
   <div class="col-lg-4">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Pieškite tekstą valdydami šrifto aspektus
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Išsaugokite SVG su įterptais arba eksportuotais šriftais
    </p>
   </div>
   <div class="col-lg-4">
    <em class="fa fa-road ico-blue fa-2x col-lg-2">
...
<div class="col-lg-12">
  <h2 class="h2title">Įvairūs vaizdo filtrai ir efektai</h2>
</div>
   <div class="col-lg-4">
   ...
   <div class="col-lg-12">
    <h2 class="h2title">
     Konvertuoti vaizdo formatus
    </h2>
    <p>
     Kartu su gausiu apdorojimo procedūrų rinkiniu, API taip pat pateikia daugybę pažangių algoritmų, todėl tai yra „viskas viename“ vaizdų konvertavimo sprendimas. Šie algoritmai yra įtraukti į specializuotas klases, kurias paprasta naudoti ir kurios gali patikimai eksportuoti vaizdus į įprastus rastrinius formatus kartu su PSD, WMF, EMF, DjVu, DICOM, DNG ir WebP formatais.
    </p>
    <p>
     Naudojant šią biblioteką formato konvertavimas yra toks pat paprastas, kaip failo plėtinio pakeitimas į norimą formatą.
    </p>
    <div class="codeblock" id="code">
     <h3>
      Išsaugokite vaizdą įvairiais formatais - Python
     </h3>
{{< gist "aspose-com-gists" "afe32f26944235686ade7c8b3c43cf30" "save-image-in-different-formats.py" >}}
   ...
   <div class="col-lg-12">
    <h2 class="h2title">
     Dinamiškai pieškite vaizdus
    </h2>
    <p>
     „Aspose.Imaging“, skirta Python, palaiko išplėstinį piešimo funkcijų rinkinį ir pagrindines funkcijas. Kūrėjai gali piešti ant vaizdo paviršiaus manipuliuodami pikselių informacija arba naudodami išplėstines funkcijas, pvz., Grafiką ir kelius.
    </p>
    <p>
     Python vaizdų biblioteka leidžia lengvai piešti linijas, kreives, stačiakampius ir kitas geometrines figūras, užpildyti uždaras formas vientisomis spalvomis arba gradientais ir tekstūromis, piešti tekstą su tikslaus šrifto valdymo parinktimis ir piešti vaizdus įkeliant esamus vaizdo duomenis.
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
    ...
    <p>
     Aspose.Imaging suteikia galimybę įkelti, redaguoti, apdoroti ir išsaugoti nuotraukas. Naudodami biblioteką galite lengvai redaguoti įkeltas nuotraukas, taikyti filtrus, manipuliuoti jomis naudodami grafiką ir kelius. Naudodami Aspose.Imaging galite lengvai filtruoti nuotraukas.
    </p>
    <div class="codeblock" id="code">
     <h3>
      Įkelkite, redaguokite, filtruokite ir išsaugokite nuotraukas - Python
     </h3>
{{< gist "aspose-com-gists" "afe32f26944235686ade7c8b3c43cf30" "load-edit-filter-save-photos.py" >}}
   ...
   <div class="col-lg-12">
    ...
    <p>
     „Aspose.Imaging“, skirta Python, palaiko suglaudintus vektorinius vaizdus. Tai vektoriniai EMF, WMF, SVG formatų vaizdai, suspausti naudojant ZIP archyvatorių. Jų dydis vidutiniškai siekia 30–70% originalo. Taip sutaupoma vietos laikmenoje ir sutrumpėja failų perdavimo tinkle laikas.
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
     Sukurkite vaizdą, manipuliuokite ir išsaugokite jį diske
    </h2>
    <p>
     Naudodami Aspose.Imaging, skirtą Python, galite lengvai kurti vaizdus su nurodytais parametrais, jais manipuliuoti ir išsaugoti.
    </p>
    <div class="codeblock" id="code">
     <h3>
      Sukurkite png vaizdą, manipuliuokite juo ir išsaugokite - Python
     </h3>
...
<h2 class="h2title">Užregistruokite pasirinktinius vaizdo failų formatus</h2>

<p>Kita daug žadanti funkcija, kurią teikia „Aspose.Imaging“, skirta Python, yra tinkintų vaizdo formatų registravimas. „Aspose.Imaging for .NET“ leidžia kūrėjams registruoti naujus pasirinktinius failų formatus, kad būtų galima kurti, atidaryti arba eksportuoti, naudojant vieną iš „Aspose.Imaging for .NET“ registro bibliotekų atitinkamoms operacijoms atlikti. Ši funkcija leidžia pridėti naujų failų formatų, kurie gali būti naudojami piešimo ir eksporto tikslais.</p>
...
{{< blocks/products/pf/slr-element name="Dokumentacija" href="https://docs.aspose.com/imaging/python-net/" >}}
{{< blocks/products/pf/slr-element name="Pirminis kodas" href="https://github.com/aspose-imaging/Aspose.Imaging-for-Python-net/" >}}
{{< blocks/products/pf/slr-element name="API nuorodos" href="https://apireference.aspose.com/python-net/imaging/" >}}
...
{{< blocks/products/pf/slr-element name="Išleidimo pastabos" href="https://releases.aspose.com/imaging/python-net/release-notes/" >}}
{{< /blocks/products/pf/slr-tab >}}

{{< blocks/products/pf/slr-tab tabTitle="Kodėl Aspose.Imaging for Python" tabId="success-stories" >}}
...
{{< blocks/products/pf/download-section downloadFreeTrialLink="https://downloads.aspose.com/imaging/python-net/" downloadFreeTrialText="Atsisiųskite nemokamą bandomąją versiją" pricingInformationText="Informacija apie kainas" pricingInformationLink="https://purchase.aspose.com/pricing/imaging/python-net/" >}}
