---
title: Peržiūrėkite CDR dokumentus naudodami Java 
weight: 3920
...
{{% blocks/products/pf/agp/feature-section-col title="Veiksmai norint peržiūrėti CDR naudojant Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Peržiūrėti CDR vaizdus – Java" offSpacer="" %}}
...
{{< blocks/imaging-app-widget
        sectionTitle="Nemokama programa, skirta peržiūrėti CDR" 
        appName="Viewer" 
        extension="CDR"
        label1="Pasirinkite arba vilkite ir numeskite CDR vaizdą" 
