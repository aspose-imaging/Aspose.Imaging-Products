---
title: Vandenženklis GIF dokumentas per Java 
weight: 3920
url: /lt/java/watermark/gif/ 
lang: lt
langdirlevel: 2
locales: zh-hans,ja,it,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko,zh-hant,ar,hi,th,sv,cs,uk,he
description: Pavyzdinis Java konvertavimo kodas iš GIF formato į  failą. Naudokite šį kodo pavyzdį, norėdami konvertuoti GIF į  bet kurioje žiniatinklio ar darbalaukio Java pagrįstoje programoje.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Pridėkite tekstinį vandens ženklą prie GIF per Java" h2="Sukurkite savo Java programas, kad galėtumėte naudoti vandenženklį GIF failams naudodami serverio API." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/imaging/aspose_imaging-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="GIF" pfName="Aspose.Imaging" subTitlepfName="skirta Java" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Veiksmai, kaip pridėti vandenženklį prie GIF naudojant Java" %}}
...
+ Išsaugokite vaizdą į diską GIF formatu
...
{{% blocks/products/pf/agp/code-block title="Vandenženklio GIF vaizdas – Java" offSpacer="" %}}
...
Aspose.Imaging API yra vaizdo apdorojimo sprendimas, skirtas kurti, modifikuoti, piešti ar konvertuoti vaizdus (nuotraukas) programose. Ji siūlo: kelių platformų vaizdo apdorojimą, įskaitant, bet tuo neapsiribojant, konvertavimą tarp įvairių vaizdo formatų (įskaitant vienodą kelių puslapių arba kelių kadrų vaizdo apdorojimą), modifikacijas, tokias kaip piešimas, darbas su grafiniais primityvais, transformacijos (keisti dydį, apkarpyti, apversti ir pasukti). , dvejetainis, pilkos spalvos tonas, koregavimas), pažangios vaizdo apdorojimo funkcijos (filtravimas, keitimas, maskavimas, iškrypimas) ir atminties optimizavimo strategijos. Tai yra atskira biblioteka ir nepriklauso nuo jokios programinės įrangos vaizdo operacijoms. Projektuose galima lengvai pridėti didelio našumo vaizdo konvertavimo funkcijų naudojant vietines API. Tai yra 100 % privačios vietinės API, o vaizdai apdorojami jūsų serveriuose.
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="Vandenženklis GIF per internetinę programą" sectionDescription="Pridėkite vandenženklį prie GIF dokumentų apsilankę [tiesioginės demonstracinės versijos svetainėje] (https://products.aspose.app/imaging/watermark). Tiesioginė demonstracinė versija turi šiuos privalumus" >}}
            ...
            {{< blocks/products/pf/agp/democard icon="fa-file-text" text="Tiesiog įkelkite GIF failą, nustatykite vandens ženklą ir paspauskite mygtuką \"Pridėti\"." >}}
