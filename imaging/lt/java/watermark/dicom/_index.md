---
title: Vandenženklis DICOM dokumentas per Java 
weight: 3920
url: /lt/java/watermark/dicom/ 
lang: lt
langdirlevel: 2
locales: zh-hans,ja,it,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko,zh-hant
description: Pavyzdinis Java konvertavimo kodas iš DICOM formato į  failą. Naudokite šį kodo pavyzdį, norėdami konvertuoti DICOM į  bet kurioje žiniatinklio ar darbalaukio Java pagrįstoje programoje.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Pridėkite tekstinį vandens ženklą prie DICOM per Java" h2="Sukurkite savo Java programas, kad galėtumėte naudoti vandenženklį DICOM failams naudodami serverio API." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/imaging/aspose_imaging-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="DICOM" pfName="Aspose.Imaging" subTitlepfName="skirta Java" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Veiksmai, kaip pridėti vandenženklį prie DICOM naudojant Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Vandenženklio DICOM vaizdas – Java" offSpacer="" %}}
