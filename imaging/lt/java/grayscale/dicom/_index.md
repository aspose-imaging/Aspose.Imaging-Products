---
title: Pilkos spalvos DICOM dokumentai per Java 
weight: 3920
url: /lt/java/grayscale/dicom/ 
lang: lt
langdirlevel: 2
locales: zh-hans,ja,it,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko,zh-hant
description: Išbandykite „On-Premise“ dokumentų API, kad galėtumėte naudoti pilkos spalvos DICOM failus .NET Framework, .NET Core, Windows Application, ASP.NET Web Application.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Pilkos spalvos DICOMs per Java" h2="Kurkite savo Java programas pilkos spalvos DICOM failams naudodami serverio API." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/imaging/aspose_imaging-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="DICOM" pfName="Aspose.Imaging" subTitlepfName="skirta Java" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/content h2="Kaip pilkos spalvos DICOM failus naudojant Java" %}}

Norėdami pilkos spalvos DICOM failus naudoti, naudosime
...
{{% blocks/products/pf/agp/feature-section-col title="Veiksmai iki pilkos spalvos DICOM per Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Pilkos spalvos DICOM vaizdai – Java" offSpacer="" %}}
