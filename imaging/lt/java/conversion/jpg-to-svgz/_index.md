...
{{% blocks/products/pf/agp/feature-section-col title="Veiksmai konvertuoti JPG į SVGZ naudojant Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Konvertuoti JPG į SVGZ – Java" offSpacer="" %}}
...
{{< blocks/imaging-app-widget
        sectionTitle="Nemokama programa konvertuoti JPG į SVGZ"
        appName="Conversion"
        ...
        checkFreeAppLabel="Peržiūrėkite mūsų [tiesiogines demonstracines versijas, kaip konvertuoti JPG į SVGZ]"
        checkFreeAppLabelUrl="(https://products.aspose.app/imaging/lt/conversion/JPG-to-SVGZ)"
        showPreview="true">}}
