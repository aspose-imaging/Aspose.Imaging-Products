...
description: „Java“ konvertavimo JPG į PNG pavyzdys. Naudokite API pavyzdinį kodą paketiniams JPG failams konvertuoti į PNG bet kurioje žiniatinklio ar darbalaukio Java pagrįstoje programoje.
---
...
{{< blocks/imaging-app-widget
        sectionTitle="Nemokama programa konvertuoti JPG į PNG"
        appName="Conversion"
        ...
        checkFreeAppLabel="Peržiūrėkite mūsų [tiesiogines demonstracines versijas, kaip konvertuoti JPG į PNG]"
        checkFreeAppLabelUrl="(https://products.aspose.app/imaging/lt/conversion/JPG-to-PNG)"
        showPreview="true">}}
