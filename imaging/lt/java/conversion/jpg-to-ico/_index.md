---
title: Konvertuoti JPG į ICO naudojant Java 
weight: 3920
url: /lt/java/conversion/jpg-to-ico/ 
lang: lt
langdirlevel: 2
locales: ja,it,zh-hant,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko,zh-hans,ar,hi,th,sv,cs,uk,he
description: „Java“ konvertavimo JPG į ICO pavyzdys. Naudokite API pavyzdinį kodą paketiniams JPG failams konvertuoti į ICO bet kurioje žiniatinklio ar darbalaukio Java pagrįstoje programoje.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Konvertuoti JPG į ICO naudojant Java" h2="Paverskite JPG į ICO naudodami savąsias Java API, nereikalaujant jokios vaizdų rengyklės ar trečiųjų šalių bibliotekų." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/imaging/aspose_imaging-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="ICO" pfName="Aspose.Imaging" subTitlepfName="skirta Java" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="APNG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Veiksmai konvertuoti JPG į ICO naudojant Java" %}}

{{% blocks/products/pf/agp/text %}}

Kūrėjai gali lengvai įkelti ir konvertuoti JPG failus į ICO naudodami tik kelias kodo eilutes.
...
{{% blocks/products/pf/agp/code-block title="Konvertuoti JPG į ICO – Java" offSpacer="" %}}
...
{{< blocks/imaging-app-widget
        sectionTitle="Nemokama programa konvertuoti JPG į ICO"
        appName="Conversion"
        ...
        checkFreeAppLabel="Peržiūrėkite mūsų [tiesiogines demonstracines versijas, kaip konvertuoti JPG į ICO]"
        checkFreeAppLabelUrl="(https://products.aspose.app/imaging/lt/conversion/JPG-to-ICO)"
        showPreview="true">}}
