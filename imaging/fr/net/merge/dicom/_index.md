---
title: Fusionner des documents DICOM via .NET 
weight: 3920
url: /fr/net/merge/dicom/ 
lang: fr
langdirlevel: 2
locales: ja,it,zh-hant,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko,zh-hans,ar,hi,th,sv,cs,uk,he
description: Essayez nos API de document sur site pour fusionner des fichiers DICOM sur .NET Framework, .NET Core, application Windows, application Web ASP.NET.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Accédez à DICOM via C#" h2="Créez vos propres applications .NET pour fusionner des fichiers DICOM à l'aide d'API côté serveur." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/imaging/aspose_imaging-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="DICOM" pfName="Aspose.Imaging" subTitlepfName="pour .NET" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour fusionner les DICOM via C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Fusionner les images DICOM - .NET" offSpacer="" %}}
...
Aspose.Imaging API est une solution de traitement d'images pour créer, modifier, dessiner ou convertir des images (photos) au sein d'applications. Il offre : le traitement d'image multiplateforme, y compris, mais sans s'y limiter, les conversions entre différents formats d'image (y compris le traitement d'image multipage ou multicadre uniforme), les modifications telles que le dessin, l'utilisation de primitives graphiques, les transformations (redimensionner, recadrer, retourner et faire pivoter , binarisation, niveaux de gris, ajustement), fonctionnalités avancées de manipulation d'images (filtrage, tramage, masquage, redressement) et stratégies d'optimisation de la mémoire. C'est une bibliothèque autonome et ne dépend d'aucun logiciel pour les opérations d'image. On peut facilement ajouter des fonctionnalités de conversion d'image hautes performances avec des API natives dans les projets. Ce sont des API sur site 100 % privées et les images sont traitées sur vos serveurs.
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="Fusionner les DICOM via l'application en ligne" sectionDescription="Fusionnez des documents DICOM en visitant notre [site Web Live Demos](https://products.aspose.app/imaging/image-merge). La démo en direct présente les avantages suivants" >}}
            {{< blocks/products/pf/agp/democard icon="fa-cogs" text="Pas besoin de télécharger ou de configurer quoi que ce soit" >}}
            {{< blocks/products/pf/agp/democard icon="fa-edit" text="Pas besoin d'écrire de code" >}}
            {{< blocks/products/pf/agp/democard icon="fa-file-text" text="Téléchargez simplement vos fichiers DICOM et cliquez sur le bouton \"Fusionner maintenant\"" >}}
