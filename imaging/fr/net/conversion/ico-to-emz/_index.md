...
{{% blocks/products/pf/agp/content h2="Comment convertir ICO en EMZ en utilisant C#" %}}

Afin de convertir ICO en EMZ, nous utiliserons
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour convertir ICO en EMZ via C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Convertir ICO en EMZ - .NET" offSpacer="" %}}
