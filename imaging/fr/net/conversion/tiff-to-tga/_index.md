---
title: Convertir TIFF en TGA via C# 
weight: 3920
url: /fr/net/conversion/tiff-to-tga/ 
lang: fr
langdirlevel: 2
locales: ja,it,zh-hant,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko,zh-hans
description: Exemple de code pour la conversion TIFF vers TGA C#. Utilisez le code d'exemple d'API pour les fichiers batch TIFF vers la conversion TGA dans VB.NET, Asp.NET ou toute application basée sur .NET.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convertir TIFF en TGA via C#" h2="Transformez TIFF en TGA à l'aide des API natives .NET sans avoir besoin d'un éditeur d'images ou de bibliothèques tierces." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/imaging/aspose_imaging-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="TGA" pfName="Aspose.Imaging" subTitlepfName="pour .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="APNG" >}}
...
{{% blocks/products/pf/agp/content h2="Comment convertir TIFF en TGA en utilisant C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour convertir TIFF en TGA via C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Convertir TIFF en TGA - .NET" offSpacer="" %}}
