---
title: Convertir ICO en DICOM via C# 
weight: 3920
url: /fr/net/conversion/ico-to-dicom/ 
lang: fr
langdirlevel: 2
locales: ja,it,zh-hant,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko,zh-hans
description: Exemple de code pour la conversion ICO vers DICOM C#. Utilisez le code d'exemple d'API pour les fichiers batch ICO vers la conversion DICOM dans VB.NET, Asp.NET ou toute application basée sur .NET.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convertir ICO en DICOM via C#" h2="Transformez ICO en DICOM à l'aide des API natives .NET sans avoir besoin d'un éditeur d'images ou de bibliothèques tierces." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/imaging/aspose_imaging-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="DICOM" pfName="Aspose.Imaging" subTitlepfName="pour .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="APNG" >}}
...
{{% blocks/products/pf/agp/content h2="Comment convertir ICO en DICOM en utilisant C#" %}}

Afin de convertir ICO en DICOM, nous utiliserons
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour convertir ICO en DICOM via C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Convertir ICO en DICOM - .NET" offSpacer="" %}}
