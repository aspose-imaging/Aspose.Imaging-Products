---
title: Convertir SVG en PDF via C# 
weight: 3920
url: /fr/net/conversion/svg-to-pdf/ 
lang: fr
langdirlevel: 2
locales: ja,it,zh-hant,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko,zh-hans,ar,hi,th,sv,cs,uk,he
description: Exemple de code pour la conversion SVG vers PDF C#. Utilisez le code d'exemple d'API pour les fichiers batch SVG vers la conversion PDF dans VB.NET, Asp.NET ou toute application basée sur .NET.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convertir SVG en PDF via C#" h2="Transformez SVG en PDF à l'aide des API natives .NET sans avoir besoin d'un éditeur d'images ou de bibliothèques tierces." logoImageSrc="/imaging/images/imaging/aspose_imaging-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="Aspose.Imaging" subTitlepfName="pour .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="APNG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour convertir SVG en PDF via C#" %}}

{{% blocks/products/pf/agp/text %}}

Les développeurs peuvent facilement charger et convertir des fichiers SVG en PDF en quelques lignes de code seulement.
...
{{< blocks/imaging-app-widget
        sectionTitle="Application gratuite pour convertir SVG en PDF"
        appName="Conversion"
        ...
        checkFreeAppLabel="Consultez nos [démos en direct pour convertir SVG en PDF]"
        checkFreeAppLabelUrl="(https://products.aspose.app/imaging/fr/conversion/SVG-to-PDF)"
        showPreview="true">}}

{{% blocks/products/pf/agp/code-block title="Convertir SVG en PDF - .NET" offSpacer="true" %}}
