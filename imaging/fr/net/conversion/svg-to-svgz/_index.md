...
{{% blocks/products/pf/agp/content h2="Comment convertir SVG en SVGZ en utilisant C#" %}}

Afin de convertir SVG en SVGZ, nous utiliserons
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour convertir SVG en SVGZ via C#" %}}

{{% blocks/products/pf/agp/text %}}

Les développeurs peuvent facilement charger et convertir des fichiers SVG en SVGZ en quelques lignes de code seulement.
...
{{% blocks/products/pf/agp/code-block title="Convertir SVG en SVGZ - .NET" offSpacer="" %}}
...
{{< blocks/imaging-app-widget
        sectionTitle="Application gratuite pour convertir SVG en SVGZ"
        appName="Conversion"
        ...
        checkFreeAppLabel="Consultez nos [démos en direct pour convertir SVG en SVGZ]"
        checkFreeAppLabelUrl="(https://products.aspose.app/imaging/fr/conversion/SVG-to-SVGZ)"
        showPreview="true">}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="/imaging/fr/net/conversion/svg-to-webp" name="WEBP" description="Image Web raster" >}}
