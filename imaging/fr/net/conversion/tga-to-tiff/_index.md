...
{{% blocks/products/pf/agp/content h2="Comment convertir TGA en TIFF en utilisant C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour convertir TGA en TIFF via C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Convertir TGA en TIFF - .NET" offSpacer="" %}}
