...
{{< blocks/imaging-app-widget
        sectionTitle="Application gratuite pour convertir SVG en TIFF"
        appName="Conversion"
        ...
        checkFreeAppLabel="Consultez nos [démos en direct pour convertir SVG en TIFF]"
        checkFreeAppLabelUrl="(https://products.aspose.app/imaging/fr/conversion/SVG-to-TIFF)"
        showPreview="true">}}
