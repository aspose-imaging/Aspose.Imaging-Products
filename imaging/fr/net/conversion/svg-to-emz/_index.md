...
{{% blocks/products/pf/agp/content h2="Comment convertir SVG en EMZ en utilisant C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour convertir SVG en EMZ via C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Convertir SVG en EMZ - .NET" offSpacer="" %}}
