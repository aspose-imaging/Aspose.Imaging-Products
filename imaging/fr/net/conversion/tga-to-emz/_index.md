...
{{% blocks/products/pf/agp/content h2="Comment convertir TGA en EMZ en utilisant C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour convertir TGA en EMZ via C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Convertir TGA en EMZ - .NET" offSpacer="" %}}
