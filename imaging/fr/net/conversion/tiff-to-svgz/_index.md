...
{{% blocks/products/pf/agp/content h2="Comment convertir TIFF en SVGZ en utilisant C#" %}}

Afin de convertir TIFF en SVGZ, nous utiliserons
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour convertir TIFF en SVGZ via C#" %}}

{{% blocks/products/pf/agp/text %}}

Les développeurs peuvent facilement charger et convertir des fichiers TIFF en SVGZ en quelques lignes de code seulement.
...
{{% blocks/products/pf/agp/code-block title="Convertir TIFF en SVGZ - .NET" offSpacer="" %}}
...
{{< blocks/imaging-app-widget
        sectionTitle="Application gratuite pour convertir TIFF en SVGZ"
        appName="Conversion"
        ...
        checkFreeAppLabel="Consultez nos [démos en direct pour convertir TIFF en SVGZ]"
        checkFreeAppLabelUrl="(https://products.aspose.app/imaging/fr/conversion/TIFF-to-SVGZ)"
        showPreview="true">}}
