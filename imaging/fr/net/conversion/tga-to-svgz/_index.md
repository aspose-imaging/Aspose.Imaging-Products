...
{{% blocks/products/pf/agp/content h2="Comment convertir TGA en SVGZ en utilisant C#" %}}

Afin de convertir TGA en SVGZ, nous utiliserons
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour convertir TGA en SVGZ via C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Convertir TGA en SVGZ - .NET" offSpacer="" %}}
