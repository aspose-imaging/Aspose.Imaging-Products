---
title: Convertir SVG en DXF via C# 
weight: 3920
url: /fr/net/conversion/svg-to-dxf/ 
lang: fr
langdirlevel: 2
locales: ja,it,zh-hant,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko,zh-hans,ar,hi,th,sv,cs,uk,he
description: Exemple de code pour la conversion SVG vers DXF C#. Utilisez le code d'exemple d'API pour les fichiers batch SVG vers la conversion DXF dans VB.NET, Asp.NET ou toute application basée sur .NET.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convertir SVG en DXF via C#" h2="Transformez SVG en DXF à l'aide des API natives .NET sans avoir besoin d'un éditeur d'images ou de bibliothèques tierces." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/imaging/aspose_imaging-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="DXF" pfName="Aspose.Imaging" subTitlepfName="pour .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="APNG" >}}
...
{{% blocks/products/pf/agp/content h2="Comment convertir SVG en DXF en utilisant C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour convertir SVG en DXF via C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Convertir SVG en DXF - .NET" offSpacer="" %}}
