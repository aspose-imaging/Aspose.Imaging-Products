...
{{< blocks/imaging-app-widget
        sectionTitle="Application gratuite pour convertir TGA en DXF"
        appName="Conversion"
        ...
        checkFreeAppLabel="Consultez nos [démos en direct pour convertir TGA en DXF]"
        checkFreeAppLabelUrl="(https://products.aspose.app/imaging/fr/conversion/TGA-to-DXF)"
        showPreview="true">}}
