---
title: Convertir TGA en JP2 via C# 
weight: 3920
url: /fr/net/conversion/tga-to-jp2/ 
lang: fr
langdirlevel: 2
locales: ja,it,zh-hant,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko,zh-hans,ar,hi,th,sv,cs,uk,he
description: Exemple de code pour la conversion TGA vers JP2 C#. Utilisez le code d'exemple d'API pour les fichiers batch TGA vers la conversion JP2 dans VB.NET, Asp.NET ou toute application basée sur .NET.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convertir TGA en JP2 via C#" h2="Transformez TGA en JP2 à l'aide des API natives .NET sans avoir besoin d'un éditeur d'images ou de bibliothèques tierces." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/imaging/aspose_imaging-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="JP2" pfName="Aspose.Imaging" subTitlepfName="pour .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="APNG" >}}
...
{{% blocks/products/pf/agp/content h2="Comment convertir TGA en JP2 en utilisant C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour convertir TGA en JP2 via C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Convertir TGA en JP2 - .NET" offSpacer="" %}}
