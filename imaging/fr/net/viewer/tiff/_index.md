---
title: Afficher les documents TIFF via .NET 
weight: 3920
url: /fr/net/viewer/tiff/ 
lang: fr
langdirlevel: 2
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour afficher les TIFF via C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Afficher les images TIFF - .NET" offSpacer="" %}}
