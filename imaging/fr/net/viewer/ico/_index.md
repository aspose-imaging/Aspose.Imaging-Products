---
title: Afficher les documents ICO via .NET 
weight: 3920
url: /fr/net/viewer/ico/ 
lang: fr
langdirlevel: 2
...
{{< blocks/products/pf/upper-banner h1="Afficher les ICO via C#" h2="Créez vos propres applications .NET pour afficher les fichiers ICO à l'aide d'API côté serveur." logoImageSrc="/imaging/images/imaging/aspose_imaging-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="ICO" pfName="Aspose.Imaging" subTitlepfName="pour .NET" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/content h2="Comment afficher des images ICO à l'aide de C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour afficher les ICO via C#" %}}
