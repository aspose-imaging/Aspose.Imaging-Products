...
description: API de bibliothèque de traitement et de manipulation d'images pour créer, modifier, dessiner ou exporter des images vers PSD BMP JPEG PNG TIFF GIF dans les applications C# ASP.NET VB.NET
---
...
{{< blocks/products/pf/carousel-item h3="" description="Aspose.Imaging pour .NET prend en charge le framework .NET et la norme .NET" >}}
<div class="diagram1 d1-net">
 <div class="d1-row">
  <div class="d1-col d1-left">
   <header>
  ...
  <div class="d1-col d1-right">
   ...
   <ul>
    ...
    <li>
     Application Linux basée sur .NET Core
    </li>
   </ul>
  </div>
  <!--/right-->
...
{{< blocks/products/pf/carousel-item h3="" description="Aspose.Imaging pour .NET prend en charge une variété d'images [formats de fichiers](https://docs.aspose.com/imaging/net/supported-file-formats/)." >}}
 ...
 <div class="row">
  <div class="container">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
    <a href="/imaging/fr/net/conversion/">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="/imaging/fr/net/change-background/">
     Changement de fond
     </a>
    </p>
   </div>
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="/imaging/fr/net/compress/">
     Compresse
     </a>
    </p>
   </div>
<div class="col-lg-4">
    ...
    <p class="col-lg-10"><a href="/imaging/fr/net/adapters/">Adapters</a></p>
   </div>    
<div class="col-lg-12">
  <h2 class="h2title">Divers filtres d'image et effets</h2>
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="/imaging/fr/net/grayscale/">
     Niveaux de gris
     </a>
    </p>
   </div>
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="/imaging/fr/net/cartoonify/">
     Caricaturer
     </a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="/imaging/fr/net/binarize/">
     Binariser
     </a>
    </p>
   </div>
   ...
   <div class="col-lg-12">
    ...
    <div class="codeblock" id="code">
     <h3>
      Enregistrer l'image dans différents formats - C#
     </h3>
{{< gist "aspose-com-gists" "38d4932ed13a06d560174ea9a85ea4cf" "save-image-in-different-formats.cs" >}}
   ...
   <div class="col-lg-12">
    ...
    <p>
     Aspose.Imaging pour .NET prend en charge un ensemble avancé de fonctionnalités de dessin ainsi que les fonctionnalités de base. Les développeurs peuvent dessiner sur la surface de l'image soit en manipulant les informations sur les pixels, soit en utilisant les fonctionnalités avancées telles que les graphiques et les chemins.
    </p>
    <p>
     La bibliothèque d'images .NET vous permet de dessiner facilement des lignes, des courbes, des rectangles et d'autres formes géométriques, de remplir des formes fermées avec des couleurs unies ou des dégradés et des textures, de dessiner du texte avec des options pour un contrôle précis de la police et de dessiner des images en chargeant des données d'image existantes.
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
    ...
    <div class="codeblock" id="code">
     <h3>
      Charger, modifier, filtrer et enregistrer des photos - C#
     </h3>
{{< gist "aspose-com-gists" "38d4932ed13a06d560174ea9a85ea4cf" "load-edit-filter-save-photos.cs" >}}
   ...
   <div class="col-lg-12">
    ...
    <p>
     En utilisant Aspose.Imaging pour .NET, vous pouvez facilement créer des images avec des paramètres spécifiés, les manipuler et les enregistrer.
    </p>
    <div class="codeblock" id="code">
     <h3>
      Créez une image png, manipulez-la et enregistrez-la - C#
     </h3>
...
{{< blocks/products/pf/slr-element name="Notes de version" href="https://releases.aspose.com/imaging/net/release-notes/" >}}
{{< /blocks/products/pf/slr-tab >}}
