---
title: Supprimer l'arrière-plan dans les documents EPS via .NET 
weight: 3920
url: /fr/net/remove-background/eps/ 
lang: fr
langdirlevel: 2
locales: ja,it,zh-hant,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko,zh-hans,ar,hi,th,sv,cs,uk,he
description: Essayez nos API de document sur site pour supprimer l'arrière-plan dans les fichiers EPS sur .NET Framework, .NET Core, Windows Application, ASP.NET Web Application.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Supprimer l'arrière-plan des EPS via C#" h2="Créez vos propres applications .NET pour supprimer l'arrière-plan des fichiers EPS à l'aide d'API côté serveur." logoImageSrc="/imaging/images/imaging/aspose_imaging-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="EPS" pfName="Aspose.Imaging" subTitlepfName="pour .NET" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/content h2="Comment supprimer l'arrière-plan dans les fichiers EPS à l'aide de C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour supprimer l'arrière-plan des EPS via C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Supprimer l'arrière-plan dans les images EPS - .NET" offSpacer="" %}}
