---
title: API de manipulation et de dessin d'images .NET Java et SharePoint 
weight: 10
url: /fr/family/ 
lang: fr
langdirlevel: 2
locales: zh-hans,ja,it,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko,zh-hant,ar,hi,th,sv,cs,uk,he
description: Créez, manipulez et convertissez des images à l'aide de la bibliothèque appropriée dans les applications .NET Java et SharePoint. Enregistrer des images aux formats PhotoShop
---

{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/upper-banner h1="API d'imagerie pour le développement multiplateforme" h2="API natives pour dessiner, manipuler, transformer et convertir des images." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/imaging/aspose_imaging.svg" pfName="Aspose.Imaging" downloadUrl="https://downloads.aspose.com/imaging/" tryOnlineUrl="" downloadFreeTrialText="Télécharger la version d'essai gratuite">}}
...
Convertissez des images dans SharePoint Foundation ou Server.
{{< /blocks/products/pf/product >}}
...
Exportez des rapports vers plusieurs formats d'image à partir de JasperReports.
{{< /blocks/products/pf/product >}}

{{< blocks/products/pf/product pfName="Aspose.Imaging for" title="Python via .NET" imgSrc="/imaging/images/imaging/aspose_imaging-for-python-net.svg" productLink="/imaging/fr/python-net/" >}}
Chargez, créez, enregistrez et manipulez différents formats de fichiers image à l'aide de Python.
{{< /blocks/products/pf/product >}}
...
{{< blocks/products/pf/slr-element name="Code source" href="https://github.com/aspose-imaging?tab=repositories" >}}
...
{{< blocks/products/pf/slr-tab tabTitle="Pourquoi la famille de produits Aspose.Imaging ?" tabId="success-stories" >}}
...
{{< blocks/products/pf/download-section downloadFreeTrialLink="https://downloads.aspose.com/imaging/" pricingInformationLink="https://purchase.aspose.com/pricing/imaging/family/" downloadFreeTrialText="Télécharger la version d'essai gratuite" pricingInformationText="Information sur les prix">}}
