---
title: Filtres d'images DICOM avec Python 
weight: 3920
url: /fr/python-net/filter/dicom/ 
lang: fr
langdirlevel: 2
locales: zh-hans,ja,it,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko,zh-hant,ar,hi,th,sv,cs,uk,he
description: Comment utiliser Python pour appliquer des filtres aux images et photos DICOM sur les applications de bureau et Web.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Utilisez Python pour appliquer des filtres aux images DICOM" h2="Créez des applications Python pour filtrer les images et les photos DICOM via les API du serveur" logoImageSrc="/imaging/images/imaging/aspose_imaging-for-python-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="DICOM" pfName="Aspose.Imaging" subTitlepfName="pour Python" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour filtrer les DICOM via Python" %}}
...
{{% blocks/products/pf/agp/code-block title="Filtrer les images DICOM - Python" offSpacer="" %}}
...
Aspose.Imaging API est une solution de traitement d'images pour créer, modifier, dessiner ou convertir des images (photos) au sein d'applications. Il offre : le traitement d'image multiplateforme, y compris, mais sans s'y limiter, les conversions entre différents formats d'image (y compris le traitement d'image multipage ou multicadre uniforme), les modifications telles que le dessin, l'utilisation de primitives graphiques, les transformations (redimensionner, recadrer, retourner et faire pivoter , binarisation, niveaux de gris, ajustement), fonctionnalités avancées de manipulation d'images (filtrage, tramage, masquage, redressement) et stratégies d'optimisation de la mémoire. C'est une bibliothèque autonome et ne dépend d'aucun logiciel pour les opérations d'image. On peut facilement ajouter des fonctionnalités de conversion d'image hautes performances avec des API natives dans les projets. Ce sont des API sur site 100 % privées et les images sont traitées sur vos serveurs.
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="Filtrer les DICOM via l'application en ligne" sectionDescription="Filtrez les documents DICOM en visitant notre [site Web Live Demos](https://products.aspose.app/imaging/image-Filter). La démo en direct présente les avantages suivants" >}}
            {{< blocks/products/pf/agp/democard icon="fa-cogs" text="Pas besoin de télécharger ou de configurer quoi que ce soit" >}}
            {{< blocks/products/pf/agp/democard icon="fa-edit" text="Pas besoin d'écrire de code" >}}
            {{< blocks/products/pf/agp/democard icon="fa-file-text" text="Téléchargez simplement vos fichiers DICOM et appuyez sur le bouton \"Filtrer maintenant\"" >}}
