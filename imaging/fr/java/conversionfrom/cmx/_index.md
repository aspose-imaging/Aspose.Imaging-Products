...
description: Aspose.Imaging peut facilement convertir de CMX vers d'autres formats à l'aide de la plate-forme Java
---

{{< blocks/products/pf/feature-page-wrap >}}
{{< blocks/products/pf/feature-page-header h1="Convertir des images à partir du format CMX à l'aide d'Aspose.Imaging pour Java" h2="Convertir du format d'image CMX vers d'autres formats à l'aide de la plate-forme Java" downloadText="Télécharger" >}}


{{% blocks/products/pf/feature-page-section  h2="Large éventail de formats d'image pouvant être convertis à partir d'images CMX à l'aide d'Aspose.Imaging pour Java" %}}
Vous pouvez convertir par programmation du format CMX vers d'autres formats disponibles en utilisant
