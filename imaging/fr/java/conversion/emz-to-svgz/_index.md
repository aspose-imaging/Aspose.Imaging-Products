...
{{% blocks/products/pf/agp/content h2="Comment convertir EMZ en SVGZ en utilisant Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour convertir EMZ en SVGZ via Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Convertir EMZ en SVGZ - Java" offSpacer="" %}}
...
{{< blocks/imaging-app-widget
        sectionTitle="Application gratuite pour convertir EMZ en SVGZ"
        appName="Conversion"
        ...
        checkFreeAppLabel="Consultez nos [démos en direct pour convertir EMZ en SVGZ]"
        checkFreeAppLabelUrl="(https://products.aspose.app/imaging/fr/conversion/EMZ-to-SVGZ)"
        showPreview="true">}}
