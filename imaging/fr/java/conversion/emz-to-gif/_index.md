...
description: Exemple de code pour la conversion Java EMZ vers GIF. Utilisez un exemple de code d'API pour la conversion par lots de fichiers EMZ en GIF dans n'importe quelle application Java Web ou de bureau.
---
