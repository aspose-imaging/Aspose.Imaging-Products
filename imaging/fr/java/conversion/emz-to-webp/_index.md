...
description: Exemple de code pour la conversion Java EMZ vers WEBP. Utilisez un exemple de code d'API pour la conversion par lots de fichiers EMZ en WEBP dans n'importe quelle application Java Web ou de bureau.
---
...
{{< blocks/imaging-app-widget
        sectionTitle="Application gratuite pour convertir EMZ en WEBP"
        appName="Conversion"
        ...
        checkFreeAppLabel="Consultez nos [démos en direct pour convertir EMZ en WEBP]"
        checkFreeAppLabelUrl="(https://products.aspose.app/imaging/fr/conversion/EMZ-to-WEBP)"
        showPreview="true">}}
