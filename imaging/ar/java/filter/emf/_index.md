---
title: تصفية المستندات EMF عبر Java 
weight: 3920
url: /ar/java/filter/emf/ 
lang: ar
langdirlevel: 2
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات تصفية EMF s عبر Java" %}}
...
{{% blocks/products/pf/agp/code-block title="تصفية الصور EMF - Java" offSpacer="" %}}
