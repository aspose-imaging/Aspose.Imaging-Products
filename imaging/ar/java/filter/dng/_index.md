---
title: تصفية المستندات DNG عبر Java 
weight: 3920
url: /ar/java/filter/dng/ 
lang: ar
langdirlevel: 2
...
{{% blocks/products/pf/agp/content h2="كيفية تصفية الملفات DNG باستخدام Java" %}}

لفلترة ملفات DNG ، سنستخدم [Aspose.Imaging for Java](https://products.aspose.com/imaging/java) API وهي واجهة برمجة تطبيقات لمعالجة الصور وتحويلها غنية بالميزات وقوية وسهلة الاستخدام لمنصة Java الأساسية. يمكنك تنزيل أحدث إصدار له مباشرةً من [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-imaging) وتثبيته داخل Maven الخاص بك مشروع قائم على أساس إضافة التكوينات التالية إلى ملف pom.xml.
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات تصفية DNG s عبر Java" %}}
...
{{% blocks/products/pf/agp/code-block title="تصفية الصور DNG - Java" offSpacer="" %}}
