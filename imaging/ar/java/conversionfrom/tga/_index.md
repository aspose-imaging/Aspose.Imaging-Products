...
description: باستخدام Aspose.Imaging ، يمكنك بسهولة التحويل من TGA إلى تنسيقات أخرى باستخدام نظام Java الأساسي
---

{{< blocks/products/pf/feature-page-wrap >}}
{{< blocks/products/pf/feature-page-header h1="تحويل ملفات الصور من TGA باستخدام Aspose.Imaging for Java" h2="قم بالتحويل من TGA إلى تنسيقات أخرى باستخدام نظام Java الأساسي" downloadText="تحميل" >}}


{{% blocks/products/pf/feature-page-section  h2="جميع تنسيقات الصور المدعومة للتحويل من TGA باستخدام Aspose.Imaging for Java" %}}
باستخدام Aspose.Imaging ، يمكنك بسهولة التحويل من TGA إلى تنسيقات أخرى مدعومة باستخدام نظام Java الأساسي.
<br/>
