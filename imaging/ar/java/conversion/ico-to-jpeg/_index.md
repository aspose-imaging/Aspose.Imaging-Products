---
title: تحويل ICO إلى JPEG عبر Java 
weight: 3920
url: /ar/java/conversion/ico-to-jpeg/ 
lang: ar
langdirlevel: 2
locales: ja,it,zh-hant,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko,zh-hans,ar,hi,th,sv,cs,uk,he
description: نموذج رمز لـ ICO إلى JPEG تحويل Java. استخدم رمز مثال API لملفات الدُفعة ICO لتحويل JPEG داخل أي تطبيق يستند إلى Web أو Desktop Java.
---
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات تحويل ICO إلى JPEG عبر Java" %}}
...
{{% blocks/products/pf/agp/code-block title="تحويل ICO إلى JPEG - Java" offSpacer="true" %}}
