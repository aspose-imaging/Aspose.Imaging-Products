...
{{% blocks/products/pf/agp/content h2="كيفية تحويل ICO إلى EMF باستخدام Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات تحويل ICO إلى EMF عبر Java" %}}
...
{{% blocks/products/pf/agp/code-block title="تحويل ICO إلى EMF - Java" offSpacer="true" %}}
