---
title: تحويل DIB إلى WMF عبر Java 
weight: 3920
url: /ar/java/conversion/dib-to-wmf/ 
lang: ar
langdirlevel: 2
locales: ja,it,zh-hant,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko,zh-hans,ar,hi,th,sv,cs,uk,he
description: نموذج رمز لـ DIB إلى WMF تحويل Java. استخدم رمز مثال API لملفات الدُفعة DIB لتحويل WMF داخل أي تطبيق يستند إلى Web أو Desktop Java.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="تحويل DIB إلى WMF عبر Java" h2="قم بتحويل DIB إلى WMF باستخدام واجهات برمجة تطبيقات Java أصلية دون الحاجة إلى أي محرر صور أو مكتبات تابعة لجهات خارجية." logoImageSrc="/imaging/images/imaging/aspose_imaging-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="WMF" pfName="Aspose.Imaging" subTitlepfName="لـ Java" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="APNG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات تحويل DIB إلى WMF عبر Java" %}}
...
{{% blocks/products/pf/agp/code-block title="تحويل DIB إلى WMF - Java" offSpacer="true" %}}
