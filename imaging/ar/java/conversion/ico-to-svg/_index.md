...
{{% blocks/products/pf/agp/feature-section-col title="خطوات تحويل ICO إلى SVG عبر Java" %}}
...
{{% blocks/products/pf/agp/code-block title="تحويل ICO إلى SVG - Java" offSpacer="true" %}}
