---
title: تحويل AVIF إلى TGA عبر C# 
weight: 3920
url: /ar/net/conversion/avif-to-tga/ 
lang: ar
langdirlevel: 2
locales: ja,it,zh-hant,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko,zh-hans,ar,hi,th,sv,cs,uk,he
description: نموذج رمز لـ AVIF لتحويل TGA C#. استخدم رمز مثال API لملفات الدُفعات AVIF لتحويل TGA داخل VB.NET أو Asp.NET أو أي تطبيق مستند إلى .NET.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="تحويل AVIF إلى TGA عبر C#" h2="قم بتحويل AVIF إلى TGA باستخدام واجهات برمجة تطبيقات .NET أصلية دون الحاجة إلى أي محرر صور أو مكتبات تابعة لجهات خارجية." logoImageSrc="/imaging/images/imaging/aspose_imaging-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="TGA" pfName="Aspose.Imaging" subTitlepfName="لـ .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="APNG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات تحويل AVIF إلى TGA عبر C#" %}}

{{% blocks/products/pf/agp/text %}}

يمكن للمطورين بسهولة تحميل وتحويل ملفات AVIF إلى TGA في بضعة أسطر من التعليمات البرمجية.
...
{{< blocks/imaging-app-widget
        sectionTitle="تطبيق مجاني لتحويل AVIF إلى TGA"
        appName="Conversion"
        ...
        checkFreeAppLabel="تحقق من [العروض التوضيحية المباشرة لتحويل AVIF إلى TGA]"
        checkFreeAppLabelUrl="(https://products.aspose.app/imaging/conversion/AVIF-to-TGA)"
        showPreview="true">}}

{{% blocks/products/pf/agp/code-block title="تحويل AVIF إلى TGA - .NET" offSpacer="true" %}}
