---
title: تحويل AVIF إلى WEBP عبر C# 
weight: 3920
url: /ar/net/conversion/avif-to-webp/ 
lang: ar
langdirlevel: 2
locales: ja,it,zh-hant,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko,zh-hans,ar,hi,th,sv,cs,uk,he
description: نموذج رمز لـ AVIF لتحويل WEBP C#. استخدم رمز مثال API لملفات الدُفعات AVIF لتحويل WEBP داخل VB.NET أو Asp.NET أو أي تطبيق مستند إلى .NET.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="تحويل AVIF إلى WEBP عبر C#" h2="قم بتحويل AVIF إلى WEBP باستخدام واجهات برمجة تطبيقات .NET أصلية دون الحاجة إلى أي محرر صور أو مكتبات تابعة لجهات خارجية." logoImageSrc="/imaging/images/imaging/aspose_imaging-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="WEBP" pfName="Aspose.Imaging" subTitlepfName="لـ .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="APNG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات تحويل AVIF إلى WEBP عبر C#" %}}
...
{{% blocks/products/pf/agp/code-block title="تحويل AVIF إلى WEBP - .NET" offSpacer="true" %}}
