...
{{% blocks/products/pf/agp/content h2="كيفية تحويل PNG إلى JPEG2000 باستخدام C#" %}}

لتحويل PNG إلى JPEG2000 ، سنستخدم [Aspose.Imaging for .NET](https://products.aspose.com/imaging/net) واجهة برمجة التطبيقات (API) وهي واجهة برمجة تطبيقات لمعالجة الصور وتحويلها غنية بالميزات وقوية وسهلة الاستخدام لمنصة C#. افتح مدير الحزم [NuGet](https://www.nuget.org/packages/aspose.imaging) ، وابحث عن
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات تحويل PNG إلى JPEG2000 عبر C#" %}}
...
{{% blocks/products/pf/agp/code-block title="تحويل PNG إلى JPEG2000 - .NET" offSpacer="" %}}
