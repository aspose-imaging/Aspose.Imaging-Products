---
title: إزالة الخلفية في مستندات EPS عبر .NET 
weight: 3920
url: /ar/net/remove-background/eps/ 
lang: ar
langdirlevel: 2
locales: ja,it,zh-hant,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko,zh-hans,ar,hi,th,sv,cs,uk,he
description: جرب واجهات برمجة تطبيقات المستندات المحلية الخاصة بنا لإزالة الخلفية في ملفات EPS على .NET Framework و .NET Core و Windows Application و ASP.NET Web Application.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="إزالة الخلفية من EPS s عبر C#" h2="أنشئ تطبيقات .NET الخاصة بك لإزالة الخلفية من ملفات EPS باستخدام واجهات برمجة التطبيقات من جانب الخادم." logoImageSrc="/imaging/images/imaging/aspose_imaging-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="EPS" pfName="Aspose.Imaging" subTitlepfName="لـ .NET" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات إزالة الخلفية من EPS s عبر C#" %}}
...
{{% blocks/products/pf/agp/code-block title="إزالة الخلفية في صور EPS - .NET" offSpacer="" %}}
