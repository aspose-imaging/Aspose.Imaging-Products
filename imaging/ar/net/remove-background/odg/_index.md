...
من أجل إزالة الخلفية في ملفات ODG ، سنستخدم [Aspose.Imaging for .NET](https://products.aspose.com/imaging/net) واجهة برمجة التطبيقات (API) وهي واجهة برمجة تطبيقات لمعالجة الصور وتحويلها غنية بالميزات وقوية وسهلة الاستخدام لمنصة C#. افتح مدير الحزم [NuGet](https://www.nuget.org/packages/aspose.imaging) ، وابحث عن
