---
title: تحويل TGA إلى J2K باستخدام Python 
weight: 3920
url: /ar/python-net/conversion/tga-to-j2k/ 
lang: ar
langdirlevel: 2
locales: ja,it,zh-hant,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko,zh-hans,ar,hi,th,sv,cs,uk,he
description: نموذج كود لـ TGA إلى J2K Python language conversion. استخدم مثال كود API المقدم لمعالجة تحويل TGA إلى J2K باستخدام أي تطبيق يستند إلى لغة Web أو Desktop Python.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="تحويل TGA إلى J2K باستخدام لغة Python" h2="قم بتحويل TGA إلى J2K باستخدام واجهات برمجة تطبيقات لغة Python الأصلية وبدون الحاجة إلى أي محرر صور أو مكتبات تابعة لجهات خارجية." logoImageSrc="/imaging/images/imaging/aspose_imaging-for-python-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="J2K" pfName="Aspose.Imaging" subTitlepfName="لـ Python" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="APNG" >}}
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل TGA إلى J2K باستخدام Python" %}}

لتحويل TGA إلى J2K ، سنستخدم [Aspose.Imaging for Python via .NET](/imaging/ar/python-net) API وهي واجهة برمجة تطبيقات لمعالجة الصور وتحويلها غنية بالميزات وقوية وسهلة الاستخدام لمنصة جافا. يمكنك تثبيته باستخدام الأمر التالي من أمر النظام الخاص بك.
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات تحويل TGA إلى J2K عبر Python" %}}
...
{{% blocks/products/pf/agp/code-block title="تحويل TGA إلى J2K - Python" offSpacer="true" %}}
