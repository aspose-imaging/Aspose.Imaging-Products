...
{{% blocks/products/pf/agp/feature-section-col title="خطوات تحويل TGA إلى JPEG2000 عبر Python" %}}
...
{{% blocks/products/pf/agp/code-block title="تحويل TGA إلى JPEG2000 - Python" offSpacer="true" %}}
