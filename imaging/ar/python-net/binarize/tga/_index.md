---
title: ترجم المستندات TGA بشكل ثنائي عبر Python 
weight: 3920
url: /ar/python-net/binarize/tga/ 
lang: ar
langdirlevel: 2
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات لثنائي TGA s عبر Python" %}}
...
{{% blocks/products/pf/agp/code-block title="ثنائية TGA الصور - Python" offSpacer="" %}}
