---
title: ترجم المستندات WMF بشكل ثنائي عبر Python 
weight: 3920
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل الملفات الثنائية إلى WMF باستخدام Python" %}}
