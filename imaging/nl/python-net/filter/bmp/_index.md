---
title: BMP Afbeeldingenfilters met Python 
weight: 3920
url: /nl/python-net/filter/bmp/ 
lang: nl
langdirlevel: 2
locales: zh-hans,ja,it,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko,zh-hant,ar,hi,th,sv,cs,uk,he
description: Hoe u Python gebruikt om filters toe te passen voor BMP afbeeldingen en foto's op desktop- en webapplicaties.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Gebruik Python om filters toe te passen voor BMP afbeeldingen" h2="Maak Python-apps om BMP afbeeldingen en foto's te filteren via server-API's" logoImageSrc="/imaging/images/imaging/aspose_imaging-for-python-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="BMP" pfName="Aspose.Imaging" subTitlepfName="voor Python" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Stappen om BMPs te filteren via Python" %}}
...
{{% blocks/products/pf/agp/code-block title="Filter BMP afbeeldingen - Python" offSpacer="" %}}
