---
title: Watermerk DIB document via Java 
weight: 3920
url: /nl/java/watermark/dib/ 
lang: nl
langdirlevel: 2
locales: zh-hans,ja,it,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko,zh-hant,ar,hi,th,sv,cs,uk,he
description: Voorbeeld Java-conversiecode voor DIB-indeling naar -bestand. Gebruik deze voorbeeldcode om DIB naar  te converteren binnen een web- of desktop-Java-toepassing.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Tekstwatermerk toevoegen aan DIB via Java" h2="Bouw uw eigen Java-apps om DIB-bestanden van een watermerk te voorzien met behulp van server-side API's." logoImageSrc="/imaging/images/imaging/aspose_imaging-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="DIB" pfName="Aspose.Imaging" subTitlepfName="voor Java" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Stappen om watermerk toe te voegen aan DIB via Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Watermerk DIB afbeelding - Java" offSpacer="" %}}
