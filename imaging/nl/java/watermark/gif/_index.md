---
title: Watermerk GIF document via Java 
weight: 3920
url: /nl/java/watermark/gif/ 
lang: nl
langdirlevel: 2
locales: zh-hans,ja,it,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko,zh-hant
description: Voorbeeld Java-conversiecode voor GIF-indeling naar -bestand. Gebruik deze voorbeeldcode om GIF naar  te converteren binnen een web- of desktop-Java-toepassing.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Tekstwatermerk toevoegen aan GIF via Java" h2="Bouw uw eigen Java-apps om GIF-bestanden van een watermerk te voorzien met behulp van server-side API's." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/imaging/aspose_imaging-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="GIF" pfName="Aspose.Imaging" subTitlepfName="voor Java" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/content h2="Hoe een GIF-bestand te watermerken met Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Stappen om watermerk toe te voegen aan GIF via Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Watermerk GIF afbeelding - Java" offSpacer="" %}}
