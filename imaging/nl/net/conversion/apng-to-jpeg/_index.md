---
title: Converteer APNG naar JPEG via C# 
weight: 3920
url: /nl/net/conversion/apng-to-jpeg/ 
lang: nl
langdirlevel: 2
locales: ja,it,zh-hant,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko,zh-hans,ar,hi,th,sv,cs,uk,he
description: Voorbeeldcode voor APNG naar JPEG C#-conversie. Gebruik API-voorbeeldcode voor batch APNG-bestanden naar JPEG-conversie binnen VB.NET, Asp.NET of een op .NET gebaseerde toepassing.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Converteer APNG naar JPEG via C#" h2="Transformeer APNG naar JPEG met behulp van native .NET API's zonder dat u een afbeeldingseditor of bibliotheken van derden nodig heeft." logoImageSrc="/imaging/images/imaging/aspose_imaging-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="JPEG" pfName="Aspose.Imaging" subTitlepfName="voor .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="APNG" >}}
...
{{% blocks/products/pf/agp/content h2="Hoe APNG naar JPEG te converteren met C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Stappen om APNG naar JPEG te converteren via C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Converteer APNG naar JPEG - .NET" offSpacer="true" %}}
