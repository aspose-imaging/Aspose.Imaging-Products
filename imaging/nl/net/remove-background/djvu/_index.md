---
title: Achtergrond verwijderen in DJVU documenten via .NET 
weight: 3920
url: /nl/net/remove-background/djvu/ 
lang: nl
langdirlevel: 2
locales: ja,it,zh-hant,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko,zh-hans,ar,hi,th,sv,cs,uk,he
description: Probeer onze On-Premise document-API's om achtergrond in DJVU-bestanden op .NET Framework, .NET Core, Windows Application, ASP.NET Web Application te verwijderen.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Achtergrond verwijderen uit DJVUs via C#" h2="Bouw uw eigen .NET-apps om achtergrond uit DJVU-bestanden te verwijderen met behulp van server-side API's." logoImageSrc="/imaging/images/imaging/aspose_imaging-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="DJVU" pfName="Aspose.Imaging" subTitlepfName="voor .NET" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Stappen om achtergrond uit DJVU's te verwijderen via C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Achtergrond verwijderen in DJVU afbeeldingen - .NET" offSpacer="" %}}
