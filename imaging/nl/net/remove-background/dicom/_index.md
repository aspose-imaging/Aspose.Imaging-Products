...
{{% blocks/products/pf/agp/feature-section-col title="Stappen om achtergrond uit DICOM's te verwijderen via C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Achtergrond verwijderen in DICOM afbeeldingen - .NET" offSpacer="" %}}
