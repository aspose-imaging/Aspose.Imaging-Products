...
{{< blocks/imaging-app-widget
        sectionTitle="WEBPをTGAに変換する無料アプリ"
        appName="Conversion"
        ...
        checkFreeAppLabel="を確認してください [WEBPをTGAに変換するライブデモ]"
        checkFreeAppLabelUrl="(https://products.aspose.app/imaging/ja/conversion/WEBP-to-TGA)"
        showPreview="true">}}

{{% blocks/products/pf/agp/code-block title="WEBPをTGAに変換します-.NET" offSpacer="true" %}}
