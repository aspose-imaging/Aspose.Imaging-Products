...
{{% blocks/products/pf/agp/code-block title="JP2をPDFに変換します-.NET" offSpacer="" %}}
...
{{< blocks/imaging-app-widget
        ...
        checkFreeAppLabel="[JP2をPDFに変換するライブデモ]を確認してください"
