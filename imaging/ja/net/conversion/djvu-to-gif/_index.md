...
{{% blocks/products/pf/agp/code-block title="DJVUをGIFに変換します-.NET" offSpacer="" %}}
...
{{< blocks/imaging-app-widget
        ...
        checkFreeAppLabel="[DJVUをGIFに変換するライブデモ]を確認してください"
