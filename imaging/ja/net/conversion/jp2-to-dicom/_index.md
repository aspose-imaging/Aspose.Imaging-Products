...
{{< blocks/imaging-app-widget
        ...
        checkFreeAppLabel="を確認してください [JP2をDICOMに変換するライブデモ]"
        checkFreeAppLabelUrl="(https://products.aspose.app/imaging/ja/conversion/JP2-to-DICOM)"
        showPreview="true">}}

{{% blocks/products/pf/agp/code-block title="JP2をDICOMに変換します-.NET" offSpacer="true" %}}
