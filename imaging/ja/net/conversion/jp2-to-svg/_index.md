...
{{% blocks/products/pf/agp/code-block title="JP2をSVGに変換します-.NET" offSpacer="" %}}
...
{{< blocks/imaging-app-widget
        ...
        checkFreeAppLabel="[JP2をSVGに変換するライブデモ]を確認してください"
