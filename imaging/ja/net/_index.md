---
title: C＃.NETクロスプラットフォームイメージライブラリAPI-Aspose 
weight: 960
url: /ja/net 
lang: ja
langdirlevel: 2
locales: zh-hans,ja,it,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko,zh-hant,ar,hi,th,sv,cs,uk,he
description: C＃ASP.NETVB.NETアプリケーション内で編集描画または画像をPSDBMP JPEG PNGTIFFGIFにエクスポートするための画像処理および操作ライブラリAPI
---

{{< blocks/products/pf/main-wrap-class>}}
{{< blocks/products/pf/upper-banner h1=".NETクロスプラットフォームライブラリ-画像処理用のAPI" h2="画像エディタを必要とせずに、画像を作成、ロード、操作、または変換します。" downloadFreeTrialText="無料トライアルをダウンロード" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/imaging/headers/aspose_imaging-for-net.svg"  pfName="Aspose.Imaging" subTitlepfName="for .NET" downloadUrl="https://downloads.aspose.com/imaging/net" >}}
...
{{< blocks/products/pf/carousel-item h3="" description="Aspose.Imaging for .NETは、.NETFrameworkと.NETStandardをサポートしています" >}}
<div class="diagram1 d1-net">
 <div class="d1-row">
  <div class="d1-col d1-left">
   <header>
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt=".NET 画像処理API" src="https://www.aspose.cloud/templates/aspose/img/products/imaging/aspose_imaging-for-net.svg"/>
  <header>
   Aspose.Imaging
  </header>
  <footer>
...
{{< blocks/products/pf/carousel-item h3="" description="Aspose.Imaging for .NET [は、さまざまな画像[ファイル形式]をサポートしています](https://docs.aspose.com/imaging/net/supported-file-formats/)." >}}
<div class="diagram1 d2 d1-net">
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="画像プロセッサC＃写真の編集画像の編集" src="https://www.aspose.cloud/templates/aspose/img/products/imaging/aspose_imaging-for-net.svg"/>
  <header>
   Aspose.Imaging
  </header>
  <footer>
 ...
 <div class="row">
  <div class="container">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
    <a href="/imaging/ja/net/conversion/">
     画像をさまざまな形式に変換する
    </a>
    </p>
   </div>
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
    <a href="/imaging/ja/net/remove-background/">
     背景を削除
    </a>
    </p>
   </div>
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="/imaging/ja/net/change-background/">
     背景を変更
     </a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="/imaging/ja/net/watermark/">
     画像に透かしを追加する
     </a>
    </p>
   </div>
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="/imaging/ja/net/compress/">
     圧縮
     </a>
    </p>
   </div>
...
<div class="col-lg-12">
  <h2 class="h2title">さまざまな画像フィルターと効果</h2>
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="/imaging/ja/net/grayscale/">
     グレースケール
     </a>
    </p>
   </div>
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="/imaging/ja/net/cartoonify/">
     漫画化
     </a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="/imaging/ja/net/binarize/">
     二値化
     </a>
    </p>
   </div>
...
<p>Aspose.Imaging for .NETが提供するもう1つの有望な機能は、カスタム画像形式を登録することです。 Aspose.Imaging for .NETを使用すると、開発者は、対応する操作にAspose.Imaging for .NETレジストリライブラリの1つを使用して、作成、開く、またはエクスポートする新しいカスタムファイル形式を登録できます。この機能により、描画およびエクスポートの目的で使用できる新しいファイル形式を追加できます。</p>
...
{{< blocks/products/pf/download-section downloadFreeTrialLink="https://downloads.aspose.com/imaging/net" downloadFreeTrialText="無料トライアルをダウンロード" pricingInformationText="価格情報" pricingInformationLink="https://purchase.aspose.com/pricing/imaging/net" >}}
