...
{{% blocks/products/pf/agp/feature-section-col title="שלבים להמרת AVIF ל-JPEG באמצעות C#" %}}
...
{{% blocks/products/pf/agp/code-block title="המר את AVIF ל-JPEG - .NET" offSpacer="true" %}}
