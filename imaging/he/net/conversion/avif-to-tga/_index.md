...
{{% blocks/products/pf/agp/feature-section-col title="שלבים להמרת AVIF ל-TGA באמצעות C#" %}}
...
{{% blocks/products/pf/agp/code-block title="המר את AVIF ל-TGA - .NET" offSpacer="true" %}}
