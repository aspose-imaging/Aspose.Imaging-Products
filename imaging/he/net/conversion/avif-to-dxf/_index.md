...
{{% blocks/products/pf/agp/feature-section-col title="שלבים להמרת AVIF ל-DXF באמצעות C#" %}}
...
{{% blocks/products/pf/agp/code-block title="המר את AVIF ל-DXF - .NET" offSpacer="true" %}}
