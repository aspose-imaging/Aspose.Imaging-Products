---
title: המר את AVIF ל-CANVAS באמצעות C# 
weight: 3920
url: /he/net/conversion/avif-to-canvas/ 
lang: he
langdirlevel: 2
locales: ja,it,zh-hant,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko,zh-hans,ar,hi,th,sv,cs,uk,he
description: קוד לדוגמה עבור המרת AVIF ל-CANVAS C#. השתמש בקוד לדוגמה של API עבור קבצי AVIF אצווה להמרה של CANVAS בתוך VB.NET, Asp.NET או כל יישום מבוסס NET.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="המר את AVIF ל-CANVAS באמצעות C#" h2="הפוך את AVIF ל-CANVAS באמצעות ממשקי API מקוריים של .NET ללא צורך בעורך תמונות או ספריות של צד שלישי." logoImageSrc="/imaging/images/imaging/aspose_imaging-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="CANVAS" pfName="Aspose.Imaging" subTitlepfName="עבור .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="APNG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="שלבים להמרת AVIF ל-CANVAS באמצעות C#" %}}
...
{{% blocks/products/pf/agp/code-block title="המר את AVIF ל-CANVAS - .NET" offSpacer="true" %}}
