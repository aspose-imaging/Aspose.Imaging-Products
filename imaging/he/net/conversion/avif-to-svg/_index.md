...
{{% blocks/products/pf/agp/feature-section-col title="שלבים להמרת AVIF ל-SVG באמצעות C#" %}}
...
{{% blocks/products/pf/agp/code-block title="המר את AVIF ל-SVG - .NET" offSpacer="true" %}}
