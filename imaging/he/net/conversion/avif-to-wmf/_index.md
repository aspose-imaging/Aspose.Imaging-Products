...
{{% blocks/products/pf/agp/feature-section-col title="שלבים להמרת AVIF ל-WMF באמצעות C#" %}}
...
{{% blocks/products/pf/agp/code-block title="המר את AVIF ל-WMF - .NET" offSpacer="true" %}}
