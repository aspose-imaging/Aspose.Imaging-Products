...
{{% blocks/products/pf/agp/feature-section-col title="שלבים להמרת AVIF ל-JP2 באמצעות C#" %}}

{{% blocks/products/pf/agp/text %}}

מפתחים יכולים לטעון ולהמיר בקלות קבצי AVIF ל-JP2 בכמה שורות קוד בלבד.
...
{{< blocks/imaging-app-widget
        sectionTitle="אפליקציה חינמית להמרת AVIF ל-JP2"
        appName="Conversion"
        ...
        checkFreeAppLabel="בדוק את [הדגמות חיות להמרת AVIF ל-JP2]"
        checkFreeAppLabelUrl="(https://products.aspose.app/imaging/conversion/AVIF-to-JP2)"
        showPreview="true">}}

{{% blocks/products/pf/agp/code-block title="המר את AVIF ל-JP2 - .NET" offSpacer="true" %}}
