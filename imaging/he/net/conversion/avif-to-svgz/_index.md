...
{{% blocks/products/pf/agp/feature-section-col title="שלבים להמרת AVIF ל-SVGZ באמצעות C#" %}}
...
{{% blocks/products/pf/agp/code-block title="המר את AVIF ל-SVGZ - .NET" offSpacer="true" %}}
