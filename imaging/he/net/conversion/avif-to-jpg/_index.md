...
{{% blocks/products/pf/agp/feature-section-col title="שלבים להמרת AVIF ל-JPG באמצעות C#" %}}
...
{{% blocks/products/pf/agp/code-block title="המר את AVIF ל-JPG - .NET" offSpacer="true" %}}
