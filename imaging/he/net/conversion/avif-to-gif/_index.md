...
{{% blocks/products/pf/agp/feature-section-col title="שלבים להמרת AVIF ל-GIF באמצעות C#" %}}
...
{{% blocks/products/pf/agp/code-block title="המר את AVIF ל-GIF - .NET" offSpacer="true" %}}
