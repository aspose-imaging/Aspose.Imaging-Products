---
title: המר את DJVU ל-DICOM באמצעות C# 
weight: 3920
url: /he/net/conversion/djvu-to-dicom/ 
lang: he
langdirlevel: 2
locales: ja,it,zh-hant,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko,zh-hans,ar,hi,th,sv,cs,uk,he
description: קוד לדוגמה עבור המרת DJVU ל-DICOM C#. השתמש בקוד לדוגמה של API עבור קבצי DJVU אצווה להמרה של DICOM בתוך VB.NET, Asp.NET או כל יישום מבוסס NET.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="המר את DJVU ל-DICOM באמצעות C#" h2="הפוך את DJVU ל-DICOM באמצעות ממשקי API מקוריים של .NET ללא צורך בעורך תמונות או ספריות של צד שלישי." logoImageSrc="/imaging/images/imaging/aspose_imaging-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="DICOM" pfName="Aspose.Imaging" subTitlepfName="עבור .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="APNG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="שלבים להמרת DJVU ל-DICOM באמצעות C#" %}}
...
{{% blocks/products/pf/agp/code-block title="המר את DJVU ל-DICOM - .NET" offSpacer="true" %}}
