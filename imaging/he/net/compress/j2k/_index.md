---
title: דחוס מסמכים J2K באמצעות .NET 
weight: 3920
url: /he/net/compress/j2k/ 
lang: he
langdirlevel: 2
locales: ja,it,zh-hant,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko,zh-hans,ar,hi,th,sv,cs,uk,he
description: נסה את ממשקי ה-API של מסמכים מקומיים כדי לדחוס קבצי J2K ב-.NET Framework, .NET Core, Windows Application, ASP.NET Web Application.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="דחוס J2K באמצעות C#" h2="בנה יישומי .NET משלך כדי לדחוס קבצים של J2K באמצעות ממשקי API בצד השרת." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/imaging/aspose_imaging-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="J2K" pfName="Aspose.Imaging" subTitlepfName="עבור .NET" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/content h2="כיצד לדחוס קבצים J2K באמצעות C#" %}}

על מנת לדחוס קבצים J2K, נשתמש [Aspose.Imaging for .NET](https://products.aspose.com/imaging/net) API שהוא עשיר בתכונות, חזק וקל לשימוש למניפולציה והמרה של תמונות עבור פלטפורמת C#. פתח את מנהל החבילות [NuGet](https://www.nuget.org/packages/aspose.imaging), חפש את
...
{{% blocks/products/pf/agp/feature-section-col title="שלבים לדחיסת J2Ks באמצעות C#" %}}
...
{{% blocks/products/pf/agp/code-block title="דחוס תמונות J2K - .NET" offSpacer="" %}}
