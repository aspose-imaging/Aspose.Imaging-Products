---
title: שנה רקע במסמכי DICOM באמצעות .NET 
weight: 3920
url: /he/net/change-background/dicom/ 
lang: he
langdirlevel: 2
locales: ja,it,zh-hant,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko,zh-hans,ar,hi,th,sv,cs,uk,he
description: נסה את ממשקי ה-API של מסמכים מקומיים כדי לשנות רקע מקבצי DICOM ב-.NET Framework, .NET Core, Windows Application, ASP.NET Web Application.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="שנה רקע ב-DICOM באמצעות C#" h2="בנה יישומי .NET משלך כדי לשנות רקע בקבצי DICOM באמצעות ממשקי API בצד השרת." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/imaging/aspose_imaging-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="DICOM" pfName="Aspose.Imaging" subTitlepfName="עבור .NET" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/content h2="כיצד לשנות רקע בקבצים DICOM באמצעות C#" %}}

כדי לשנות רקע בקבצי DICOM, נשתמש [Aspose.Imaging for .NET](https://products.aspose.com/imaging/net) API שהוא עשיר בתכונות, חזק וקל לשימוש למניפולציה והמרה של תמונות עבור פלטפורמת C#. פתח את מנהל החבילות [NuGet](https://www.nuget.org/packages/aspose.imaging), חפש את
...
{{% blocks/products/pf/agp/feature-section-col title="שלבים לשינוי הרקע ב-DICOM באמצעות C#" %}}
...
{{% blocks/products/pf/agp/code-block title="שנה רקע בתמונות DICOM - .NET" offSpacer="" %}}
...
Aspose.Imaging API הוא פתרון לעיבוד תמונה ליצירה, שינוי, ציור או המרת תמונות (תמונות) בתוך יישומים. הוא מציע: עיבוד תמונה חוצה פלטפורמות, כולל אך לא רק המרות בין פורמטים שונים של תמונה (כולל עיבוד תמונה אחיד מרובה עמודים או ריבוי מסגרות), שינויים כגון ציור, עבודה עם פרימיטיבים גרפיים, טרנספורמציות (שינוי גודל, חיתוך, הפוך וסיבוב , בינאריזציה, גווני אפור, התאמה), תכונות מתקדמות של מניפולציה של תמונות (סינון, שיטוט, מיסוך, ביטול הטיה) ואסטרטגיות אופטימיזציה של זיכרון. זוהי ספרייה עצמאית ואינה תלויה בתוכנה כלשהי לפעולות תמונה. אפשר להוסיף בקלות תכונות המרת תמונה בעלות ביצועים גבוהים עם ממשקי API מקוריים בתוך פרויקטים. אלו הם 100% ממשקי API פרטיים מקומיים ותמונות מעובדות בשרתים שלך.
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="שנה רקע ב-DICOM באמצעות אפליקציה מקוונת" sectionDescription="שנה רקע במסמכים של DICOM על ידי ביקור ב[אתר ההדגמות החיות] שלנו (https://products.aspose.app/imaging/remove-background). להדגמה החיה יש את היתרונות הבאים" >}}
            ...
            {{< blocks/products/pf/agp/democard icon="fa-file-text" text="פשוט העלה את קבצי DICOM שלך ולחץ על הלחצן  שנה רקע עכשיו." >}}
