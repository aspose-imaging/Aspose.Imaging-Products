...
description: צור מניפולציות והמר תמונות באמצעות ספרייה רלוונטית בתוך יישומי .NET Java ו-SharePoint. שמור תמונות בפורמטים של PhotoShop
---
...
{{< blocks/products/pf/product pfName="Aspose.Imaging for" title=".NET" imgSrc="https://www.aspose.cloud/templates/aspose/img/products/imaging/aspose_imaging-for-net.svg" productLink="/imaging/he/net/" >}}
מקד ל-Windows Forms, ASP.NET, WPF, WCF או כל סוג של יישום המבוסס על .NET Framework 2.0 ואילך.
...
ממשקי API מקוריים של Java למחשב שולחני, אינטרנט או כל סוג של יישום המבוסס על Java SE או EE.
{{< /blocks/products/pf/product >}}
...
המר תמונות ב-SharePoint Foundation או בשרת.
{{< /blocks/products/pf/product >}}
