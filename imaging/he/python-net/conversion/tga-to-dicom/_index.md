---
title: המר את TGA ל-DICOM באמצעות Python 
weight: 3920
url: /he/python-net/conversion/tga-to-dicom/ 
lang: he
langdirlevel: 2
locales: ja,it,zh-hant,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko,zh-hans,ar,hi,th,sv,cs,uk,he
description: קוד לדוגמה עבור המרת שפת TGA ל-DICOM Python. השתמש בקוד דוגמה של ממשק API המוצג כדי לעבד המרה של TGA ל-DICOM באמצעות כל יישום מבוסס שפת אינטרנט או Desktop Python.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="המר את TGA ל-DICOM באמצעות השפה Python" h2="שנה את TGA ל-DICOM באמצעות ממשקי API של שפת Python מקורית וללא צורך בכל עורך תמונות או ספריות של צד שלישי." logoImageSrc="/imaging/images/imaging/aspose_imaging-for-python-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="DICOM" pfName="Aspose.Imaging" subTitlepfName="עבור Python" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="APNG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="שלבים להמרת TGA ל-DICOM באמצעות Python" %}}

{{% blocks/products/pf/agp/text %}}

מפתחים יכולים לטעון ולהמיר בקלות קבצי TGA ל-DICOM בכמה שורות קוד בלבד.
...
{{< blocks/imaging-app-widget
        sectionTitle="אפליקציה חינמית להמרת TGA ל-DICOM"
        appName="Conversion"
        ...
        checkFreeAppLabel="בדוק את [הדגמות חיות להמרת TGA ל-DICOM]"
        checkFreeAppLabelUrl="(https://products.aspose.app/imaging/conversion/TGA-to-DICOM)"
        showPreview="true">}}

{{% blocks/products/pf/agp/code-block title="המר את TGA ל-DICOM - Python" offSpacer="true" %}}
