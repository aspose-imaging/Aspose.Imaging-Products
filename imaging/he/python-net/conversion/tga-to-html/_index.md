...
{{% blocks/products/pf/agp/feature-section-col title="שלבים להמרת TGA ל-HTML באמצעות Python" %}}
...
{{% blocks/products/pf/agp/code-block title="המר את TGA ל-HTML - Python" offSpacer="true" %}}
