...
{{% blocks/products/pf/agp/feature-section-col title="שלבים להמרת J2K ל-HTML באמצעות Python" %}}
...
{{% blocks/products/pf/agp/code-block title="המר את J2K ל-HTML - Python" offSpacer="true" %}}
