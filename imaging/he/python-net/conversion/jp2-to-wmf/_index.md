---
title: המר את JP2 ל-WMF באמצעות Python 
weight: 3920
url: /he/python-net/conversion/jp2-to-wmf/ 
lang: he
langdirlevel: 2
locales: ja,it,zh-hant,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko,zh-hans,ar,hi,th,sv,cs,uk,he
description: קוד לדוגמה עבור המרת שפת JP2 ל-WMF Python. השתמש בקוד דוגמה של ממשק API המוצג כדי לעבד המרה של JP2 ל-WMF באמצעות כל יישום מבוסס שפת אינטרנט או Desktop Python.
---
...
{{% blocks/products/pf/agp/content h2="כיצד להמיר JP2 ל-WMF באמצעות Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="שלבים להמרת JP2 ל-WMF באמצעות Python" %}}
...
{{% blocks/products/pf/agp/code-block title="המר את JP2 ל-WMF - Python" offSpacer="true" %}}
