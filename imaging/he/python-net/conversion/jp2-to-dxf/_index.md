---
title: המר את JP2 ל-DXF באמצעות Python 
weight: 3920
url: /he/python-net/conversion/jp2-to-dxf/ 
lang: he
langdirlevel: 2
locales: ja,it,zh-hant,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko,zh-hans,ar,hi,th,sv,cs,uk,he
description: קוד לדוגמה עבור המרת שפת JP2 ל-DXF Python. השתמש בקוד דוגמה של ממשק API המוצג כדי לעבד המרה של JP2 ל-DXF באמצעות כל יישום מבוסס שפת אינטרנט או Desktop Python.
---
...
{{% blocks/products/pf/agp/content h2="כיצד להמיר JP2 ל-DXF באמצעות Python" %}}

כדי להמיר את JP2 ל-DXF, נשתמש [Aspose.Imaging for Python דרך NET](/imaging/he/python-net) API שהוא עשיר בתכונות, חזק וקל לשימוש למניפולציה והמרה של תמונות API עבור פלטפורמת Python. אתה יכול להתקין אותו באמצעות הפקודה הבאה מפקודת המערכת שלך.
