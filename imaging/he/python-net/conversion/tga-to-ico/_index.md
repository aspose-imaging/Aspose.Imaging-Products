---
title: המר את TGA ל-ICO באמצעות Python 
weight: 3920
url: /he/python-net/conversion/tga-to-ico/ 
lang: he
langdirlevel: 2
locales: ja,it,zh-hant,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko,zh-hans,ar,hi,th,sv,cs,uk,he
description: קוד לדוגמה עבור המרת שפת TGA ל-ICO Python. השתמש בקוד דוגמה של ממשק API המוצג כדי לעבד המרה של TGA ל-ICO באמצעות כל יישום מבוסס שפת אינטרנט או Desktop Python.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="המר את TGA ל-ICO באמצעות השפה Python" h2="שנה את TGA ל-ICO באמצעות ממשקי API של שפת Python מקורית וללא צורך בכל עורך תמונות או ספריות של צד שלישי." logoImageSrc="/imaging/images/imaging/aspose_imaging-for-python-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="ICO" pfName="Aspose.Imaging" subTitlepfName="עבור Python" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="APNG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="שלבים להמרת TGA ל-ICO באמצעות Python" %}}
...
{{% blocks/products/pf/agp/code-block title="המר את TGA ל-ICO - Python" offSpacer="true" %}}
