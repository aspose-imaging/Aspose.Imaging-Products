---
title: תמונות לְהַסֵס באמצעות Python 
weight: 3920
url: /he/python-net/dither/ 
lang: he
langdirlevel: 2
locales: zh-hans,ja,it,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko,zh-hant,ar,hi,th,sv,cs,uk,he
description: החלת ספריית Aspose.Imaging על תמונות ותמונות של לְהַסֵס באמצעות יישומי Python וממשקי API משלך של שרת.
---

{{< blocks/products/pf/feature-page-wrap >}}
{{< blocks/products/pf/feature-page-header h1="השתמש ב-Python עבור פעולת לְהַסֵס בתמונות" h2="תמונות לְהַסֵס באמצעות יישומי Python משלך באמצעות ספריית Aspose.Imaging" downloadText="הורד" >}}


{{% blocks/products/pf/feature-page-section  h2="החל את פעולת לְהַסֵס על כל פורמטי התמונה הזמינים" %}}
<p align="justify" style="text-indent:2em;font-size:15px;">
דיטה בתחום הגרפיקה הממוחשבת משמשת מעצבים כדי להשיג אפקט צבע בולט יותר במערכות עם פלטת צבעים מוגבלת. בתמונה מוחלקת, פיקסלים צבעוניים מהפלטה הזמינה משמשים להערכת צבעים חסרים, ויוצרים רושם של מיזוג צבעים. לעתים קרובות, אתה יכול להבחין בגרעיניות או דפוס נקודות מובהק בתמונות כאלה, במיוחד בעת שימוש בפלטות עם מספר מוגבל של צבעים. פעולת ה-dither מופעלת כדי להוסיף רעש או דפוסים לתמונה, ולעתים קרובות דפוס זה נראה בקלות. הוכח שבמקרים כאלה, השימוש ברעש כחול לדיטהינג הוא האופטימלי ביותר. Aspose.Imaging מאפשרת החלקת תמונה באמצעות אלגוריתמים שונים הניתנים לבחירה בהתאם להעדפותיך.
</p>
<p align="justify" style="text-indent:2em;font-size:15px;">
באמצעות ספריית Aspose.Imaging עבור Python, אתה יכול לבצע בקלות את פעולת <b>לְהַסֵס</b> עבור תמונות ותמונות בפורמטים שונים באופן פרוגרמטי.
</p>
<h3 style="margin-top:16px;">
בחר פורמט תמונה מהרשימה עבור הפעולה לְהַסֵס:
</h3>
<hr/>
