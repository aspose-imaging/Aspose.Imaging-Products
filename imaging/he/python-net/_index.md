...
description: ספריית עיבוד תמונה ומניפולציה של Python. Aspose.Imaging עבור Python באמצעות NET מאפשר ליצור, לטעון, להציג, לערוך, לצייר או להמיר תמונות לפורמטים מרובים בתוך יישומים ללא כל עורך תמונות
---
...
<p align="justify">
 Aspose.Imaging עבור Python דרך .NET היא ספרייה המציעה תכונות מתקדמות לעיבוד תמונה. אתה יכול בקלות ליצור, לטעון, לבצע מניפולציות, להמיר או לדחוס תמונות באמצעות API זה. כמו כן, Aspose.Imaging עבור Python דרך NET תומך בציור ובעבודה עם פרימיטיבים גרפיים. ייצוא והמרה של תמונות - אחת מתכונות הליבה של ה-API יחד עם טרנספורמציות של תמונה (שינוי גודל, חיתוך, היפוך וסיבוב, בינאריזציה, גווני אפור, התאמה), תכונות מתקדמות של מניפולציה של תמונות (סינון, הסטה, מיסוך, ביטול הטיה).
</p>

<p align="justify">
 Aspose.Imaging עבור Python דרך .NET הוא API המסוגל לעבד פורמטים נפוצים של תמונה ותומך בכמה פורמטים מיוחדים כמו DjVu, DICOM, WebP ו-DNG.
</p>
...
<div class="diagram1 d1-python">
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="Image Python API" src="/imaging/images/imaging/aspose_imaging-for-python-net.svg"/>
  <header>
   Aspose.Imaging
  </header>
  <footer>
...
{{< blocks/products/pf/carousel-item h3="" description="Aspose.Imaging עבור Python דרך .NET זמין עבור:" >}}
<div class="diagram1 d1-python">
 <div class="d1-row">
  <div class="d1-col d1-left">
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="Python API לעיבוד תמונה" src="/imaging/images/imaging/aspose_imaging-for-python-net.svg"/>
  <header>
   Aspose.Imaging
  </header>
  <footer>
...
{{< blocks/products/pf/carousel-item h3="" description="Aspose.Imaging עבור Python תומך במגוון תמונות [פורמטים של קובץ](https://docs.aspose.com/imaging/python-net/supported-file-formats/)." >}}
<div class="diagram1 d2 d1-python">
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="מעבד תמונה C# עריכת תמונה ערוך תמונה" src="/imaging/images/imaging/aspose_imaging-for-python-net.svg"/>
  <header>
   Aspose.Imaging
  </header>
  <footer>
 ...
 <div class="row">
  <div class="container">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
    <a href="/imaging/he/python-net/conversion/">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
    <a href="/imaging/he/python-net/crop/">
     יְבוּל
    </a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
    <a href="/imaging/he/python-net/resize/">
     שנה גודל
    </a>
    </p>
   </div>
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
    <a href="/imaging/he/python-net/remove-background/">    
     הסר רקע
    </a>
    </p>
   </div>
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="/imaging/he/python-net/change-background/">
     שנה רקע
     </a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="/imaging/he/python-net/watermark/">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="/imaging/he/python-net/viewer/">
     הצג תמונה
     </a>
    </p>
   </div>   
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="/imaging/he/python-net/compress/">
     לִדחוֹס
     </a>
    </p>
   </div>
<div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="/imaging/he/python-net/merge/">
     לְמַזֵג
     </a>
    </p>
   </div>
<div class="col-lg-12">
  <h2 class="h2title">מסנני תמונות ואפקטים שונים</h2>
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="/imaging/he/python-net/dither/">
     לְהַסֵס
     </a>
    </p>
   </div>
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="/imaging/he/python-net/grayscale/">
     גווני אפור
     </a>
    </p>
   </div>
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="/imaging/he/python-net/filter/">
     לְסַנֵן
     </a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="/imaging/he/python-net/cartoonify/">
     קריקטורה
     </a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="/imaging/he/python-net/binarize/">
     בינאריזה
     </a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="/imaging/he/python-net/adjust/">
     לְהַתְאִים
     </a>
    </p>
   </div>
...
<h2 class="h2title">רשום פורמטים מותאמים אישית של קבצי תמונה</h2>

<p>תכונה מבטיחה נוספת ש-Aspose.Imaging עבור Python מספקת היא רישום פורמטים מותאמים אישית של תמונה. Aspose.Imaging עבור .NET מאפשר למפתחים לרשום פורמטים חדשים של קבצים מותאמים אישית ליצירה, פתיחה או ייצוא אליהם באמצעות אחת מספריות הרישום Aspose.Imaging עבור .NET עבור פעולה מתאימה. תכונה זו מאפשרת הוספת פורמטים חדשים של קבצים שניתן להשתמש בהם למטרות ציור וייצוא.</p>
...
{{< blocks/products/pf/slr-element name="מכתבי שחרור" href="https://releases.aspose.com/imaging/python-net/release-notes/" >}}
{{< /blocks/products/pf/slr-tab >}}
