---
title: תמונות יְבוּל באמצעות Python 
weight: 3920
url: /he/python-net/crop/ 
lang: he
langdirlevel: 2
locales: zh-hans,ja,it,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko,zh-hant,ar,hi,th,sv,cs,uk,he
description: החלת ספריית Aspose.Imaging על תמונות ותמונות של יְבוּל באמצעות יישומי Python וממשקי API משלך של שרת.
---

{{< blocks/products/pf/feature-page-wrap >}}
{{< blocks/products/pf/feature-page-header h1="השתמש ב-Python עבור פעולת יְבוּל בתמונות" h2="תמונות יְבוּל באמצעות יישומי Python משלך באמצעות ספריית Aspose.Imaging" downloadText="הורד" >}}


{{% blocks/products/pf/feature-page-section  h2="החל את פעולת יְבוּל על כל פורמטי התמונה הזמינים" %}}
<p align="justify" style="text-indent:2em;font-size:15px;">
חיתוך תמונות הוא תהליך של הסרת חלקים מיותרים מתמונות או תמונות. כתוצאה מפעולת חיתוך התמונה, ניתן להסיר חלק מהפריפריה של התמונה כדי לשפר את הקומפוזיציה שלה, להתאים פרופורציות או למרכז את האלמנט הראשי. כדי להשיג זאת, אתה יכול להשתמש בתוכנות ייעודיות לעריכת תמונות או להחיל פעולת חיתוך באופן פרוגרמטי על התמונות, התמונות, הנופים או הפורטרטים, בהתאם לדרישות הספציפיות שלך. חיתוך מוצא יישומים נרחבים בצילום, מניפולציה של תמונות, הפקת וידאו, עיצוב גרפי והדפסה. עם ספריית Aspose.Imaging, אתה יכול להפוך חיתוך תמונה לאוטומטי באמצעות פרמטרים הניתנים להתאמה אישית.
</p>
<p align="justify" style="text-indent:2em;font-size:15px;">
באמצעות ספריית Aspose.Imaging עבור Python, אתה יכול לבצע בקלות את פעולת <b>יְבוּל</b> עבור תמונות ותמונות בפורמטים שונים באופן פרוגרמטי.
</p>
<h3 style="margin-top:16px;">
בחר פורמט תמונה מהרשימה עבור הפעולה יְבוּל:
</h3>
<hr/>
