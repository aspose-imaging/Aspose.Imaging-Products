---
title: מסמך סימן מים WMF באמצעות Java 
weight: 3920
url: /he/java/watermark/wmf/ 
lang: he
langdirlevel: 2
locales: zh-hans,ja,it,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko,zh-hant,ar,hi,th,sv,cs,uk,he
description: קוד המרת Java לדוגמה עבור פורמט WMF לקובץ . השתמש בקוד לדוגמה זה כדי להמיר את WMF ל- בתוך כל יישום מבוסס Java אינטרנט או שולחני.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="הוסף סימן מים של טקסט ל-WMF באמצעות Java" h2="בנה יישומי Java משלך לסימן מים של קבצי WMF באמצעות ממשקי API בצד השרת." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/imaging/aspose_imaging-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="WMF" pfName="Aspose.Imaging" subTitlepfName="עבור Java" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/feature-section-col title="שלבים להוספת סימן מים ל-WMF באמצעות Java" %}}
...
{{% blocks/products/pf/agp/code-block title="תמונת סימן מים WMF - Java" offSpacer="" %}}
