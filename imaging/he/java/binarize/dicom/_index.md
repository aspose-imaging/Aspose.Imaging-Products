---
title: בצע בינאריזה של מסמכים ב-DICOM באמצעות Java 
weight: 3920
url: /he/java/binarize/dicom/ 
lang: he
langdirlevel: 2
locales: zh-hans,ja,it,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko,zh-hant,ar,hi,th,sv,cs,uk,he
description: נסה את ממשקי ה-API של מסמכים מקומיים כדי לשלב קבצי DICOM ב-.NET Framework, .NET Core, Windows Application, ASP.NET Web Application.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="בינאריזה של DICOM באמצעות Java" h2="בנה יישומי Java משלך כדי לשלב קבצים DICOM באמצעות ממשקי API בצד השרת." logoImageSrc="/imaging/images/imaging/aspose_imaging-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="DICOM" pfName="Aspose.Imaging" subTitlepfName="עבור Java" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/content h2="כיצד לבצע בינאריזה של קבצים DICOM באמצעות Java" %}}

המצאת הסרט הצבעוני סימנה אבן דרך משמעותית בתחום הצילום. עם זאת, צילום קלאסי מקושר מטבעו לדימויים בשחור-לבן. למרות היכולות הטכניות הנרחבות של מצלמות ללכוד את כל ספקטרום הצבעים, אנשים רבים בוחרים במונוכרום, והופכים את התמונות שלהם לשחור ולבן. במקרים כאלה, נכנסת לפעולה פונקציית בינאריזציה, הממירה את כל הפיקסלים לערכים בינאריים: \"0\" ללבן ו\"1\" לשחור. בתרחישים אחרים, ההמרה הזו אינה מונעת מבחירות אמנותיות אלא מבחירות מעשיות, כמו הכנת איורים בשחור-לבן להדפסה בספרים או בעיתונים. באמצעות ספריית הגרפיקה Java, אתה יכול להגדיר סף בהירות פיקסלים. פיקסלים עם ערכי בהירות מתחת לסף זה יהפכו לשחורים, בעוד אלו שמעליו יהפכו לבנים. לחלופין, אתה יכול להשתמש בשיטת בינאריזציה אדפטיבית השוקלת את ערכי הפיקסלים באזור שמסביב. גישה זו מביאה למעברים חלקים יותר בין גבולות צבע בתמונה בשחור-לבן המתקבלת. על מנת לשלב קבצים ב-DICOM, נשתמש [Aspose.Imaging for Java](https://products.aspose.com/imaging/java) API שהוא עשיר בתכונות, חזק וקל לשימוש למניפולציה והמרה של תמונות עבור פלטפורמת Java. אתה יכול להוריד את הגרסה האחרונה שלו ישירות מ-[Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-imaging) ולהתקין אותה בתוך ה-Maven שלך פרויקט מבוסס על ידי הוספת התצורות הבאות לקובץ pom.xml.
...
{{% blocks/products/pf/agp/feature-section-col title="שלבים לעיבוד בינארי של DICOM באמצעות Java" %}}
...
{{% blocks/products/pf/agp/code-block title="בינאריזה של תמונות DICOM - Java" offSpacer="" %}}
...
Aspose.Imaging API הוא פתרון לעיבוד תמונה ליצירה, שינוי, ציור או המרת תמונות (תמונות) בתוך יישומים. הוא מציע: עיבוד תמונה חוצה פלטפורמות, כולל אך לא רק המרות בין פורמטים שונים של תמונה (כולל עיבוד תמונה אחיד מרובה עמודים או ריבוי מסגרות), שינויים כגון ציור, עבודה עם פרימיטיבים גרפיים, טרנספורמציות (שינוי גודל, חיתוך, הפוך וסיבוב , בינאריזציה, גווני אפור, התאמה), תכונות מתקדמות של מניפולציה של תמונות (סינון, שיטוט, מיסוך, ביטול הטיה) ואסטרטגיות אופטימיזציה של זיכרון. זוהי ספרייה עצמאית ואינה תלויה בתוכנה כלשהי לפעולות תמונה. אפשר להוסיף בקלות תכונות המרת תמונה בעלות ביצועים גבוהים עם ממשקי API מקוריים בתוך פרויקטים. אלו הם 100% ממשקי API פרטיים מקומיים ותמונות מעובדות בשרתים שלך.
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="בצע בינאריזה של DICOM באמצעות אפליקציה מקוונת" sectionDescription="בצע בינאריזה של מסמכים ב-DICOM על ידי ביקור ב[אתר האינטרנט של הדגמות חיות](https://products.aspose.app/imaging/image-Binarize). להדגמה החיה יש את היתרונות הבאים" >}}
            ...
            {{< blocks/products/pf/agp/democard icon="fa-file-text" text="פשוט העלה את קבצי DICOM שלך ולחץ על הלחצן בינאריזציה עכשיו." >}}
