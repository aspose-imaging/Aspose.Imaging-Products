...
<div class="diagram1 d1-java">
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="תמונה Java API" src="https://www.aspose.cloud/templates/aspose/img/products/imaging/aspose_imaging-for-java.svg"/>
  <header>
   Aspose.Imaging
  </header>
  <footer>
...
<div class="diagram1 d1-java">
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="Java API לעיבוד תמונה" src="https://www.aspose.cloud/templates/aspose/img/products/imaging/aspose_imaging-for-java.svg"/>
  <header>
   Aspose.Imaging
  </header>
  <footer>
...
<div class="diagram1 d2 d1-java">
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="מעבד תמונה C# עריכת תמונה ערוך תמונה" src="https://www.aspose.cloud/templates/aspose/img/products/imaging/aspose_imaging-for-java.svg"/>
  <header>
   Aspose.Imaging
  </header>
  <footer>
...
<p>תכונה מבטיחה נוספת ש-Aspose.Imaging עבור Java מספקת היא רישום פורמטים מותאמים אישית של תמונה. Aspose.Imaging עבור .NET מאפשר למפתחים לרשום פורמטים חדשים של קבצים מותאמים אישית ליצירה, פתיחה או ייצוא אליהם באמצעות אחת מספריות הרישום Aspose.Imaging עבור .NET עבור פעולה מתאימה. תכונה זו מאפשרת הוספת פורמטים חדשים של קבצים שניתן להשתמש בהם למטרות ציור וייצוא.</p>
