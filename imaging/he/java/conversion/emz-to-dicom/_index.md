...
{{% blocks/products/pf/agp/content h2="כיצד להמיר EMZ ל-DICOM באמצעות Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="שלבים להמרת EMZ ל-DICOM באמצעות Java" %}}
...
{{% blocks/products/pf/agp/code-block title="המר את EMZ ל-DICOM - Java" offSpacer="" %}}
