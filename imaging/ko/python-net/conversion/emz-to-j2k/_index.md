...
EMZ을 J2K로 변환하려면 다음을 사용합니다. [Aspose.Imaging for Python via .NET](/imaging/ko/python-net) API는 기능이 풍부하고 강력하며 사용하기 쉬운 Python 플랫폼용 이미지 조작 및 변환 API입니다. 시스템 명령에서 다음 명령을 사용하여 설치할 수 있습니다.
