---
title: Python 이미징 API | .NET을 통한 Python용 Aspose.Imaging - 그리기 조작 및 이미지 변환 
weight: 960
url: /ko/python-net/ 
lang: ko
langdirlevel: 2
locales: zh-hans,ja,it,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko,zh-hant,ar,hi,th,sv,cs,uk,he
description: Python 이미지 처리 및 조작 라이브러리. Aspose.Imaging for Python via .NET을 사용하면 이미지 편집기 없이 애플리케이션 내에서 이미지를 생성, 로드, 보기, 편집, 그리기 또는 여러 형식으로 변환할 수 있습니다.
---
...
<div class="diagram1 d1-python">
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="이미지 파이썬 API" src="/imaging/images/imaging/aspose_imaging-for-python-net.svg"/>
  <header>
   Aspose.Imaging
  </header>
  <footer>
...
{{< blocks/products/pf/carousel-item h3="" description=".NET을 통한 Python용 Aspose.Imaging은 다음에서 사용할 수 있습니다." >}}
<div class="diagram1 d1-python">
 <div class="d1-row">
  <div class="d1-col d1-left">
   <header>
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="Python 이미지 처리 API" src="/imaging/images/imaging/aspose_imaging-for-python-net.svg"/>
  <header>
   Aspose.Imaging
  </header>
  <footer>
...
{{< blocks/products/pf/carousel-item h3="" description="Aspose.Imaging for Python [은 다양한 이미지[파일 형식]를 지원합니다](https://docs.aspose.com/imaging/python-net/supported-file-formats/)." >}}
<div class="diagram1 d2 d1-python">
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="이미지 프로세서 C# 사진 편집 이미지 편집" src="/imaging/images/imaging/aspose_imaging-for-python-net.svg"/>
  <header>
   Aspose.Imaging
  </header>
  <footer>
 ...
 <div class="row">
  <div class="container">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
    <a href="/imaging/ko/python-net/conversion/">
     이미지를 다양한 형식으로 변환
    </a>
    </p>
   </div>
...
{{< gist "aspose-com-gists" "afe32f26944235686ade7c8b3c43cf30" "save-image-in-different-formats.py" >}}
   ...
   <div class="col-lg-12">
    ...
    <p>
     Aspose.Imaging for Python은 핵심 기능과 함께 고급 그리기 기능 세트를 지원합니다. 개발자는 픽셀 정보를 조작하거나 그래픽 및 경로와 같은 고급 기능을 사용하여 이미지 표면에 그릴 수 있습니다.
    </p>
    <p>
     Python 이미지 라이브러리를 사용하면 선, 곡선, 직사각형 및 기타 기하학적 모양을 쉽게 그리고 닫힌 모양을 단색 또는 그라디언트 및 질감으로 채우고 글꼴을 미세하게 제어할 수 있는 옵션으로 텍스트를 그리고 기존 이미지 데이터를 로드하여 이미지를 그릴 수 있습니다.
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
...
{{< gist "aspose-com-gists" "afe32f26944235686ade7c8b3c43cf30" "load-edit-filter-save-photos.py" >}}
   ...
   <div class="col-lg-12">
    ...
    <p>
     Aspose.Imaging for Python은 압축된 벡터 이미지를 지원합니다. Zip 아카이버를 사용하여 압축된 EMF, WMF, SVG 형식의 벡터 이미지입니다. 크기는 원본의 평균 30-70%입니다. 이렇게 하면 미디어 공간이 절약되고 네트워크를 통한 파일 전송 시간이 줄어듭니다.
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
    ...
    <p>
     Python용 Aspose.Imaging을 사용하면 지정된 매개변수로 이미지를 쉽게 생성하고 조작하고 저장할 수 있습니다.
    </p>
    <div class="codeblock" id="code">
     <h3>
      png 이미지를 만들고 조작하고 저장하십시오. - Python
     </h3>
...
<p>Aspose.Imaging for Python이 제공하는 또 다른 유망한 기능은 사용자 지정 이미지 형식을 등록하는 것입니다. .NET용 Aspose.Imaging을 사용하면 개발자가 해당 작업에 대해 .NET용 Aspose.Imaging 레지스트리 라이브러리 중 하나를 사용하여 생성, 열기 또는 내보낼 새 사용자 지정 파일 형식을 등록할 수 있습니다. 이 기능을 사용하면 그리기 및 내보내기 목적으로 사용할 수 있는 새 파일 형식을 추가할 수 있습니다.</p>
...
{{< blocks/products/pf/slr-element name="선적 서류 비치" href="https://docs.aspose.com/imaging/python-net/" >}}
{{< blocks/products/pf/slr-element name="소스 코드" href="https://github.com/aspose-imaging/Aspose.Imaging-for-Python-net/" >}}
{{< blocks/products/pf/slr-element name="API 참조" href="https://apireference.aspose.com/python-net/imaging/" >}}
...
{{< blocks/products/pf/slr-element name="릴리즈 노트" href="https://releases.aspose.com/imaging/python-net/release-notes/" >}}
{{< /blocks/products/pf/slr-tab >}}

{{< blocks/products/pf/slr-tab tabTitle="Aspose.Imaging을 사용해야 하는 이유 Python" tabId="success-stories" >}}
...
{{< blocks/products/pf/download-section downloadFreeTrialLink="https://downloads.aspose.com/imaging/python-net/" downloadFreeTrialText="무료 평가판 다운로드" pricingInformationText="가격 정보" pricingInformationLink="https://purchase.aspose.com/pricing/imaging/python-net/" >}}
