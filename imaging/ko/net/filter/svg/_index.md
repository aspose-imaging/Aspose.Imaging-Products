---
title: .NET을 통해 SVG 문서 필터링 
weight: 3920
url: /ko/net/filter/svg/ 
lang: ko
langdirlevel: 2
...
{{% blocks/products/pf/agp/content h2="C#을 사용하여 SVG 파일을 필터링하는 방법" %}}

SVG 파일을 필터링하기 위해 다음을 사용합니다. [.NET용 Aspose.Imaging](https://products.aspose.com/imaging/net) 기능이 풍부하고 강력하며 사용하기 쉬운 C# 플랫폼용 이미지 조작 및 변환 API인 API입니다. 열려있는 [누겟](https://www.nuget.org/packages/aspose.imaging) 패키지 관리자, 검색 **아포즈.이미징** 설치합니다. 패키지 관리자 콘솔에서 다음 명령을 사용할 수도 있습니다.
...
{{% blocks/products/pf/agp/feature-section-col title="C#을 통해 SVG을 필터링하는 단계" %}}
...
{{% blocks/products/pf/agp/code-block title="SVG 이미지 필터링 - .NET" offSpacer="" %}}
