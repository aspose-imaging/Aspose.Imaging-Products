---
title: .NET을 통해 J2K에서 다른 형식으로 변환 
weight: 3920
...
{{< blocks/products/pf/feature-page-header h1=".NET을 통해 J2K에서 이미지 파일 변환" h2="J2K에서 다른 형식으로 변환" downloadText="다운로드" >}}


{{% blocks/products/pf/feature-page-section  h2="J2K에서 변환할 지원되는 모든 이미지 형식" %}}
Aspose.Imaging을 사용하면 J2K에서 .NET 플랫폼의 다른 형식으로 많은 변환을 자동화할 수 있습니다.
<br/>
지원되는 변환의 전체 목록:
