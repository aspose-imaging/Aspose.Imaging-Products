---
title: Java을 통해 JPG 문서의 배경 제거 
weight: 3920
url: /ko/java/remove-background/jpg/ 
lang: ko
langdirlevel: 2
...
JPG 파일에서 배경을 제거하기 위해 다음을 사용합니다.
...
{{% blocks/products/pf/agp/feature-section-col title="Java를 통해 JPG에서 배경을 제거하는 단계" %}}
...
{{% blocks/products/pf/agp/code-block title="JPG 이미지의 배경 제거 - Java" offSpacer="" %}}
