---
title: Java을 통해 EMZ 문서의 배경 제거 
weight: 3920
url: /ko/java/remove-background/emz/ 
lang: ko
langdirlevel: 2
...
{{% blocks/products/pf/agp/content h2="Java을 사용하여 EMZ 파일에서 배경을 제거하는 방법" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Java를 통해 EMZ에서 배경을 제거하는 단계" %}}
...
{{% blocks/products/pf/agp/code-block title="EMZ 이미지의 배경 제거 - Java" offSpacer="" %}}
