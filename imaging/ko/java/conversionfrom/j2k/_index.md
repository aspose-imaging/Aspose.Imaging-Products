...
description: Aspose.Imaging은 Java 플랫폼을 사용하여 J2K에서 다른 형식으로 쉽게 변환할 수 있습니다.
---

{{< blocks/products/pf/feature-page-wrap >}}
{{< blocks/products/pf/feature-page-header h1="Aspose.Imaging for Java를 사용하여 J2K 형식에서 이미지 변환" h2="Java 플랫폼을 사용하여 J2K 이미지 형식에서 다른 형식으로 변환" downloadText="다운로드" >}}


{{% blocks/products/pf/feature-page-section  h2="Aspose.Imaging for Java를 사용하여 J2K 이미지에서 변환할 수 있는 광범위한 이미지 형식" %}}
