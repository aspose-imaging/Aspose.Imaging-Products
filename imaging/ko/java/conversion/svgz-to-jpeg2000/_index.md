...
SVGZ을 JPEG2000로 변환하려면 다음을 사용합니다.
...
{{< blocks/imaging-app-widget
        ...
        checkFreeAppLabel="[SVGZ을 JPEG2000로 변환하는 라이브 데모]를 확인하세요."
