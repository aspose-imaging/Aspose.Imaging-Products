...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Convert PDF to CANVAS via C#" %}}

{{% blocks/products/pf/agp/text %}}

Developers can easily load & convert PDF files to CANVAS in just a few lines of code.
...
{{% blocks/products/pf/agp/code-block title="Convert PDF to CANVAS - .NET" offSpacer="true" %}}
