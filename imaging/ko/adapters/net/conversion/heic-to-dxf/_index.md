---
title: C#을 통해 HEIC을 DXF로 변환 
weight: 3920
url: /ko/adapters/net/heic-to-dxf/ 
lang: ko
langdirlevel: 2
...
{{% blocks/products/pf/agp/content h2="C#을 사용하여 HEIC을 DXF로 변환하는 방법" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="C#을 통해 HEIC을 DXF로 변환하는 단계" %}}

{{% blocks/products/pf/agp/text %}}

개발자는 단 몇 줄의 코드만으로 HEIC 파일을 DXF로 쉽게 로드하고 변환할 수 있습니다.

{{% /blocks/products/pf/agp/text %}}

+ 일회성 작업인 Register() 메서드를 사용하여 어댑터를 초기화합니다.
+ Aspose.Imaging.Image.Load() 메소드를 사용하여 필요한 HEIC 파일을 로드합니다.
+ DXF 형식에 필요한 저장 옵션 클래스 인스턴스를 생성하고 필요한 속성을 설정합니다.
+ 옵션과 함께 파일 경로 또는 스트림을 지정하고 Aspose.Imaging.Image.Save() 메서드를 사용하여 DXF를 저장합니다.
...
{{% blocks/products/pf/agp/code-block title="HEIC을 DXF로 변환 - .NET" offSpacer="true" %}}
