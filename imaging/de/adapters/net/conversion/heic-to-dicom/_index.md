---
title: Konvertieren Sie HEIC über C# in DICOM 
weight: 3920
url: /de/adapters/net/heic-to-dicom/ 
lang: de
langdirlevel: 2
...
{{% blocks/products/pf/agp/content h2="So konvertieren Sie HEIC mit C# in DICOM" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Schritte zum Konvertieren von HEIC in DICOM über C#" %}}

{{% blocks/products/pf/agp/text %}}

Entwickler können HEIC-Dateien problemlos in nur wenigen Codezeilen laden und in DICOM konvertieren.
...
+ Erstellen Sie die erforderliche Klasseninstanz für Speicheroptionen für das Format DICOM und legen Sie die erforderlichen Eigenschaften fest.
+ Speichern Sie DICOM mit der Methode Aspose.Imaging.Image.Save() und geben Sie dabei den Dateipfad oder Stream zusammen mit den Optionen an.
...
{{% blocks/products/pf/agp/code-block title="Konvertieren Sie HEIC in DICOM – .NET" offSpacer="true" %}}
