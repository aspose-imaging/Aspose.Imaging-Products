---
title: CDR Bilder Graustufen mit Python 
weight: 3920
url: /de/python-net/grayscale/cdr/ 
lang: de
langdirlevel: 2
locales: zh-hans,ja,it,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko,zh-hant,ar,hi,th,sv,cs,uk,he
description: So verwenden Sie Python zum Graustufen von CDR-Bildern und Fotos in Desktop- und Webanwendungen.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Verwenden Sie Python zum Graustufen von CDR-Bildern" h2="Erstellen Sie Python-Apps für Graustufen-CDR-Bilder und Fotos über Server-APIs" logoImageSrc="/imaging/images/imaging/aspose_imaging-for-python-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="CDR" pfName="Aspose.Imaging" subTitlepfName="für Python" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Schritte zu Graustufen-CDRs über Python" %}}
...
{{% blocks/products/pf/agp/code-block title="Graustufenbilder im CDR - Python" offSpacer="" %}}
