...
{{% blocks/products/pf/agp/feature-section-col title="Schritte zum Binarisieren von ODGs über Python" %}}
...
{{% blocks/products/pf/agp/code-block title="ODG-Bilder binarisieren - Python" offSpacer="" %}}
