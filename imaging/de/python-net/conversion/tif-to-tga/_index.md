---
title: Konvertieren Sie TIF in TGA mit Python 
weight: 3920
url: /de/python-net/conversion/tif-to-tga/ 
lang: de
langdirlevel: 2
locales: ja,it,zh-hant,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko,zh-hans,ar,hi,th,sv,cs,uk,he
description: Beispielcode für die Python-Sprachumwandlung von TIF in TGA. Verwenden Sie den vorgestellten API-Beispielcode, um die Konvertierung von TIF in TGA mit einer beliebigen Web- oder Desktop-Python-Sprachanwendung zu verarbeiten.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Konvertieren Sie TIF in TGA mit der Sprache Python" h2="Wandeln Sie TIF in TGA um, indem Sie native Python-Sprach-APIs verwenden und keinen Bildeditor oder Bibliotheken von Drittanbietern benötigen." logoImageSrc="/imaging/images/imaging/aspose_imaging-for-python-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="TGA" pfName="Aspose.Imaging" subTitlepfName="für Python" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="APNG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Schritte zum Konvertieren von TIF in TGA über Python" %}}
...
{{% blocks/products/pf/agp/code-block title="Konvertiere TIF in TGA - Python" offSpacer="true" %}}
