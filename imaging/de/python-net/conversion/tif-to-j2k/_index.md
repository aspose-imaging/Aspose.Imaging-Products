...
{{% blocks/products/pf/agp/content h2="So konvertieren Sie TIF in J2K mit Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Schritte zum Konvertieren von TIF in J2K über Python" %}}
...
{{% blocks/products/pf/agp/code-block title="Konvertiere TIF in J2K - Python" offSpacer="" %}}
