...
{{% blocks/products/pf/agp/feature-section-col title="Schritte zum Dithern von TIFFs über Python" %}}
...
{{% blocks/products/pf/agp/code-block title="Dither-Bilder von TIFF - Python" offSpacer="" %}}
