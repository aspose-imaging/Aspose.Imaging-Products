...
{{% blocks/products/pf/agp/feature-section-col title="Schritte zum Zuschneiden von WMFs über Python" %}}
...
{{% blocks/products/pf/agp/code-block title="Zuschneiden von WMF-Bildern – Python" offSpacer="" %}}
