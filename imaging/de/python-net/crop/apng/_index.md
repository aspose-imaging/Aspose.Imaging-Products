...
{{% blocks/products/pf/agp/feature-section-col title="Schritte zum Zuschneiden von APNGs über Python" %}}
...
{{% blocks/products/pf/agp/code-block title="Zuschneiden von APNG-Bildern – Python" offSpacer="" %}}
