...
{{% blocks/products/pf/agp/feature-section-col title="Schritte zum Zuschneiden von TGAs über Python" %}}
...
{{% blocks/products/pf/agp/code-block title="Zuschneiden von TGA-Bildern – Python" offSpacer="" %}}
