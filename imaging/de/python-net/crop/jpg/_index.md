...
{{% blocks/products/pf/agp/feature-section-col title="Schritte zum Zuschneiden von JPGs über Python" %}}
...
{{% blocks/products/pf/agp/code-block title="Zuschneiden von JPG-Bildern – Python" offSpacer="" %}}
