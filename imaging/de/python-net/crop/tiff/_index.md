...
{{% blocks/products/pf/agp/feature-section-col title="Schritte zum Zuschneiden von TIFFs über Python" %}}
...
{{% blocks/products/pf/agp/code-block title="Zuschneiden von TIFF-Bildern – Python" offSpacer="" %}}
