...
{{% blocks/products/pf/agp/feature-section-col title="Schritte zum Zuschneiden von DJVUs über Python" %}}
...
{{% blocks/products/pf/agp/code-block title="Zuschneiden von DJVU-Bildern – Python" offSpacer="" %}}
