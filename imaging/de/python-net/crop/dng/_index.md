...
{{% blocks/products/pf/agp/feature-section-col title="Schritte zum Zuschneiden von DNGs über Python" %}}
...
{{% blocks/products/pf/agp/code-block title="Zuschneiden von DNG-Bildern – Python" offSpacer="" %}}
