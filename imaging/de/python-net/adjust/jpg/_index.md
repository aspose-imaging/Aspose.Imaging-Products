...
{{% blocks/products/pf/agp/feature-section-col title="Schritte zum Anpassen von JPGs über Python" %}}
...
{{% blocks/products/pf/agp/code-block title="JPG-Bilder anpassen – Python" offSpacer="" %}}
