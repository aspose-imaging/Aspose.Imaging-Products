...
{{< blocks/imaging-app-widget
        ...
        checkFreeAppLabel="Sehen Sie sich unsere an [Live-Demos zum Konvertieren von TIF in DICOM]"
        checkFreeAppLabelUrl="(https://products.aspose.app/imaging/de/conversion/TIF-to-DICOM)"
        showPreview="true">}}

{{% blocks/products/pf/agp/code-block title="Konvertiere TIF in DICOM - .NET" offSpacer="true" %}}
