---
title: Dokument mit Wasserzeichen WEBP über C# 
weight: 3920
url: /de/net/watermark/webp/ 
lang: de
langdirlevel: 2
locales: zh-hans,ja,it,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko,zh-hant
description: Probieren Sie unsere On-Premise-Dokument-APIs aus, um die Datei WEBP in .NET Framework, .NET Core, Windows-Anwendung und ASP.NET-Webanwendung mit Wasserzeichen zu versehen.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Textwasserzeichen zu WEBP über C# hinzufügen" h2="Erstellen Sie mithilfe serverseitiger APIs Ihre eigenen .NET-Apps, um WEBP-Dateien mit Wasserzeichen zu versehen." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/imaging/aspose_imaging-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="WEBP" pfName="Aspose.Imaging" subTitlepfName="für .NET" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Schritte zum Hinzufügen von Wasserzeichen zu WEBP über C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Wasserzeichenbild WEBP - .NET" offSpacer="" %}}
