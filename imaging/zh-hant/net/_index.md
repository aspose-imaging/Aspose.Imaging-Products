...
{{< blocks/products/pf/upper-banner h1=".NET 跨平台庫 - 圖像處理 API" h2="無需任何圖像編輯器即可創建、加載、操作或轉換圖像。" downloadFreeTrialText="下載免費試用版" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/imaging/headers/aspose_imaging-for-net.svg"  pfName="Aspose.Imaging" subTitlepfName="for .NET" downloadUrl="https://downloads.aspose.com/imaging/net" >}}
...
{{< blocks/products/pf/tab-content carousel1Text1="在一個" carousel1Text2="一目了然" carousel2Text1="支持的文件" carousel2Text2="格式" carousel3Text1="平台" carousel3Text2="獨立">}}
<p align="justify">
 Aspose.Imaging for .NET 是一個提供高級圖像處理功能的庫。您可以使用此 API 輕鬆創建、加載、操作、轉換、壓縮圖像或照片。也假設。圖像庫支持繪圖和使用圖形基元。圖像導出和轉換（包括統一的多頁圖像處理）是 API 的核心功能之一，以及圖像轉換（調整大小、裁剪、翻轉和旋轉、二值化、灰度、調整）、高級圖像處理功能（過濾、抖動、遮罩、去歪斜） ) 和內存優化策略。
</p>

<p align="justify">
 Aspose.Imaging for .NET 是一個靈活、穩定且功能強大的 API，能夠處理最常用的格式以及一些特殊格式，如 DjVu、DICOM、WebP 和 DNG。此外，它擴展了對 .NET 和 .NET Core 的圖像格式和處理功能的原生支持。 Aspose.Imaging 是跨平台庫，兼容 Windows 和 Linux。
</p>
...
<div class="diagram1 d1-net">
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="圖像 .NET API" src="https://www.aspose.cloud/templates/aspose/img/products/imaging/aspose_imaging-for-net.svg"/>
  <header>
   Aspose.Imaging
  </header>
  <footer>
...
<div class="diagram1 d1-net">
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt=".NET 圖像處理 API" src="https://www.aspose.cloud/templates/aspose/img/products/imaging/aspose_imaging-for-net.svg"/>
  <header>
   Aspose.Imaging
  </header>
  <footer>
...
{{< blocks/products/pf/carousel-item h3="" description="Aspose.Imaging for .NET 支持多種圖像[文件格式](https://docs.aspose.com/imaging/net/supported-file-formats/)." >}}
<div class="diagram1 d2 d1-net">
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="圖像處理器 C# 編輯照片 編輯圖像" src="https://www.aspose.cloud/templates/aspose/img/products/imaging/aspose_imaging-for-net.svg"/>
  <header>
   Aspose.Imaging
  </header>
  <footer>
...
<h2 class="h2title">註冊自定義圖像文件格式</h2>

<p>Aspose.Imaging for .NET 提供的另一個有前途的功能是註冊自定義圖像格式。 Aspose.Imaging for .NET 允許開發人員通過使用 Aspose.Imaging for .NET 註冊表庫之一來註冊新的自定義文件格式以創建、打開或導出以進行相應的操作。此功能允許添加可用於繪圖和導出目的的新文件格式。</p>
