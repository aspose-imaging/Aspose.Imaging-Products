---
title: 通過 .NET 調整 DJVU 文檔 
weight: 3920
url: /zh-hant/net/adjust/djvu/ 
lang: zh-hant
langdirlevel: 2
...
{{% blocks/products/pf/agp/content h2="如何使用 C# 調整 DJVU 文件" %}}

為了調整 DJVU 文件，我們將使用 [Aspose.Imaging for .NET](https://products.aspose.com/imaging/net) API 是一個功能豐富、功能強大且易於使用的 C# 平台圖像處理和轉換 API。打開 [NuGet](https://www.nuget.org/packages/aspose.imaging) 包管理器，搜索 **Aspose.Imaging** 並安裝。您也可以從包管理器控制台使用以下命令。
...
{{% blocks/products/pf/agp/feature-section-col title="通過 C# 調整 DJVU 的步驟" %}}
...
{{% blocks/products/pf/agp/code-block title="調整 DJVU 圖像 - .NET" offSpacer="" %}}
