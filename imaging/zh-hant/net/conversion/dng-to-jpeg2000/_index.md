...
weight: 3920
url: /zh-hant/net/conversion/dng-to-jpeg2000/ 
lang: zh-hant
langdirlevel: 2
...
為了將 DNG 轉換為 JPEG2000，我們將使用 [Aspose.Imaging for .NET](https://products.aspose.com/imaging/net) API 是一個功能豐富、功能強大且易於使用的 C# 平台圖像處理和轉換 API。打開 [NuGet](https://www.nuget.org/packages/aspose.imaging) 包管理器，搜索 **Aspose.Imaging** 並安裝。您也可以從包管理器控制台使用以下命令。
...
{{< blocks/imaging-app-widget
        sectionTitle="將 DNG 轉換為 JPEG2000 的免費應用程序"
        appName="Conversion"
        extension="DNG to JPEG2000"
        label1="選擇或拖放 DNG 圖像"
        label2="選擇格式並單擊轉換按鈕"
        label3="點擊下載按鈕下載 JPEG2000 圖像"
        checkFreeAppLabel="查看我們的 [將 DNG 轉換為 JPEG2000 的現場演示]"
        checkFreeAppLabelUrl="(https://products.aspose.app/imaging/zh-hant/conversion/DNG-to-JPEG2000)"
        showPreview="true">}}
