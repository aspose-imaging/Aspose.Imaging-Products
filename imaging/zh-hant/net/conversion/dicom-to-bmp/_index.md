---
title: 通過 C# 將 DICOM 轉換為 BMP 
weight: 3920
url: /zh-hant/net/conversion/dicom-to-bmp/ 
lang: zh-hant
langdirlevel: 2
locales: ja,it,zh-hant,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko,zh-hans,ar,hi,th,sv,cs,uk,he
description: DICOM 到 BMP C# 轉換的示例代碼。使用 API 示例代碼在 VB.NET、Asp.NET 或任何基於 .NET 的應用程序中將 DICOM 文件批量轉換為 BMP。
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="通過 C# 將 DICOM 轉換為 BMP" h2="使用原生 .NET API 將 DICOM 轉換為 BMP，無需任何圖像編輯器或第 3 方庫。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/imaging/aspose_imaging-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="BMP" pfName="Aspose.Imaging" subTitlepfName=".NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="APNG" >}}
...
{{% blocks/products/pf/agp/content h2="如何使用 C# 將 DICOM 轉換為 BMP" %}}

為了將 DICOM 轉換為 BMP，我們將使用 [Aspose.Imaging for .NET](https://products.aspose.com/imaging/net) API 是一個功能豐富、功能強大且易於使用的 C# 平台圖像處理和轉換 API。打開 [NuGet](https://www.nuget.org/packages/aspose.imaging) 包管理器，搜索 **Aspose.Imaging** 並安裝。您也可以從包管理器控制台使用以下命令。
...
{{% blocks/products/pf/agp/feature-section-col title="通過 C# 將 DICOM 轉換為 BMP 的步驟" %}}

{{% blocks/products/pf/agp/text %}}

開發人員只需幾行代碼即可輕鬆加載 DICOM 文件並將其轉換為 BMP。
...
{{% blocks/products/pf/agp/code-block title="將 DICOM 轉換為 BMP - .NET" offSpacer="" %}}
...
{{< blocks/imaging-app-widget
        sectionTitle="將 DICOM 轉換為 BMP 的免費應用程序"
        appName="Conversion"
        extension="DICOM to BMP"
        label1="選擇或拖放 DICOM 圖像"
        label2="選擇格式並單擊轉換按鈕"
        label3="點擊下載按鈕下載 BMP 圖像"
        checkFreeAppLabel="查看我們的 [將 DICOM 轉換為 BMP 的現場演示]"
        checkFreeAppLabelUrl="(https://products.aspose.app/imaging/zh-hant/conversion/DICOM-to-BMP)"
        showPreview="true">}}
