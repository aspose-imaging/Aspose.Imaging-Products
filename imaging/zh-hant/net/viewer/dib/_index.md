---
title: 通過 .NET 查看 DIB 文檔 
weight: 3920
url: /zh-hant/net/viewer/dib/ 
lang: zh-hant
langdirlevel: 2
...
{{< blocks/products/pf/upper-banner h1="通過 C# 查看 DIB" h2="構建您自己的 .NET 應用以使用服務器端 API 查看 DIB 文件。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/imaging/aspose_imaging-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="DIB" pfName="Aspose.Imaging" subTitlepfName=".NET" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/feature-section-col title="通過 C# 查看 DIB 的步驟" %}}
...
{{% blocks/products/pf/agp/code-block title="查看 DIB 圖像 - .NET" offSpacer="" %}}
