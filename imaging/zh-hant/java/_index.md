---
title: Java 成像 API |繪製操縱和變換圖像 
weight: 960
url: /zh-hant/java/ 
lang: zh-hant
langdirlevel: 2
locales: zh-hans,ja,it,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko,zh-hant,ar,hi,th,sv,cs,uk,he
description: Java 圖像處理和操作庫。無需任何圖像編輯器即可在應用程序中創建加載視圖編輯繪圖或將圖像轉換為多種格式
---

{{< blocks/products/pf/main-wrap-class>}}
{{< blocks/products/pf/upper-banner h1="用於圖像處理的 Java 庫和 API" h2="無需任何圖像編輯器即可創建、加載、操作或轉換圖像。" downloadFreeTrialText="下載免費試用版" logoImageSrc="/imaging/images/imaging/headers/aspose_imaging-for-java.svg"  pfName="Aspose.Imaging" subTitlepfName="for Java" downloadUrl="https://downloads.aspose.com/imaging/java/" >}}
...
{{< blocks/products/pf/tab-content carousel1Text1="在一個" carousel1Text2="一目了然" carousel2Text1="平台" carousel2Text2="獨立" carousel3Text1="支持的文件" carousel3Text2="格式">}}
   ...
   <div class="col-lg-12">
    <h2 class="h2title">
     使用 Aspose.Imaging for Java 釋放影像處理的全部潛力
    </h2>
    <p align="justify">
     Aspose.Imaging for Java 是一個使用者友善的函式庫，可為您提供進階影像處理功能。借助此多功能 API，您可以輕鬆建立、載入、操作、轉換和壓縮影像或照片，從而實現廣泛的影像處理功能，而無需專用的影像編輯器。
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
   ...
   <div class="col-lg-12">
    ...
    <p align="justify">
     Aspose.Imaging for Java 不僅靈活穩定，而且用途廣泛。它支援最常用的圖像格式，並進一步提供對 DjVu、DICOM、WebP、EPS 和 DNG 等特殊格式的支援。這種廣泛的格式支援使其成為各種影像處理任務的首選解決方案。
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
    ...
    <p align="justify">
     使用 Aspose.Imaging for Java 將您的映像處理項目提升到新的高度。立即體驗我們 API 的靈活性、穩定性和強大功能。
    </p>
   </div>
...
<div class="diagram1 d1-java">
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="圖像 Java API" src="/imaging/images/imaging/aspose_imaging-for-java.svg"/>
  <header>
   Aspose.Imaging
  </header>
  <footer>
...
<div class="diagram1 d1-java">
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="Java 圖像處理 API" src="/imaging/images/imaging/aspose_imaging-for-java.svg"/>
  <header>
   Aspose.Imaging
  </header>
  <footer>
...
{{< blocks/products/pf/carousel-item h3="" description="Aspose.Imaging for Java 支持多種圖像[文件格式](https://docs.aspose.com/imaging/java/supported-file-formats/)." >}}
<div class="diagram1 d2 d1-java">
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="圖像處理器 C# 編輯照片 編輯圖像" src="/imaging/images/imaging/aspose_imaging-for-java.svg"/>
  <header>
   Aspose.Imaging
  </header>
  <footer>
 ...
 <div class="row">
  <div class="container">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
    <a href="/imaging/zh-hant/java/conversion/">
     將圖像轉換為多種格式
    </a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
    <a href="/imaging/zh-hant/java/crop/">
     莊稼
    </a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
    <a href="/imaging/zh-hant/java/resize/">
     調整大小
    </a>
    </p>
   </div>
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
    <a href="/imaging/zh-hant/java/remove-background/">    
     移除背景
    </a>
    </p>
   </div>
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="/imaging/zh-hant/java/change-background/">
     換背景
     </a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="/imaging/zh-hant/java/watermark/">
     為圖像添加水印     
     </a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="/imaging/zh-hant/java/viewer/">
     看圖
     </a>
    </p>
   </div>   
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="/imaging/zh-hant/java/compress/">
     壓縮
     </a>
    </p>
   </div>
<div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="/imaging/zh-hant/java/merge/">
     合併
     </a>
    </p>
   </div>
<div class="col-lg-12">
  <h2 class="h2title">各種圖像濾鏡和效果</h2>
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="/imaging/zh-hant/java/dither/">
     抖動
     </a>
    </p>
   </div>
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="/imaging/zh-hant/java/grayscale/">
     灰階
     </a>
    </p>
   </div>
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="/imaging/zh-hant/java/filter/">
     篩選
     </a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="/imaging/zh-hant/java/cartoonify/">
     卡通化
     </a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="/imaging/zh-hant/java/binarize/">
     二值化
     </a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="/imaging/zh-hant/java/adjust/">
     調整
     </a>
    </p>
   </div>
...
<p>Aspose.Imaging for Java 提供的另一個有前途的功能是註冊自定義圖像格式。 Aspose.Imaging for .NET 允許開發人員通過使用 Aspose.Imaging for .NET 註冊表庫之一來註冊新的自定義文件格式以創建、打開或導出以進行相應的操作。此功能允許添加可用於繪圖和導出目的的新文件格式。</p>
...
{{< blocks/products/pf/slr-element name="文檔" href="https://docs.aspose.com/imaging/java/" >}}
{{< blocks/products/pf/slr-element name="源代碼" href="https://github.com/aspose-imaging/Aspose.Imaging-for-Java/" >}}
{{< blocks/products/pf/slr-element name="API 參考" href="https://apireference.aspose.com/java/imaging/" >}}
...
{{< blocks/products/pf/slr-element name="發行說明" href="https://releases.aspose.com/imaging/java/release-notes/" >}}
{{< /blocks/products/pf/slr-tab >}}

{{< blocks/products/pf/slr-tab tabTitle="為什麼 Aspose.Imaging 用於 Java" tabId="success-stories" >}}
...
{{< blocks/products/pf/download-section downloadFreeTrialLink="https://downloads.aspose.com/imaging/java/" downloadFreeTrialText="下載免費試用版" pricingInformationText="定價信息" pricingInformationLink="https://purchase.aspose.com/pricing/imaging/java/" >}}
