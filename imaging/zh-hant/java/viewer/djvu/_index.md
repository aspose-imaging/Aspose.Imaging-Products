---
title: 通過 Java 查看 DJVU 文檔 
weight: 3920
url: /zh-hant/java/viewer/djvu/ 
lang: zh-hant
langdirlevel: 2
...
{{< blocks/products/pf/upper-banner h1="通過 Java 查看 DJVU" h2="構建您自己的 Java 應用以使用服務器端 API 查看 DJVU 文件。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/imaging/aspose_imaging-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="DJVU" pfName="Aspose.Imaging" subTitlepfName="Java" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/content h2="如何使用 Java 查看 DJVU 圖像" %}}

為了查看 DJVU 文件，我們將使用 [Aspose.Imaging for Java](https://products.aspose.com/imaging/java) API 是一個功能豐富、功能強大 易於使用的 Java 平台圖像處理和轉換 API。您可以直接從 [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-imaging) 並通過將以下配置添加到 pom.xml 將其安裝在基於 Maven 的項目中。
...
{{% blocks/products/pf/agp/feature-section-col title="通過 Java 查看 DJVU 的步驟" %}}
...
{{% blocks/products/pf/agp/code-block title="查看 DJVU 圖像 - Java" offSpacer="" %}}
