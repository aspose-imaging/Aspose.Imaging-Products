---
title: 通過 Java 查看 WMF 文檔 
weight: 3920
url: /zh-hant/java/viewer/wmf/ 
lang: zh-hant
langdirlevel: 2
locales: zh-hans,ja,it,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko,zh-hant,ar,hi,th,sv,cs,uk,he
description: 嘗試使用我們的本地文檔 API 來查看 .NET Framework、.NET Core、Windows 應用程序、ASP.NET Web 應用程序上的 WMF 文件。
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="通過 Java 查看 WMF" h2="構建您自己的 Java 應用以使用服務器端 API 查看 WMF 文件。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/imaging/aspose_imaging-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="WMF" pfName="Aspose.Imaging" subTitlepfName="Java" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/content h2="如何使用 Java 查看 WMF 圖像" %}}

為了查看 WMF 文件，我們將使用 [Aspose.Imaging for Java](https://products.aspose.com/imaging/java) API 是一個功能豐富、功能強大 易於使用的 Java 平台圖像處理和轉換 API。您可以直接從 [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-imaging) 並通過將以下配置添加到 pom.xml 將其安裝在基於 Maven 的項目中。
...
{{% blocks/products/pf/agp/feature-section-col title="通過 Java 查看 WMF 的步驟" %}}
...
{{% blocks/products/pf/agp/code-block title="查看 WMF 圖像 - Java" offSpacer="" %}}
...
{{< blocks/imaging-app-widget
        sectionTitle="免費應用程序查看 WMF" 
        appName="Viewer" 
        extension="WMF"
        label1="選擇或拖放 WMF 圖像" 
        label2="圖片將自動上傳並顯示" 
        checkFreeAppLabel="[查看我們的 [現場演示以查看 WMF](https://products.aspose.app/imaging/zh-hant/image-view/WMF)">}}
