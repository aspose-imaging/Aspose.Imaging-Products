---
title: Dithering di documenti CDR tramite .NET 
weight: 3920
url: /it/net/dither/cdr/ 
lang: it
langdirlevel: 2
...
{{< blocks/products/pf/upper-banner h1="Dithering di CDR tramite C#" h2="Crea le tue app .NET per ditherizzare i file CDR utilizzando le API lato server." logoImageSrc="/imaging/images/imaging/aspose_imaging-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="CDR" pfName="Aspose.Imaging" subTitlepfName="per .NET" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Passaggi per il dithering di CDR tramite C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Dithering CDR immagini - .NET" offSpacer="" %}}
