---
title: Filtra i documenti DICOM tramite .NET 
weight: 3920
url: /it/net/filter/dicom/ 
lang: it
langdirlevel: 2
...
{{< blocks/products/pf/upper-banner h1="Filtra DICOM tramite C#" h2="Crea le tue app .NET per filtrare i file DICOM utilizzando le API lato server." logoImageSrc="/imaging/images/imaging/aspose_imaging-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="DICOM" pfName="Aspose.Imaging" subTitlepfName="per .NET" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/content h2="Come filtrare i file DICOM utilizzando C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Passaggi per filtrare DICOM tramite C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Filtra immagini DICOM - .NET" offSpacer="" %}}
