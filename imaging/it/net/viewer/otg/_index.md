---
title: Visualizza i documenti OTG tramite .NET 
weight: 3920
...
{{< blocks/products/pf/upper-banner h1="Visualizza OTGs tramite C#" h2="Crea le tue app .NET per visualizzare i file OTG utilizzando le API lato server." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/imaging/aspose_imaging-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="OTG" pfName="Aspose.Imaging" subTitlepfName="per .NET" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Passaggi per visualizzare OTG tramite C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Visualizza le immagini di OTG - .NET" offSpacer="" %}}
