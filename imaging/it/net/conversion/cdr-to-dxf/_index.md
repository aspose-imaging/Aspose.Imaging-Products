...
{{% blocks/products/pf/agp/content h2="Come convertire CDR in DXF utilizzando C#" %}}

Per convertire CDR in DXF, useremo [Aspose.Imaging per .NET](https://products.aspose.com/imaging/net) API che è un'API di conversione e manipolazione delle immagini ricca di funzionalità, potente e facile da usare per la piattaforma C#. Aprire [NuGet](https://www.nuget.org/packages/aspose.imaging) gestore pacchetti, cerca **Aspose.Imaging** e installa. È inoltre possibile utilizzare il seguente comando dalla Console di gestione pacchetti.
...
{{% blocks/products/pf/agp/feature-section-col title="Passaggi per convertire CDR in DXF tramite C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Converti CDR in DXF - .NET" offSpacer="" %}}
...
{{< blocks/imaging-app-widget
        sectionTitle="App gratuita per convertire CDR in DXF"
        appName="Conversion"
        ...
        checkFreeAppLabel="Dai un'occhiata alle nostre [dimostrazioni dal vivo per convertire CDR in DXF]"
        checkFreeAppLabelUrl="(https://products.aspose.app/imaging/it/conversion/CDR-to-DXF)"
        showPreview="true">}}
