---
title: Converti CDR in GIF tramite C# 
weight: 3920
url: /it/net/conversion/cdr-to-gif/ 
lang: it
langdirlevel: 2
locales: ja,it,zh-hant,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko,zh-hans,ar,hi,th,sv,cs,uk,he
description: Codice di esempio per la conversione da CDR a GIF C#. Utilizzare il codice di esempio API per la conversione batch di file CDR in GIF all'interno di VB.NET, Asp.NET o qualsiasi applicazione basata su .NET.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Converti CDR in GIF tramite C#" h2="Trasforma CDR in GIF utilizzando le API .NET native senza bisogno di alcun editor di immagini o librerie di terze parti." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/imaging/aspose_imaging-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="GIF" pfName="Aspose.Imaging" subTitlepfName="per .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="APNG" >}}
...
{{% blocks/products/pf/agp/content h2="Come convertire CDR in GIF utilizzando C#" %}}

Per convertire CDR in GIF, useremo [Aspose.Imaging per .NET](https://products.aspose.com/imaging/net) API che è un'API di conversione e manipolazione delle immagini ricca di funzionalità, potente e facile da usare per la piattaforma C#. Aprire [NuGet](https://www.nuget.org/packages/aspose.imaging) gestore pacchetti, cerca **Aspose.Imaging** e installa. È inoltre possibile utilizzare il seguente comando dalla Console di gestione pacchetti.
...
{{% blocks/products/pf/agp/feature-section-col title="Passaggi per convertire CDR in GIF tramite C#" %}}

{{% blocks/products/pf/agp/text %}}

Gli sviluppatori possono caricare e convertire facilmente i file CDR in GIF in poche righe di codice.
...
{{% blocks/products/pf/agp/code-block title="Converti CDR in GIF - .NET" offSpacer="" %}}
...
{{< blocks/imaging-app-widget
        sectionTitle="App gratuita per convertire CDR in GIF"
        appName="Conversion"
        ...
        checkFreeAppLabel="Dai un'occhiata alle nostre [dimostrazioni dal vivo per convertire CDR in GIF]"
        checkFreeAppLabelUrl="(https://products.aspose.app/imaging/it/conversion/CDR-to-GIF)"
        showPreview="true">}}
