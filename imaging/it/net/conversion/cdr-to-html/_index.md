...
Per convertire CDR in HTML, useremo [Aspose.Imaging per .NET](https://products.aspose.com/imaging/net) API che è un'API di conversione e manipolazione delle immagini ricca di funzionalità, potente e facile da usare per la piattaforma C#. Aprire [NuGet](https://www.nuget.org/packages/aspose.imaging) gestore pacchetti, cerca **Aspose.Imaging** e installa. È inoltre possibile utilizzare il seguente comando dalla Console di gestione pacchetti.
...
{{< blocks/imaging-app-widget
        sectionTitle="App gratuita per convertire CDR in HTML"
        appName="Conversion"
        ...
        checkFreeAppLabel="Dai un'occhiata alle nostre [dimostrazioni dal vivo per convertire CDR in HTML]"
        checkFreeAppLabelUrl="(https://products.aspose.app/imaging/it/conversion/CDR-to-HTML)"
        showPreview="true">}}
