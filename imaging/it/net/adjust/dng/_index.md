---
title: Modifica i documenti DNG tramite .NET 
weight: 3920
url: /it/net/adjust/dng/ 
lang: it
langdirlevel: 2
...
{{< blocks/products/pf/upper-banner h1="Regola DNGs tramite C#" h2="Crea le tue app .NET per regolare i file DNG utilizzando le API lato server." logoImageSrc="/imaging/images/imaging/aspose_imaging-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="DNG" pfName="Aspose.Imaging" subTitlepfName="per .NET" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Passaggi per modificare DNG tramite C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Regola le immagini di DNG - .NET" offSpacer="" %}}
