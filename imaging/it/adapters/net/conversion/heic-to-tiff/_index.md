---
title: Converti HEIC in TIFF tramite C# 
weight: 3920
url: /it/adapters/net/heic-to-tiff/ 
lang: it
langdirlevel: 2
...
{{% blocks/products/pf/agp/content h2="Come convertire HEIC in TIFF utilizzando C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Passaggi per convertire HEIC in TIFF tramite C#" %}}

{{% blocks/products/pf/agp/text %}}

Gli sviluppatori possono caricare e convertire facilmente i file HEIC in TIFF in poche righe di codice.
...
+ Crea l'istanza della classe delle opzioni di salvataggio richiesta per il formato TIFF e imposta le proprietà necessarie.
+ Salva TIFF utilizzando il metodo Aspose.Imaging.Image.Save(), specificando il percorso del file o il flusso insieme alle opzioni.
...
{{% blocks/products/pf/agp/code-block title="Converti HEIC in TIFF - .NET" offSpacer="true" %}}
