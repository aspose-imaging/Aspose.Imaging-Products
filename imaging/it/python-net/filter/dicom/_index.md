---
title: Filtri di immagini DICOM con Python 
weight: 3920
url: /it/python-net/filter/dicom/ 
lang: it
langdirlevel: 2
locales: zh-hans,ja,it,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko,zh-hant,ar,hi,th,sv,cs,uk,he
description: Come utilizzare Python per applicare filtri per immagini e foto DICOM su applicazioni desktop e web.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Utilizza Python per applicare filtri per immagini DICOM" h2="Crea app Python per filtrare immagini e foto DICOM tramite API server" logoImageSrc="/imaging/images/imaging/aspose_imaging-for-python-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="DICOM" pfName="Aspose.Imaging" subTitlepfName="per Python" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Passaggi per filtrare DICOM tramite Python" %}}
...
{{% blocks/products/pf/agp/code-block title="Filtra immagini DICOM - Python" offSpacer="" %}}
