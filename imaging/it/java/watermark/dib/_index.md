---
title: Documento filigrana DIB tramite Java 
weight: 3920
url: /it/java/watermark/dib/ 
lang: it
langdirlevel: 2
locales: zh-hans,ja,it,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko,zh-hant
description: Esempio di codice di conversione Java per il formato DIB in file . Utilizzare questo codice di esempio per convertire DIB in  all'interno di qualsiasi applicazione basata su Java Web o desktop.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Aggiungi filigrana di testo a DIB tramite Java" h2="Crea le tue app Java per filigranare i file DIB utilizzando le API lato server." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/imaging/aspose_imaging-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="DIB" pfName="Aspose.Imaging" subTitlepfName="per Java" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Passaggi per aggiungere filigrana a DIB tramite Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Immagine filigrana DIB - Java" offSpacer="" %}}
