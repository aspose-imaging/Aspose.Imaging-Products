---
title: Documento filigrana BMP tramite Java 
weight: 3920
url: /it/java/watermark/bmp/ 
lang: it
langdirlevel: 2
locales: zh-hans,ja,it,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko,zh-hant,ar,hi,th,sv,cs,uk,he
description: Esempio di codice di conversione Java per il formato BMP in file . Utilizzare questo codice di esempio per convertire BMP in  all'interno di qualsiasi applicazione basata su Java Web o desktop.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Aggiungi filigrana di testo a BMP tramite Java" h2="Crea le tue app Java per filigranare i file BMP utilizzando le API lato server." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/imaging/aspose_imaging-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="BMP" pfName="Aspose.Imaging" subTitlepfName="per Java" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/content h2="Come filigranare il file BMP utilizzando Java" %}}

Per filigranare il file BMP, useremo [Aspose.Imaging per Java](https://products.aspose.com/imaging/java) API che è un'API di conversione e manipolazione delle immagini ricca di funzionalità, potente e facile da usare per la piattaforma Java. Puoi scaricare la sua ultima versione direttamente da [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-imaging) e installalo all'interno del tuo progetto basato su Maven aggiungendo le seguenti configurazioni a pom.xml.
...
{{% blocks/products/pf/agp/feature-section-col title="Passaggi per aggiungere filigrana a BMP tramite Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Immagine filigrana BMP - Java" offSpacer="" %}}
