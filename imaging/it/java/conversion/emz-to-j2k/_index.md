...
description: Codice di esempio per la conversione Java da EMZ a J2K. Utilizzare il codice di esempio API per la conversione batch di file EMZ in J2K all'interno di qualsiasi applicazione basata su Java Web o desktop.
---
