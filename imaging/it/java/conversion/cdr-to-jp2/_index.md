...
description: Codice di esempio per la conversione Java da CDR a JP2. Utilizzare il codice di esempio API per la conversione batch di file CDR in JP2 all'interno di qualsiasi applicazione basata su Java Web o desktop.
---
...
{{% blocks/products/pf/agp/code-block title="Converti CDR in JP2 - Java" offSpacer="true" %}}
