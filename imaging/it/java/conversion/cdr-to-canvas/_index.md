...
description: Codice di esempio per la conversione Java da CDR a CANVAS. Utilizzare il codice di esempio API per la conversione batch di file CDR in CANVAS all'interno di qualsiasi applicazione basata su Java Web o desktop.
---
...
{{% blocks/products/pf/agp/code-block title="Converti CDR in CANVAS - Java" offSpacer="true" %}}
