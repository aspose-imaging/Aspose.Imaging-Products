...
description: Codice di esempio per la conversione Java da CDR a BMP. Utilizzare il codice di esempio API per la conversione batch di file CDR in BMP all'interno di qualsiasi applicazione basata su Java Web o desktop.
---
...
Per convertire CDR in BMP, useremo [Aspose.Imaging per Java](https://products.aspose.com/imaging/java) API che è un'API di conversione e manipolazione delle immagini ricca di funzionalità, potente e facile da usare per la piattaforma Java. Puoi scaricare la sua ultima versione direttamente da [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-imaging) e installalo all'interno del tuo progetto basato su Maven aggiungendo le seguenti configurazioni a pom.xml.
...
{{% blocks/products/pf/agp/code-block title="Converti CDR in BMP - Java" offSpacer="true" %}}
