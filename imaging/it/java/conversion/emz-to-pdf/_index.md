...
description: Codice di esempio per la conversione Java da EMZ a PDF. Utilizzare il codice di esempio API per la conversione batch di file EMZ in PDF all'interno di qualsiasi applicazione basata su Java Web o desktop.
---
...
{{% blocks/products/pf/agp/code-block title="Converti EMZ in PDF - Java" offSpacer="true" %}}
