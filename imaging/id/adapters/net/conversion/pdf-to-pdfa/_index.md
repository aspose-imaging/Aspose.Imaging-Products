...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Convert PDF to PDFA via C#" %}}

{{% blocks/products/pf/agp/text %}}

Developers can easily load & convert PDF files to PDFA in just a few lines of code.
...
{{% blocks/products/pf/agp/code-block title="Convert PDF to PDFA - .NET" offSpacer="true" %}}
