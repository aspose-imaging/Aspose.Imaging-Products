---
title: Ubah latar belakang dalam dokumen CDR melalui .NET 
weight: 3920
url: /id/net/change-background/cdr/ 
lang: id
langdirlevel: 2
locales: ja,it,zh-hant,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko,zh-hans,ar,hi,th,sv,cs,uk,he
description: Coba API dokumen Lokal kami untuk mengubah latar belakang dari file CDR di .NET Framework, .NET Core, Aplikasi Windows, Aplikasi Web ASP.NET.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Ubah latar belakang dalam CDR melalui C#" h2="Buat aplikasi .NET Anda sendiri untuk Mengubah latar belakang dalam file CDR menggunakan API sisi server." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/imaging/aspose_imaging-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="CDR" pfName="Aspose.Imaging" subTitlepfName="untuk .NET" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/content h2="Cara mengubah latar belakang di File CDR Menggunakan C#" %}}

Untuk mengubah latar belakang dalam file CDR, kami akan menggunakan [Aspose.Imaging for .NET](https://products.aspose.com/imaging/net) API yang kaya fitur, kuat, dan mudah digunakan manipulasi gambar dan konversi API untuk platform C#. Membuka [NuGet](https://www.nuget.org/packages/aspose.imaging) manajer paket, cari **Aspose.Imaging** dan menginstal. Anda juga dapat menggunakan perintah berikut dari Package Manager Console.
...
{{% blocks/products/pf/agp/feature-section-col title="Langkah-langkah untuk Mengubah latar belakang dalam CDR melalui C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Mengubah latar belakang dalam gambar CDR - .NET" offSpacer="" %}}
