---
title: Ubah latar belakang dalam dokumen SVG melalui .NET 
weight: 3920
url: /id/net/change-background/svg/ 
lang: id
langdirlevel: 2
locales: ja,it,zh-hant,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko,zh-hans,ar,hi,th,sv,cs,uk,he
description: Coba API dokumen Lokal kami untuk mengubah latar belakang dari file SVG di .NET Framework, .NET Core, Aplikasi Windows, Aplikasi Web ASP.NET.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Ubah latar belakang dalam SVG melalui C#" h2="Buat aplikasi .NET Anda sendiri untuk Mengubah latar belakang dalam file SVG menggunakan API sisi server." logoImageSrc="/imaging/images/imaging/aspose_imaging-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="SVG" pfName="Aspose.Imaging" subTitlepfName="untuk .NET" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/content h2="Cara mengubah latar belakang di File SVG Menggunakan C#" %}}

Seringkali, untuk mendapatkan gambar ideal, diperlukan perubahan latar belakang. Untuk mendapatkan efek gambar berformat SVG yang diinginkan, objek latar depan harus diisolasi dari gambar lainnya. Deteksi objek otomatis dimungkinkan jika latar belakangnya seragam. Jika latar belakang foto tidak rata atau pemisahan objek sulit dilakukan, disarankan untuk memberi tanda terlebih dahulu pada gambar. Hal ini melibatkan identifikasi wilayah persegi panjang di dalam foto tempat objek yang dituju berada dan menentukan tipenya. Hal ini dapat dilakukan secara manual atau otomatis melalui fitur pengenalan objek Cloud API. Setelah pemilihan objek dan penghapusan latar belakang asli, latar belakang baru dapat diterapkan atau transparansi dapat diterapkan. Untuk mengubah latar belakang file SVG, kami akan menggunakan [Aspose.Imaging for .NET](https://products.aspose.com/imaging/net) API yang kaya fitur, kuat, dan mudah digunakan manipulasi gambar dan konversi API untuk platform C#. Membuka [NuGet](https://www.nuget.org/packages/aspose.imaging) manajer paket, cari **Aspose.Imaging** dan menginstal. Anda juga dapat menggunakan perintah berikut dari Package Manager Console.
...
{{% blocks/products/pf/agp/feature-section-col title="Langkah-langkah untuk Mengubah latar belakang dalam SVG melalui C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Mengubah latar belakang dalam gambar SVG - .NET" offSpacer="" %}}
