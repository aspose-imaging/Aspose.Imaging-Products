...
Seringkali, untuk mendapatkan gambar ideal, diperlukan perubahan latar belakang. Untuk mendapatkan efek gambar berformat DICOM yang diinginkan, objek latar depan harus diisolasi dari gambar lainnya. Deteksi objek otomatis dimungkinkan jika latar belakangnya seragam. Jika latar belakang foto tidak rata atau pemisahan objek sulit dilakukan, disarankan untuk memberi tanda terlebih dahulu pada gambar. Hal ini melibatkan identifikasi wilayah persegi panjang di dalam foto tempat objek yang dituju berada dan menentukan tipenya. Hal ini dapat dilakukan secara manual atau otomatis melalui fitur pengenalan objek Cloud API. Setelah pemilihan objek dan penghapusan latar belakang asli, latar belakang baru dapat diterapkan atau transparansi dapat diterapkan. Untuk mengubah latar belakang file DICOM, kami akan menggunakan [Aspose.Imaging for .NET](https://products.aspose.com/imaging/net) API yang kaya fitur, kuat, dan mudah digunakan manipulasi gambar dan konversi API untuk platform C#. Membuka [NuGet](https://www.nuget.org/packages/aspose.imaging) manajer paket, cari **Aspose.Imaging** dan menginstal. Anda juga dapat menggunakan perintah berikut dari Package Manager Console.
