---
title: Ganggu dokumen APNG melalui .NET 
weight: 3920
url: /id/net/dither/apng/ 
lang: id
langdirlevel: 2
...
{{< blocks/products/pf/upper-banner h1="Ganggu APNG melalui C#" h2="Buat aplikasi .NET Anda sendiri ke file Dither APNG menggunakan API sisi server." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/imaging/aspose_imaging-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="APNG" pfName="Aspose.Imaging" subTitlepfName="untuk .NET" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/content h2="Cara Mengganggu APNG File Menggunakan C#" %}}

Untuk Dither APNG file, kami akan menggunakan [Aspose.Imaging for .NET](https://products.aspose.com/imaging/net) API yang kaya fitur, kuat, dan mudah digunakan manipulasi gambar dan konversi API untuk platform C#. Membuka [NuGet](https://www.nuget.org/packages/aspose.imaging) manajer paket, cari **Aspose.Imaging** dan menginstal. Anda juga dapat menggunakan perintah berikut dari Package Manager Console.
...
{{% blocks/products/pf/agp/feature-section-col title="Langkah-langkah untuk Mengalihkan APNG melalui C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Ganggu APNG gambar - .NET" offSpacer="" %}}
