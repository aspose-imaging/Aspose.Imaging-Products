...
{{% blocks/products/pf/agp/content h2="Cara Mengganggu DICOM File Menggunakan C#" %}}

Untuk Dither DICOM file, kami akan menggunakan [Aspose.Imaging for .NET](https://products.aspose.com/imaging/net) API yang kaya fitur, kuat, dan mudah digunakan manipulasi gambar dan konversi API untuk platform C#. Membuka [NuGet](https://www.nuget.org/packages/aspose.imaging) manajer paket, cari **Aspose.Imaging** dan menginstal. Anda juga dapat menggunakan perintah berikut dari Package Manager Console.
...
{{% blocks/products/pf/agp/feature-section-col title="Langkah-langkah untuk Mengalihkan DICOM melalui C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Ganggu DICOM gambar - .NET" offSpacer="" %}}
