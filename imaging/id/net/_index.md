...
description: Pemrosesan gambar dan manipulasi perpustakaan API untuk membuat edit gambar atau ekspor gambar ke PSD BMP JPEG PNG TIFF GIF dalam aplikasi C# ASP.NET VB.NET
---
...
{{< blocks/products/pf/carousel-item h3="" description="Ikhtisar API." >}}
<div class="diagram1 d1-net">
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="Gambar .NET API" src="/imaging/images/imaging/aspose_imaging-for-net.svg"/>
  <header>
   Aspose.Imaging
  </header>
  <footer>
...
{{< blocks/products/pf/carousel-item h3="" description="Aspose.Imaging untuk .NET mendukung .NET framework dan .NET Standard" >}}
<div class="diagram1 d1-net">
 <div class="d1-row">
  <div class="d1-col d1-left">
   <header>
  ...
  <div class="d1-col d1-right">
   ...
   <ul>
    ...
    <li>
     Aplikasi Linux berbasis .NET Core
    </li>
   </ul>
  </div>
  <!--/right-->
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt=".NET API Pemrosesan Gambar" src="/imaging/images/imaging/aspose_imaging-for-net.svg"/>
  <header>
   Aspose.Imaging
  </header>
  <footer>
...
{{< blocks/products/pf/carousel-item h3="" description="Aspose.Imaging untuk .NET mendukung berbagai gambar [format file](https://docs.aspose.com/imaging/net/supported-file-formats/)." >}}
<div class="diagram1 d2 d1-net">
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="Pengolah Gambar C# Mengedit foto Mengedit gambar" src="/imaging/images/imaging/aspose_imaging-for-net.svg"/>
  <header>
   Aspose.Imaging
  </header>
  <footer>
...
<div class="container-fluid features-section bg-gray singleproduct">
 ...
 <div class="row">
  <div class="container">
   <h2 class="pr-ft">
    Fitur API Pemrosesan Gambar Tingkat Lanjut
   </h2>
   <p>
   </p>
   <div class="col-lg-4">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
    <a href="/imaging/id/net/conversion/">
     Konversikan gambar ke berbagai format
    </a>
    </p>
   </div>
   <div class="col-lg-4">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Mendukung gambar multi-bingkai animasi
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Pemrosesan halaman gambar seragam (bingkai)
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Menggambar gambar menggunakan Grafik (jalur grafik dan bentuk geometris yang berbeda)
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
    <a href="/imaging/id/net/remove-background/">    
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Gambar teks sambil mengontrol aspek font
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Simpan SVG dengan font yang disematkan atau diekspor
    </p>
   </div>
   <div class="col-lg-4">
    <em class="fa fa-road ico-blue fa-2x col-lg-2">
    ...
    <p class="col-lg-10">
     <a href="/imaging/id/net/change-background/">
     Ubah latar belakang
     </a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="/imaging/id/net/watermark/">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="/imaging/id/net/compress/">
     Kompres
     </a>
    </p>
   </div>
<div class="col-lg-4">
    ...
    <p class="col-lg-10"><a href="/imaging/id/net/adapters/">Adapters</a></p>
   </div>    
<div class="col-lg-12">
  <h2 class="h2title">Berbagai filter dan efek gambar</h2>
</div>
   <div class="col-lg-4">
    <em class="fa fa-compass ico-blue fa-2x col-lg-2">
    </em>
    <p class="col-lg-10">
     <a href="/imaging/id/net/dither/">
     Gentar
     </a>
    </p>
   </div>
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="/imaging/id/net/grayscale/">
     Skala abu-abu
     </a>
    </p>
   </div>
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="/imaging/id/net/cartoonify/">
     Buat kartun
     </a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="/imaging/id/net/binarize/">
     Binarisasi
     </a>
    </p>
   </div>
   ...
   <div class="col-lg-12">
    ...
    <p>
     Seiring dengan rangkaian rutinitas pemrosesan yang kaya, API juga menyediakan serangkaian algoritme canggih yang menjadikannya solusi lengkap untuk konversi gambar. Algoritme ini dikemas dalam kelas khusus, yang mudah digunakan dan dapat mengekspor gambar ke format raster konvensional bersama dengan format PSD, WMF, EMF, DjVu, DICOM, DNG, dan WebP dengan keandalan.
    </p>
    <p>
     Menggunakan perpustakaan ini, konversi format semudah mengubah ekstensi file ke format yang diinginkan.
    </p>
    <div class="codeblock" id="code">
     <h3>
      Simpan gambar dalam format yang berbeda - C#
     </h3>
{{< gist "aspose-com-gists" "38d4932ed13a06d560174ea9a85ea4cf" "save-image-in-different-formats.cs" >}}
   ...
   <div class="col-lg-12">
    ...
    <p>
     Aspose.Imaging for .NET mendukung serangkaian fitur menggambar tingkat lanjut bersama dengan fungsionalitas inti. Pengembang dapat menggambar pada permukaan gambar baik dengan memanipulasi informasi piksel atau dengan menggunakan fungsionalitas lanjutan seperti Grafik dan Jalur.
    </p>
    <p>
     Pustaka gambar .NET memungkinkan Anda menggambar garis, kurva, persegi panjang, dan bentuk geometris lainnya dengan mudah, mengisi bentuk tertutup dengan warna solid atau gradien & tekstur, menggambar teks dengan opsi untuk mengontrol font dengan baik, dan menggambar gambar dengan memuat data gambar yang ada.
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
    ...
    <p>
     Aspose.Imaging menyediakan kemampuan untuk memuat, mengedit, memproses, dan menyimpan foto. Menggunakan perpustakaan, Anda dapat dengan mudah mengedit foto yang dimuat, menerapkan filter, memanipulasinya menggunakan Grafik dan Jalur. Menggunakan Aspose.Imaging, Anda dapat dengan mudah memfilter foto.
    </p>
    <div class="codeblock" id="code">
     <h3>
      Muat, edit, filter, dan simpan foto - C#
     </h3>
{{< gist "aspose-com-gists" "38d4932ed13a06d560174ea9a85ea4cf" "load-edit-filter-save-photos.cs" >}}
   ...
   <div class="col-lg-12">
    ...
    <p>
     Aspose.Imaging untuk .NET mendukung gambar vektor terkompresi. Mereka adalah gambar vektor format EMF, WMF, SVG yang dikompresi menggunakan pengarsip zip. Ukuran mereka rata-rata 30-70% dari aslinya. Ini menghemat ruang pada media dan mengurangi waktu transfer file melalui jaringan.
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
     Buat gambar, manipulasi, dan simpan ke disk
    </h2>
    <p>
     Menggunakan Aspose.Imaging untuk .NET Anda dapat dengan mudah membuat gambar dengan parameter tertentu, memanipulasinya, dan menyimpannya.
    </p>
    <div class="codeblock" id="code">
     <h3>
      Buat gambar png, manipulasi, dan simpan - C#
     </h3>
...
<h2 class="h2title">Daftarkan Format File Gambar Kustom</h2>

<p>Fitur lain yang menjanjikan yang disediakan Aspose.Imaging for .NET adalah mendaftarkan format gambar khusus. Aspose.Imaging untuk .NET memungkinkan pengembang untuk mendaftarkan format file kustom baru untuk membuat, membuka atau mengekspor ke dengan menggunakan salah satu perpustakaan registri Aspose.Imaging untuk .NET untuk operasi yang sesuai. Fitur ini memungkinkan penambahan format file baru yang dapat digunakan untuk menggambar dan tujuan ekspor.</p>
...
{{< blocks/products/pf/slr-element name="Catatan Rilis" href="https://releases.aspose.com/imaging/net/release-notes/" >}}
{{< /blocks/products/pf/slr-tab >}}
