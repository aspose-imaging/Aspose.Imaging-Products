---
title: Dokumen skala abu-abu EPS melalui .NET 
weight: 3920
url: /id/net/grayscale/eps/ 
lang: id
langdirlevel: 2
locales: zh-hans,ja,it,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko,zh-hant,ar,hi,th,sv,cs,uk,he
description: Coba API dokumen Lokal kami untuk file skala abu-abu EPS di .NET Framework, .NET Core, Aplikasi Windows, Aplikasi Web ASP.NET.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Skala abu-abu EPS melalui C#" h2="Buat aplikasi .NET Anda sendiri ke file skala abu-abu EPS menggunakan API sisi server." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/imaging/aspose_imaging-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="EPS" pfName="Aspose.Imaging" subTitlepfName="untuk .NET" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/content h2="Cara Grayscale File EPS Menggunakan C#" %}}

Untuk file skala abu-abu EPS, kami akan menggunakan [Aspose.Imaging for .NET](https://products.aspose.com/imaging/net) API yang kaya fitur, kuat, dan mudah digunakan manipulasi gambar dan konversi API untuk platform C#. Membuka [NuGet](https://www.nuget.org/packages/aspose.imaging) manajer paket, cari **Aspose.Imaging** dan menginstal. Anda juga dapat menggunakan perintah berikut dari Package Manager Console.
...
{{% blocks/products/pf/agp/feature-section-col title="Langkah-langkah ke Grayscale EPS melalui C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Gambar skala abu-abu EPS - .NET" offSpacer="" %}}
