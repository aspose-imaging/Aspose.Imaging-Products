...
description: Menggunakan Aspose.Imaging Anda dapat dengan mudah mengonversi dari DICOM ke format lain menggunakan platform Java
---

{{< blocks/products/pf/feature-page-wrap >}}
{{< blocks/products/pf/feature-page-header h1="Konversi File Gambar dari DICOM menggunakan Aspose.Imaging untuk Java" h2="Konversikan dari DICOM ke format lain menggunakan platform Java" downloadText="Unduh" >}}


{{% blocks/products/pf/feature-page-section  h2="Semua format gambar yang didukung untuk dikonversi dari DICOM menggunakan Aspose.Imaging untuk Java" %}}
Menggunakan Aspose.Imaging Anda dapat dengan mudah mengonversi dari DICOM ke format lain yang didukung menggunakan platform Java.
<br/>
