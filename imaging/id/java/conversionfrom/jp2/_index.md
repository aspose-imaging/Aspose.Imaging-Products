...
description: Aspose.Imaging dapat dengan mudah mengonversi dari JP2 ke format lain menggunakan platform Java
---

{{< blocks/products/pf/feature-page-wrap >}}
{{< blocks/products/pf/feature-page-header h1="Konversikan gambar dari format JP2 menggunakan Aspose.Imaging untuk Java" h2="Konversi dari format gambar JP2 ke format lain menggunakan platform Java" downloadText="Unduh" >}}


{{% blocks/products/pf/feature-page-section  h2="Spektrum luas format gambar yang dapat dikonversi dari gambar JP2 menggunakan Aspose.Imaging untuk Java" %}}
