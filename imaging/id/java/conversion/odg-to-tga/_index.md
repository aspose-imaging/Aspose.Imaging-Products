...
description: Contoh kode untuk ODG ke TGA konversi Java. Gunakan kode contoh API untuk file batch ODG ke konversi TGA dalam aplikasi berbasis Java Web atau Desktop.
---
...
Untuk mengonversi ODG ke TGA, kami akan menggunakan [Aspose.Imaging for Java](https://products.aspose.com/imaging/java) API yang kaya fitur, kuat dan mudah digunakan manipulasi gambar dan konversi API untuk platform Java. Anda dapat mengunduh versi terbarunya langsung dari [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-imaging) dan instal dalam proyek berbasis Maven Anda dengan menambahkan konfigurasi berikut ke pom.xml.
...
{{< blocks/imaging-app-widget
        sectionTitle="Aplikasi Gratis untuk Mengonversi ODG ke TGA"
        appName="Conversion"
        ...
        checkFreeAppLabel="Lihat [demo langsung kami untuk mengonversi ODG ke TGA]"
        checkFreeAppLabelUrl="(https://products.aspose.app/imaging/id/conversion/ODG-to-TGA)"
        showPreview="true">}}
