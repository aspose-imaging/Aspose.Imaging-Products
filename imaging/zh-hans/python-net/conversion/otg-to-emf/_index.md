...
{{% blocks/products/pf/agp/content h2="如何使用 Python 将 OTG 转换为 EMF" %}}

为了将 OTG 转换为 EMF，我们将使用 [Aspose.Imaging for Python via .NET](/imaging/zh-hans/python-net) API 是一个功能丰富、功能强大且易于使用的图像处理和转换 API，适用于 Python 平台。您可以使用系统命令中的以下命令安装它。
...
{{% blocks/products/pf/agp/code-block title="将 OTG 转换为 EMF - Python" offSpacer="" %}}
