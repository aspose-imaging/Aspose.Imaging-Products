...
{{% blocks/products/pf/agp/content h2="如何使用 Python 将 OTG 转换为 WEBP" %}}

为了将 OTG 转换为 WEBP，我们将使用 [Aspose.Imaging for Python via .NET](/imaging/zh-hans/python-net) API 是一个功能丰富、功能强大且易于使用的图像处理和转换 API，适用于 Python 平台。您可以使用系统命令中的以下命令安装它。
...
{{% blocks/products/pf/agp/feature-section-col title="通过 Python 将 OTG 转换为 WEBP 的步骤" %}}
...
{{% blocks/products/pf/agp/code-block title="将 OTG 转换为 WEBP - Python" offSpacer="" %}}
...
{{< blocks/imaging-app-widget
        sectionTitle="将 OTG 转换为 WEBP 的免费应用程序"
        appName="Conversion"
        extension="OTG-to-WEBP"
        label1="选择或拖放 OTG 图像"
        label2="选择格式并单击转换按钮"
        label3="点击下载按钮下载 WEBP 图像"
        checkFreeAppLabel="查看我们的 [将 OTG 转换为 WEBP 的现场演示]"
        checkFreeAppLabelUrl="(https://products.aspose.app/imaging/zh-hans/conversion/OTG-to-WEBP)"
        showPreview="true">}}
