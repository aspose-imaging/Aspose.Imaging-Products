---
title: 使用 Python 将 OTG 转换为 PNG 
weight: 3920
url: /zh-hans/python-net/conversion/otg-to-png/ 
lang: zh-hans
langdirlevel: 2
locales: ja,it,zh-hant,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko,zh-hans,ar,hi,th,sv,cs,uk,he
description: OTG 到 PNG Python 语言转换的示例代码。使用提供的 API 示例代码，使用任何基于 Web 或桌面 Python 语言的应用程序处理 OTG 到 PNG 的转换。
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="使用 Python 语言将 OTG 转换为 PNG" h2="使用本机 Python 语言 API 将 OTG 转换为 PNG，无需任何图像编辑器或第 3 方库。" logoImageSrc="/imaging/images/imaging/aspose_imaging-for-python-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PNG" pfName="Aspose.Imaging" subTitlepfName="对于 Python" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="APNG" >}}
...
{{% blocks/products/pf/agp/content h2="如何使用 Python 将 OTG 转换为 PNG" %}}

为了将 OTG 转换为 PNG，我们将使用 [Aspose.Imaging for Python via .NET](/imaging/zh-hans/python-net) API 是一个功能丰富、功能强大且易于使用的图像处理和转换 API，适用于 Python 平台。您可以使用系统命令中的以下命令安装它。
...
{{% blocks/products/pf/agp/code-block title="将 OTG 转换为 PNG - Python" offSpacer="" %}}
