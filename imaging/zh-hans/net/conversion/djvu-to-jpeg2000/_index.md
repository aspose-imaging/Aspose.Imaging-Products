---
title: 通过 C# 将 DJVU 转换为 JPEG2000 
weight: 3920
url: /zh-hans/net/conversion/djvu-to-jpeg2000/ 
lang: zh-hans
langdirlevel: 2
locales: ja,it,zh-hant,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko,zh-hans,ar,hi,th,sv,cs,uk,he
description: DJVU 到 JPEG2000 C# 转换的示例代码。使用 API 示例代码在 VB.NET、Asp.NET 或任何基于 .NET 的应用程序中将 DJVU 文件批量转换为 JPEG2000。
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="通过 C# 将 DJVU 转换为 JPEG2000" h2="使用原生 .NET API 将 DJVU 转换为 JPEG2000，无需任何图像编辑器或第 3 方库。" logoImageSrc="/imaging/images/imaging/aspose_imaging-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="JPEG2000" pfName="Aspose.Imaging" subTitlepfName=".NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="APNG" >}}
...
{{% blocks/products/pf/agp/content h2="如何使用 C# 将 DJVU 转换为 JPEG2000" %}}

为了将 DJVU 转换为 JPEG2000，我们将使用 [Aspose.Imaging for .NET](https://products.aspose.com/imaging/net) API 是一个功能丰富、功能强大 易于使用的 C# 平台图像处理和转换 API。打开 [NuGet](https://www.nuget.org/packages/aspose.imaging) 包管理器，搜索 **Aspose.Imaging** 并安装。您还可以从包管理器控制台使用以下命令。
...
{{% blocks/products/pf/agp/feature-section-col title="通过 C# 将 DJVU 转换为 JPEG2000 的步骤" %}}

{{% blocks/products/pf/agp/text %}}

开发人员只需几行代码即可轻松加载 DJVU 文件并将其转换为 JPEG2000。
...
{{% blocks/products/pf/agp/code-block title="将 DJVU 转换为 JPEG2000 - .NET" offSpacer="" %}}
...
{{< blocks/imaging-app-widget
        sectionTitle="将 DJVU 转换为 JPEG2000 的免费应用程序"
        appName="Conversion"
        extension="DJVU-to-JPEG2000"
        label1="选择或拖放 DJVU 图像"
        label2="选择格式并单击转换按钮"
        label3="点击下载按钮下载 JPEG2000 图像"
        checkFreeAppLabel="查看我们的 [将 DJVU 转换为 JPEG2000 的现场演示]"
        checkFreeAppLabelUrl="(https://products.aspose.app/imaging/zh-hans/conversion/DJVU-to-JPEG2000)"
        showPreview="true">}}
