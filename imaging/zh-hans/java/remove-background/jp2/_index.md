---
title: 通过 Java 删除 JP2 文档中的背景 
weight: 3920
url: /zh-hans/java/remove-background/jp2/ 
lang: zh-hans
langdirlevel: 2
...
{{% blocks/products/pf/agp/content h2="如何使用 Java 删除 JP2 文件中的背景" %}}

为了去除 JP2 文件中的背景，我们将使用 [Aspose.Imaging for Java](https://products.aspose.com/imaging/java) API 是一个功能丰富、功能强大 易于使用的 Java 平台图像处理和转换 API。您可以直接从 [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-imaging)
...
{{% blocks/products/pf/agp/feature-section-col title="通过 Java 从 JP2 中删除背景的步骤" %}}
...
{{% blocks/products/pf/agp/code-block title="删除 JP2 图像中的背景 - Java" offSpacer="" %}}
