---
title: 通过 Java 删除 DICOM 文档中的背景 
weight: 3920
url: /zh-hans/java/remove-background/dicom/ 
lang: zh-hans
langdirlevel: 2
...
{{% blocks/products/pf/agp/feature-section-col title="通过 Java 从 DICOM 中删除背景的步骤" %}}
...
{{% blocks/products/pf/agp/code-block title="删除 DICOM 图像中的背景 - Java" offSpacer="" %}}
