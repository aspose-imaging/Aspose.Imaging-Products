---
title: 通过 Java 对 EPS 文档进行二值化 
weight: 3920
url: /zh-hans/java/binarize/eps/ 
lang: zh-hans
langdirlevel: 2
...
{{% blocks/products/pf/agp/content h2="如何使用 Java 二进制化 EPS 文件" %}}

为了二进制化 EPS 文件，我们将使用 [Aspose.Imaging for Java](https://products.aspose.com/imaging/java) API 是一个功能丰富、功能强大 易于使用的 Java 平台图像处理和转换 API。您可以直接从 [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-imaging)
...
{{% blocks/products/pf/agp/feature-section-col title="通过 Java 对 EPS 进行二值化的步骤" %}}
...
{{% blocks/products/pf/agp/code-block title="二值化 EPS 图像 - Java" offSpacer="" %}}
