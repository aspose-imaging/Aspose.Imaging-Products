...
{{% blocks/products/pf/agp/content h2="如何使用 Java 将 GIF 转换为 SVGZ" %}}

为了将 GIF 转换为 SVGZ，我们将使用 [Aspose.Imaging for Java](https://products.aspose.com/imaging/java) API 是一个功能丰富、功能强大 易于使用的 Java 平台图像处理和转换 API。您可以直接从 [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-imaging)
...
{{% blocks/products/pf/agp/feature-section-col title="通过 Java 将 GIF 转换为 SVGZ 的步骤" %}}
...
{{% blocks/products/pf/agp/code-block title="将 GIF 转换为 SVGZ - Java" offSpacer="true" %}}
