...
{{% blocks/products/pf/agp/content h2="如何使用 Java 将 DIB 转换为 SVGZ" %}}

为了将 DIB 转换为 SVGZ，我们将使用 [Aspose.Imaging for Java](https://products.aspose.com/imaging/java) API 是一个功能丰富、功能强大 易于使用的 Java 平台图像处理和转换 API。您可以直接从 [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-imaging)
...
{{% blocks/products/pf/agp/feature-section-col title="通过 Java 将 DIB 转换为 SVGZ 的步骤" %}}
...
{{< blocks/imaging-app-widget
        sectionTitle="将 DIB 转换为 SVGZ 的免费应用程序"
        appName="Conversion"
        extension="DIB-to-SVGZ"
        label1="选择或拖放 DIB 图像"
        label2="选择格式并单击转换按钮"
        label3="点击下载按钮下载 SVGZ 图像"
        checkFreeAppLabel="查看我们的 [将 DIB 转换为 SVGZ 的现场演示]"
        checkFreeAppLabelUrl="(https://products.aspose.app/imaging/zh-hans/conversion/DIB-to-SVGZ)"
        showPreview="true">}}

{{% blocks/products/pf/agp/code-block title="将 DIB 转换为 SVGZ - Java" offSpacer="true" %}}
