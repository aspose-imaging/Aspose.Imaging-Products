---
title: Java 成像 API |绘制操纵和变换图像 
weight: 960
url: /zh-hans/java 
lang: zh-hans
langdirlevel: 2
locales: zh-hans,ja,it,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko,zh-hant,ar,hi,th,sv,cs,uk,he
description: Java 图像处理和操作库。无需任何图像编辑器即可在应用程序中创建加载视图编辑绘图或将图像转换为多种格式
---

{{< blocks/products/pf/main-wrap-class>}}
{{< blocks/products/pf/upper-banner h1="用于图像处理的 Java 库和 API" h2="无需任何图像编辑器即可创建、加载、操作或转换图像。" downloadFreeTrialText="下载免费试用版" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/imaging/headers/aspose_imaging-for-java.svg"  pfName="Aspose.Imaging" subTitlepfName="for Java" downloadUrl="https://downloads.aspose.com/imaging/java" >}}
...
<p align="justify">
 Aspose.Imaging for Java 是一个提供高级图像处理功能的库。您可以使用此 API 轻松创建、加载、操作、转换、压缩图像或照片。还有阿斯波。图像库支持绘图和使用图形基元。图像导出和转换（包括统一的多页图像处理）是 API 的核心功能之一，以及图像转换（调整大小、裁剪、翻转和旋转、二值化、灰度、调整）、高级图像处理功能（过滤、抖动、遮罩、去歪斜） ) 和内存优化策略。
</p>

<p align="justify">
 Aspose.Imaging for Java 是一个灵活、稳定和强大的 API，能够处理最常用的格式以及一些特殊格式，如 DjVu、DICOM、WebP 和 DNG。
</p>
...
<div class="diagram1 d1-java">
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="图像 Java API" src="https://www.aspose.cloud/templates/aspose/img/products/imaging/aspose_imaging-for-java.svg"/>
  <header>
   Aspose.Imaging
  </header>
  <footer>
...
{{< blocks/products/pf/carousel-item h3="" description="Aspose.Imaging for Java 支持 JDK 1.6 及更高版本。" >}}
<div class="diagram1 d1-java">
 <div class="d1-row">
  <div class="d1-col d1-left">
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="Java 图像处理 API" src="https://www.aspose.cloud/templates/aspose/img/products/imaging/aspose_imaging-for-java.svg"/>
  <header>
   Aspose.Imaging
  </header>
  <footer>
...
{{< blocks/products/pf/carousel-item h3="" description="Aspose.Imaging for Java 支持多种图像[文件格式](https://docs.aspose.com/imaging/java/supported-file-formats/)." >}}
<div class="diagram1 d2 d1-java">
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="图像处理器 C# 编辑照片 编辑图像" src="https://www.aspose.cloud/templates/aspose/img/products/imaging/aspose_imaging-for-java.svg"/>
  <header>
   Aspose.Imaging
  </header>
  <footer>
 ...
 <div class="row">
  <div class="container">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
    <a href="/imaging/zh-hans/java/conversion/">
     将图像转换为多种格式
    </a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
    <a href="/imaging/zh-hans/java/crop/">
     庄稼
    </a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
    <a href="/imaging/zh-hans/java/resize/">
     调整大小
    </a>
    </p>
   </div>
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
    <a href="/imaging/zh-hans/java/remove-background/">
     移除背景
    </a>
    </p>
   </div>
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="/imaging/zh-hans/java/change-background/">
     换背景
     </a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="/imaging/zh-hans/java/watermark/">
     为图像添加水印
     </a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="/imaging/zh-hans/java/viewer/">
     看图
     </a>
    </p>
   </div>   
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="/imaging/zh-hans/java/compress/">
     压缩
     </a>
    </p>
   </div>
<div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="/imaging/zh-hans/java/merge/">
     合并
     </a>
    </p>
   </div>
<div class="col-lg-12">
  <h2 class="h2title">各种图像滤镜和效果</h2>
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="/imaging/zh-hans/java/dither/">
     抖动
     </a>
    </p>
   </div>
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="/imaging/zh-hans/java/grayscale/">
     灰阶
     </a>
    </p>
   </div>
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="/imaging/zh-hans/java/filter/">
     筛选
     </a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="/imaging/zh-hans/java/cartoonify/">
     卡通化
     </a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="/imaging/zh-hans/java/binarize/">
     二值化
     </a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="/imaging/zh-hans/java/adjust/">
     调整
     </a>
    </p>
   </div>
...
<p>Aspose.Imaging for Java 提供的另一个有前途的功能是注册自定义图像格式。 Aspose.Imaging for .NET 允许开发人员通过使用 Aspose.Imaging for .NET 注册表库之一来注册新的自定义文件格式以创建、打开或导出以进行相应的操作。此功能允许添加可用于绘图和导出目的的新文件格式。</p>
...
{{< blocks/products/pf/slr-element name="文档" href="https://docs.aspose.com/imaging/java" >}}
{{< blocks/products/pf/slr-element name="源代码" href="https://github.com/aspose-imaging/Aspose.Imaging-for-Java" >}}
{{< blocks/products/pf/slr-element name="API 参考" href="https://apireference.aspose.com/java/imaging" >}}
...
{{< blocks/products/pf/download-section downloadFreeTrialLink="https://downloads.aspose.com/imaging/java" downloadFreeTrialText="下载免费试用版" pricingInformationText="定价信息" pricingInformationLink="https://purchase.aspose.com/pricing/imaging/java" >}}
