---
title: Konvertering av bilder från J2K till TGA med Python 
weight: 3920
url: /sv/python-net/conversion/j2k-to-tga/ 
lang: sv
langdirlevel: 2
locales: ja,it,zh-hant,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko,zh-hans,ar,hi,th,sv,cs,uk,he
description: Hur man använder Python för konvertering av bilder och foton från J2K till TGA på skrivbord och webbapplikationer.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Använd Python för bildkonvertering från J2K till TGA" h2="Skapa Python-appar för att konvertera J2K till TGA-bilder och foton via server-API:er" logoImageSrc="/imaging/images/imaging/aspose_imaging-for-python-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="TGA" pfName="Aspose.Imaging" subTitlepfName="för Python" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="APNG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att konvertera J2K till TGA via Python" %}}
...
{{% blocks/products/pf/agp/code-block title="Konvertera J2K till TGA - Python" offSpacer="true" %}}
