---
title: Gråskala ICO dokument via .NET 
weight: 3920
url: /sv/net/grayscale/ico/ 
lang: sv
langdirlevel: 2
...
{{< blocks/products/pf/upper-banner h1="Gråskala ICO via C#" h2="Bygg dina egna .NET-appar för ICO-filer i gråskala med hjälp av API:er på serversidan." logoImageSrc="/imaging/images/imaging/aspose_imaging-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="ICO" pfName="Aspose.Imaging" subTitlepfName="för .NET" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steg till gråskala ICOs via C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Gråskala ICO bilder - .NET" offSpacer="" %}}
