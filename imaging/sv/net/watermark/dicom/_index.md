---
title: Vattenstämpel DICOM dokument via C# 
weight: 3920
url: /sv/net/watermark/dicom/ 
lang: sv
langdirlevel: 2
locales: zh-hans,ja,it,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko,zh-hant,ar,hi,th,sv,cs,uk,he
description: Prova våra lokala dokument-API:er för att vattenmärka DICOM-filen på .NET Framework, .NET Core, Windows Application, ASP.NET Web Application.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Lägg till textvattenstämpel i DICOM via C#" h2="Bygg dina egna .NET-appar för att vattenmärka DICOM-filer med hjälp av API:er på serversidan." logoImageSrc="/imaging/images/imaging/aspose_imaging-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="DICOM" pfName="Aspose.Imaging" subTitlepfName="för .NET" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att lägga till vattenstämpel till DICOM via C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Vattenstämpel DICOM bild - .NET" offSpacer="" %}}
