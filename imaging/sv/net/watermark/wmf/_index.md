---
title: Vattenstämpel WMF dokument via C# 
weight: 3920
url: /sv/net/watermark/wmf/ 
lang: sv
langdirlevel: 2
locales: zh-hans,ja,it,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko,zh-hant,ar,hi,th,sv,cs,uk,he
description: Prova våra lokala dokument-API:er för att vattenmärka WMF-filen på .NET Framework, .NET Core, Windows Application, ASP.NET Web Application.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Lägg till textvattenstämpel i WMF via C#" h2="Bygg dina egna .NET-appar för att vattenmärka WMF-filer med hjälp av API:er på serversidan." logoImageSrc="/imaging/images/imaging/aspose_imaging-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="WMF" pfName="Aspose.Imaging" subTitlepfName="för .NET" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att lägga till vattenstämpel till WMF via C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Vattenstämpel WMF bild - .NET" offSpacer="" %}}
