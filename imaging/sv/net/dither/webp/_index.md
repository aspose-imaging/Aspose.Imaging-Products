---
title: Dithera WEBP-dokument via .NET 
weight: 3920
url: /sv/net/dither/webp/ 
lang: sv
langdirlevel: 2
...
{{< blocks/products/pf/upper-banner h1="Dithera WEBP via C#" h2="Bygg dina egna .NET-appar för att dithera WEBP-filer med hjälp av API:er på serversidan." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/imaging/aspose_imaging-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="WEBP" pfName="Aspose.Imaging" subTitlepfName="för .NET" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/content h2="Hur man ditherar WEBP-filer med C#" %}}

För att dithera WEBP-filer kommer vi att använda [Aspose.Imaging for .NET](https://products.aspose.com/imaging/net) API som är ett funktionsrikt, kraftfullt och lättanvänt API för bildmanipulation och konvertering för C#-plattformen. Öppna [NuGet](https://www.nuget.org/packages/aspose.imaging) pakethanteraren, sök efter
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att dithera WEBP via C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Dither WEBP-bilder - .NET" offSpacer="" %}}
