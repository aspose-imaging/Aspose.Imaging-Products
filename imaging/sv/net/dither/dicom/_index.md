---
title: Dithera DICOM-dokument via .NET 
weight: 3920
url: /sv/net/dither/dicom/ 
lang: sv
langdirlevel: 2
...
{{< blocks/products/pf/upper-banner h1="Dithera DICOM via C#" h2="Bygg dina egna .NET-appar för att dithera DICOM-filer med hjälp av API:er på serversidan." logoImageSrc="/imaging/images/imaging/aspose_imaging-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="DICOM" pfName="Aspose.Imaging" subTitlepfName="för .NET" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att dithera DICOM via C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Dither DICOM-bilder - .NET" offSpacer="" %}}
