---
title: Dithera TIFF-dokument via .NET 
weight: 3920
url: /sv/net/dither/tiff/ 
lang: sv
langdirlevel: 2
...
{{% blocks/products/pf/agp/content h2="Hur man ditherar TIFF-filer med C#" %}}

För att dithera TIFF-filer kommer vi att använda [Aspose.Imaging for .NET](https://products.aspose.com/imaging/net) API som är ett funktionsrikt, kraftfullt och lättanvänt API för bildmanipulation och konvertering för C#-plattformen. Öppna [NuGet](https://www.nuget.org/packages/aspose.imaging) pakethanteraren, sök efter
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att dithera TIFF via C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Dither TIFF-bilder - .NET" offSpacer="" %}}
