...
<div class="diagram1 d1-net">
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="Obrázek .NET API" src="/imaging/images/imaging/aspose_imaging-for-net.svg"/>
  <header>
   Aspose.Imaging
  </header>
  <footer>
...
<div class="diagram1 d1-net">
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt=".NET API pro zpracování obrazu" src="/imaging/images/imaging/aspose_imaging-for-net.svg"/>
  <header>
   Aspose.Imaging
  </header>
  <footer>
...
<div class="diagram1 d2 d1-net">
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="Obrazový procesor C# Upravit fotografii Upravit obrázek" src="/imaging/images/imaging/aspose_imaging-for-net.svg"/>
  <header>
   Aspose.Imaging
  </header>
  <footer>
...
<div class="col-lg-4">
    ...
    <p class="col-lg-10"><a href="/imaging/cs/adapters/net/">Adapters</a></p>
   </div>    
<div class="col-lg-12">
...
{{< blocks/products/pf/slr-element name="Poznámky k vydání" href="https://releases.aspose.com/imaging/net/release-notes/" >}}
{{< /blocks/products/pf/slr-tab >}}
