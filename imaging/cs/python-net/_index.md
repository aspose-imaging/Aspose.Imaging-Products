---
title: Python Imaging API | Aspose.Imaging pro Python přes .NET - Draw Manipulate and Transform Images 
weight: 960
url: /cs/python-net/ 
lang: cs
langdirlevel: 2
locales: zh-hans,ja,it,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko,zh-hant,ar,hi,th,sv,cs,uk,he
description: Python Knihovna pro zpracování a manipulaci s obrázky. Aspose.Imaging pro Python přes .NET umožňuje vytvářet, načítat, prohlížet, upravovat, kreslit nebo převádět obrázky do různých formátů v rámci aplikací bez jakéhokoli editoru obrázků
---
...
{{< blocks/products/pf/carousel-item h3="" description="Přehled API." >}}
...
{{< blocks/products/pf/carousel-item h3="" description="Aspose.Imaging pro Python přes .NET je k dispozici pro:" >}}
<div class="diagram1 d1-python">
 <div class="d1-row">
  <div class="d1-col d1-left">
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="Python API pro zpracování obrazu" src="/imaging/images/imaging/aspose_imaging-for-python-net.svg"/>
  <header>
   Aspose.Imaging
  </header>
  <footer>
...
{{< blocks/products/pf/carousel-item h3="" description="Aspose.Imaging pro Python podporuje různé obrázky [formáty souborů](https://docs.aspose.com/imaging/python-net/supported-file-formats/)." >}}
<div class="diagram1 d2 d1-python">
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="Obrazový procesor C# Upravit fotografii Upravit obrázek" src="/imaging/images/imaging/aspose_imaging-for-python-net.svg"/>
  <header>
   Aspose.Imaging
  </header>
  <footer>
 ...
 <div class="row">
  <div class="container">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
    <a href="/imaging/cs/python-net/conversion/">
     Převeďte obrázky do různých formátů
    </a>
    </p>
   </div>
   <div class="col-lg-4">
...
<div class="col-lg-12">
  <h2 class="h2title">Různé obrazové filtry a efekty</h2>
</div>
   <div class="col-lg-4">
   ...
   <div class="col-lg-12">
    ...
    <div class="codeblock" id="code">
     <h3>
      Uložit obrázek v různých formátech - Python
     </h3>
{{< gist "aspose-com-gists" "afe32f26944235686ade7c8b3c43cf30" "save-image-in-different-formats.py" >}}
   ...
   <div class="col-lg-12">
    ...
    <p>
     Aspose.Imaging pro Python podporuje pokročilou sadu funkcí kreslení spolu se základními funkcemi. Vývojáři mohou kreslit na povrch obrazu buď manipulací s informacemi o pixelech, nebo pomocí pokročilých funkcí, jako je grafika a cesty.
    </p>
    <p>
     Knihovna obrázků Python vám umožňuje snadno kreslit čáry, křivky, obdélníky a další geometrické tvary, vyplňovat uzavřené tvary plnými barvami nebo přechody a texturami, kreslit text s možnostmi jemné kontroly nad písmem a kreslit obrázky načítáním existujících obrazových dat.
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
    ...
    <div class="codeblock" id="code">
     <h3>
      Nahrávejte, upravujte, filtrujte a ukládejte fotografie - Python
     </h3>
{{< gist "aspose-com-gists" "afe32f26944235686ade7c8b3c43cf30" "load-edit-filter-save-photos.py" >}}
   ...
   <div class="col-lg-12">
    ...
    <p>
     Aspose.Imaging pro Python podporuje komprimované vektorové obrázky. Jsou to vektorové obrázky formátů EMF, WMF, SVG komprimované pomocí archivátoru zip. Jejich velikost se pohybuje v průměru od 30-70% originálu. To šetří místo na médiích a zkracuje dobu přenosu souborů po síti.
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
    ...
    <p>
     Pomocí Aspose.Imaging pro Python můžete snadno vytvářet obrázky se zadanými parametry, manipulovat s nimi a ukládat je.
    </p>
    <div class="codeblock" id="code">
     <h3>
      Vytvořte obrázek png, upravte jej a uložte - Python
     </h3>
...
<h2 class="h2title">Zaregistrujte vlastní formáty obrazových souborů</h2>

<p>Další slibnou funkcí, kterou Aspose.Imaging pro Python poskytuje, je registrace vlastních formátů obrázků. Aspose.Imaging for .NET umožňuje vývojářům registrovat nové vlastní formáty souborů, které mohou vytvářet, otevírat nebo exportovat pomocí jedné z knihoven registru Aspose.Imaging for .NET pro odpovídající operace. Tato funkce umožňuje přidávat nové formáty souborů, které lze použít pro účely kreslení a exportu.</p>
...
{{< blocks/products/pf/slr-element name="Poznámky k vydání" href="https://releases.aspose.com/imaging/python-net/release-notes/" >}}
{{< /blocks/products/pf/slr-tab >}}

{{< blocks/products/pf/slr-tab tabTitle="Proč Aspose.Imaging pro Python" tabId="success-stories" >}}
...
{{< blocks/products/pf/download-section downloadFreeTrialLink="https://downloads.aspose.com/imaging/python-net/" downloadFreeTrialText="Stáhněte si zkušební verzi zdarma" pricingInformationText="Informace o cenách" pricingInformationLink="https://purchase.aspose.com/pricing/imaging/python-net/" >}}
