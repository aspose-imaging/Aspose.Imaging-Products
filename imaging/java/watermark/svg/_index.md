...
+  Create instance of SvgGraphics2D from the Image
+  Define Font for watermark text
+  Draw watermark using SvgGraphics2D.drawString method
+  Create instance of SvgImage using SvgGraphics2D.endRecording method
+  Save SvgImage to disc in SVG format
