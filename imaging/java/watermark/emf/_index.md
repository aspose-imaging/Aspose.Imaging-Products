...
+  Create instance of EmfRecorderGraphics2D from the Image
+  Define Font for watermark text
+  Draw watermark using EmfRecorderGraphics2D.drawString method
+  Create instance of EmfImage using EmfRecorderGraphics2D.endRecording method
+  Save EmfImage to disc in EMF format
