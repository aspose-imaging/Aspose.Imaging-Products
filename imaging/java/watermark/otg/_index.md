---
title: Watermark OTG document via Java 
weight: 760
...
{{< blocks/products/pf/upper-banner h1="Add Text Watermark to OTG via Java" h2="Build your own Java apps to watermark OTG files using server-side APIs." logoImageSrc="https://www.aspose.com/templates/aspose/App_Themes/V3/images/imaging/272x272/aspose_imaging-for-java.png" sourceAdditionalConversionTag="" additionalConversionTag="OTG" pfName="Aspose.Imaging" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/content h2="How to Watermark OTG File Using Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Add Watermark to OTG via Java" %}}
...
1.  Save image to disc in OTG format
...
{{% blocks/products/pf/agp/code-block title="Add Watermark to OTG - Java" offSpacer="" %}}

```cs

// Load image
Image image = Image.load("image.otg");
...
// Save image
image.save("watermarked-image.otg");  
