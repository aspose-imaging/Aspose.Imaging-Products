...
description: Sample Java conversion code for DICOM format to WMF file. Use this example code to convert DICOM to WMF within any Web or Desktop Java based application.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert DICOM to WMF via Java" h2="Transform DICOM as WMF using native Java library without any dependencies." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/imaging/aspose_imaging-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="WMF" pfName="Aspose.Imaging" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DICOM" >}}
...
{{% blocks/products/pf/agp/content h2="How to Convert DICOM to WMF Using Java" %}}
 ...
 In order to render DICOM to WMF, we’ll use
...
{{% blocks/products/pf/agp/text %}}
 ...
 Aspose.Imaging API makes it easy for the developers to convert DICOM file to WMF in just a few lines of code.
...
{{< gist "aspose-com-gists" "07be292db0a393dc95f153f84b28c069" "convert-dicom-to-wmf.java" >}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="DICOM to WMF Conversion Live Demos" sectionDescription="[Convert DICOM to WMF](https://products.aspose.app/imaging/conversion/dicom-to-wmf) right now by visiting our Live Demos website.The live demo has the following benefits" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" No need to download Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" No need to write any code." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Just upload your DICOM file, it will be converted instantly to WMF." >}}
