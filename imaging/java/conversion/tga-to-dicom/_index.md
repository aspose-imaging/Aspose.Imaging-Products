...
description: Sample Java conversion code for TGA format to DICOM file. Use this example code to convert TGA to DICOM within any Web or Desktop Java based application.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert TGA to DICOM via Java" h2="Transform TGA as DICOM using native Java library without any dependencies." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/imaging/aspose_imaging-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="DICOM" pfName="Aspose.Imaging" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="TGA" >}}
...
{{% blocks/products/pf/agp/content h2="How to Convert TGA to DICOM Using Java" %}}
 ...
 In order to render TGA to DICOM, we’ll use
...
{{% blocks/products/pf/agp/text %}}
 ...
 Aspose.Imaging API makes it easy for the developers to convert TGA file to DICOM in just a few lines of code.
...
{{< gist "aspose-com-gists" "07be292db0a393dc95f153f84b28c069" "convert-tga-to-dicom.java" >}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="TGA to DICOM Conversion Live Demos" sectionDescription="[Convert TGA to DICOM](https://products.aspose.app/imaging/conversion/tga-to-dicom) right now by visiting our Live Demos website.The live demo has the following benefits" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" No need to download Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" No need to write any code." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Just upload your TGA file, it will be converted instantly to DICOM." >}}
