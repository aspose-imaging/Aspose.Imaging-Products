---
title: Converter WEBP para CANVAS usando Python 
weight: 3920
url: /pt/python-net/conversion/webp-to-canvas/ 
lang: pt
langdirlevel: 2
locales: ja,it,zh-hant,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko,zh-hans,ar,hi,th,sv,cs,uk,he
description: Código de exemplo para conversão da linguagem Python WEBP para CANVAS. Use o código de exemplo de API apresentado para processar a conversão de WEBP para CANVAS usando qualquer aplicativo baseado na linguagem Python da Web ou da área de trabalho.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Converter WEBP para CANVAS usando a linguagem Python" h2="Transforme WEBP em CANVAS usando APIs de linguagem Python nativas e sem a necessidade de nenhum editor de imagens ou bibliotecas de terceiros." logoImageSrc="/imaging/images/imaging/aspose_imaging-for-python-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="CANVAS" pfName="Aspose.Imaging" subTitlepfName="para Python" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="APNG" >}}
...
{{% blocks/products/pf/agp/content h2="Como converter WEBP para CANVAS usando Python" %}}

Para converter WEBP em CANVAS, usaremos [Aspose.Imaging para Python via .NET](/imaging/pt/python-net) API que é uma API de manipulação e conversão de imagens rica em recursos, poderosa e fácil de usar para a plataforma Python. Você pode instalá-lo usando o seguinte comando do comando do sistema.
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para converter WEBP em CANVAS via Python" %}}
