---
title: Documento de marca d'água WMF via Python 
weight: 3920
url: /pt/python-net/watermark/wmf/ 
lang: pt
langdirlevel: 2
...
{{< blocks/products/pf/upper-banner h1="Adicionar marca d'água de texto a WMF por meio de Python" h2="Crie seus próprios aplicativos Python para marcar arquivos WMF com marca d'água usando APIs do lado do servidor." logoImageSrc="/imaging/images/imaging/aspose_imaging-for-python-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="WMF" pfName="Aspose.Imaging" subTitlepfName="para Python" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para adicionar marca d'água a WMF via Python" %}}
...
{{% blocks/products/pf/agp/code-block title="Imagem de marca d'água WMF - Python" offSpacer="" %}}
