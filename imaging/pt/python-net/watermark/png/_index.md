---
title: Documento de marca d'água PNG via Python 
weight: 3920
url: /pt/python-net/watermark/png/ 
lang: pt
langdirlevel: 2
...
{{< blocks/products/pf/upper-banner h1="Adicionar marca d'água de texto a PNG por meio de Python" h2="Crie seus próprios aplicativos Python para marcar arquivos PNG com marca d'água usando APIs do lado do servidor." logoImageSrc="/imaging/images/imaging/aspose_imaging-for-python-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PNG" pfName="Aspose.Imaging" subTitlepfName="para Python" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para adicionar marca d'água a PNG via Python" %}}
...
{{% blocks/products/pf/agp/code-block title="Imagem de marca d'água PNG - Python" offSpacer="" %}}
