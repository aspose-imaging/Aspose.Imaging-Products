---
title: Cartoonify documentos WEBP via Java 
weight: 3920
url: /pt/java/cartoonify/webp/ 
lang: pt
langdirlevel: 2
locales: zh-hans,ja,it,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko,zh-hant,ar,hi,th,sv,cs,uk,he
description: Experimente nossas APIs de documentos locais para Cartoonify arquivos WEBP no .NET Framework, .NET Core, Windows Application, ASP.NET Web Application.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Cartoonify WEBPs via Java" h2="Crie seus próprios aplicativos Java para arquivos Cartoonify WEBP usando APIs do lado do servidor." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/imaging/aspose_imaging-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="WEBP" pfName="Aspose.Imaging" subTitlepfName="para Java" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para caricaturar WEBPs via Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Imagens do Cartoonify WEBP - Java" offSpacer="" %}}
