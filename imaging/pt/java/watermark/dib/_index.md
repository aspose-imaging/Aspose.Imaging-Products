---
title: Documento de marca d'água DIB via Java 
weight: 3920
url: /pt/java/watermark/dib/ 
lang: pt
langdirlevel: 2
locales: zh-hans,ja,it,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko,zh-hant
description: Exemplo de código de conversão Java do formato DIB para o arquivo . Use este código de exemplo para converter DIB em  em qualquer aplicativo baseado em Java Web ou Desktop.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Adicionar marca d'água de texto a DIB por meio de Java" h2="Crie seus próprios aplicativos Java para marcar arquivos DIB com marca d'água usando APIs do lado do servidor." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/imaging/aspose_imaging-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="DIB" pfName="Aspose.Imaging" subTitlepfName="para Java" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para adicionar marca d'água a DIB via Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Imagem de marca d'água DIB - Java" offSpacer="" %}}
