---
title: Remova o plano de fundo em documentos BMP via Java 
weight: 3920
url: /pt/java/remove-background/bmp/ 
lang: pt
langdirlevel: 2
locales: ja,it,zh-hant,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko,zh-hans,ar,hi,th,sv,cs,uk,he
description: Experimente nossas APIs de documentos no local para alterar o plano de fundo de arquivos BMP no aplicativo Java.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Remova o plano de fundo de BMPs via Java" h2="Crie seus próprios aplicativos Java para remover o plano de fundo de arquivos BMP usando APIs do lado do servidor." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/imaging/aspose_imaging-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="BMP" pfName="Aspose.Imaging" subTitlepfName="para Java" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para remover o plano de fundo de BMPs via Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Remover plano de fundo em imagens BMP - Java" offSpacer="" %}}
