---
title: Remova o plano de fundo em documentos SVG via Java 
weight: 3920
url: /pt/java/remove-background/svg/ 
lang: pt
langdirlevel: 2
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para remover o plano de fundo de SVGs via Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Remover plano de fundo em imagens SVG - Java" offSpacer="" %}}
