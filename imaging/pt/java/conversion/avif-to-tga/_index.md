---
title: Converter AVIF para TGA via Java 
weight: 3920
url: /pt/java/conversion/avif-to-tga/ 
lang: pt
langdirlevel: 2
locales: ja,it,zh-hant,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko,zh-hans,ar,hi,th,sv,cs,uk,he
description: Código de exemplo para conversão Java de AVIF para TGA. Use o código de exemplo da API para arquivos em lote AVIF para conversão TGA em qualquer aplicativo baseado em Java da Web ou Desktop.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Converter AVIF para TGA via Java" h2="Transforme AVIF em TGA usando APIs Java nativas sem precisar de nenhum editor de imagens ou bibliotecas de terceiros." logoImageSrc="/imaging/images/imaging/aspose_imaging-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="TGA" pfName="Aspose.Imaging" subTitlepfName="para Java" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="APNG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para converter AVIF em TGA via Java" %}}

{{% blocks/products/pf/agp/text %}}

Os desenvolvedores podem facilmente carregar e converter arquivos AVIF para TGA em apenas algumas linhas de código.
...
{{< blocks/imaging-app-widget
        sectionTitle="Aplicativo gratuito para converter AVIF para TGA"
        appName="Conversion"
        ...
        checkFreeAppLabel="Confira nossas [demonstrações ao vivo para converter AVIF em TGA]"
        checkFreeAppLabelUrl="(https://products.aspose.app/imaging/pt/conversion/AVIF-to-TGA)"
        showPreview="true">}}
