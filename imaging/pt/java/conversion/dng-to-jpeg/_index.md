---
title: Converter DNG para JPEG via Java 
weight: 3920
url: /pt/java/conversion/dng-to-jpeg/ 
lang: pt
langdirlevel: 2
locales: ja,it,zh-hant,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko,zh-hans,ar,hi,th,sv,cs,uk,he
description: Código de exemplo para conversão Java de DNG para JPEG. Use o código de exemplo da API para arquivos em lote DNG para conversão JPEG em qualquer aplicativo baseado em Java da Web ou Desktop.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Converter DNG para JPEG via Java" h2="Transforme DNG em JPEG usando APIs Java nativas sem precisar de nenhum editor de imagens ou bibliotecas de terceiros." logoImageSrc="/imaging/images/imaging/aspose_imaging-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="JPEG" pfName="Aspose.Imaging" subTitlepfName="para Java" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="APNG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para converter DNG em JPEG via Java" %}}

{{% blocks/products/pf/agp/text %}}

Os desenvolvedores podem facilmente carregar e converter arquivos DNG para JPEG em apenas algumas linhas de código.
...
{{< blocks/imaging-app-widget
        sectionTitle="Aplicativo gratuito para converter DNG para JPEG"
        appName="Conversion"
        ...
        checkFreeAppLabel="Confira nossas [demonstrações ao vivo para converter DNG em JPEG]"
        checkFreeAppLabelUrl="(https://products.aspose.app/imaging/pt/conversion/DNG-to-JPEG)"
        showPreview="true">}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="/imaging/pt/java/conversion/dng-to-wmf/" name="WMF" description="Meta-arquivo do Microsoft Windows" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="/imaging/pt/java/conversion/dng-to-ico/" name="ICO" description="ícone do Windows" >}}
