...
description: Código de exemplo para conversão Java de EPS para DICOM. Use o código de exemplo da API para arquivos em lote EPS para conversão DICOM em qualquer aplicativo baseado em Java da Web ou Desktop.
---
