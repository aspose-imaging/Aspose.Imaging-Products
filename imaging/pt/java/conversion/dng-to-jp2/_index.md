...
description: Código de exemplo para conversão Java de DNG para JP2. Use o código de exemplo da API para arquivos em lote DNG para conversão JP2 em qualquer aplicativo baseado em Java da Web ou Desktop.
---
