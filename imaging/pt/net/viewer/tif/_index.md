---
title: Visualize documentos TIF via .NET 
weight: 3920
url: /pt/net/viewer/tif/ 
lang: pt
langdirlevel: 2
locales: zh-hans,ja,it,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko,zh-hant,ar,hi,th,sv,cs,uk,he
description: Experimente nossas APIs de documentos no local para exibir arquivos TIF no .NET Framework, .NET Core, Windows Application, ASP.NET Web Application.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Visualize TIFs via C#" h2="Crie seus próprios aplicativos .NET para visualizar arquivos TIF usando APIs do lado do servidor." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/imaging/aspose_imaging-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="TIF" pfName="Aspose.Imaging" subTitlepfName="para .NET" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para visualizar TIFs via C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Ver imagens de TIF - .NET" offSpacer="" %}}
...
{{< blocks/imaging-app-widget
        sectionTitle="Aplicativo gratuito para visualização TIF" 
        appName="Viewer" 
        extension="TIF"
        label1="Selecione ou arraste e solte uma imagem TIF" 
        label2="A imagem será carregada e mostrada automaticamente" 
        checkFreeAppLabel="Confira nossas [demonstrações ao vivo para ver TIF](https://products.aspose.app/imaging/pt/image-view/TIF)">}}
