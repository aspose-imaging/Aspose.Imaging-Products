---
title: Visualize documentos SVG via .NET 
weight: 3920
url: /pt/net/viewer/svg/ 
lang: pt
langdirlevel: 2
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para visualizar SVGs via C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Ver imagens de SVG - .NET" offSpacer="" %}}
