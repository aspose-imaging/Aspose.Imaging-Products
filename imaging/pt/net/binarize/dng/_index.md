---
title: Binarize documentos DNG via .NET 
weight: 3920
url: /pt/net/binarize/dng/ 
lang: pt
langdirlevel: 2
locales: zh-hans,ja,it,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko,zh-hant
description: Experimente nossas APIs de documentos locais para binarizar arquivos DNG no .NET Framework, .NET Core, Windows Application, ASP.NET Web Application.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Binarize DNGs via C#" h2="Crie seus próprios aplicativos .NET para binarizar arquivos DNG usando APIs do lado do servidor." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/imaging/aspose_imaging-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="DNG" pfName="Aspose.Imaging" subTitlepfName="para .NET" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para binarizar DNGs via C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Binarize imagens DNG - .NET" offSpacer="" %}}
