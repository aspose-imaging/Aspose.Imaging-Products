---
title: Binarize documentos SVG via .NET 
weight: 3920
url: /pt/net/binarize/svg/ 
lang: pt
langdirlevel: 2
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para binarizar SVGs via C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Binarize imagens SVG - .NET" offSpacer="" %}}
