---
title: Binarize documentos CMX via .NET 
weight: 3920
...
{{< blocks/products/pf/upper-banner h1="Binarize CMXs via C#" h2="Crie seus próprios aplicativos .NET para binarizar arquivos CMX usando APIs do lado do servidor." logoImageSrc="/imaging/images/imaging/aspose_imaging-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="CMX" pfName="Aspose.Imaging" subTitlepfName="para .NET" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para binarizar CMXs via C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Binarize imagens CMX - .NET" offSpacer="" %}}
