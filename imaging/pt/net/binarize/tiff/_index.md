---
title: Binarize documentos TIFF via .NET 
weight: 3920
url: /pt/net/binarize/tiff/ 
lang: pt
langdirlevel: 2
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para binarizar TIFFs via C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Binarize imagens TIFF - .NET" offSpacer="" %}}
