---
title: Binarize documentos PNG via .NET 
weight: 3920
url: /pt/net/binarize/png/ 
lang: pt
langdirlevel: 2
locales: zh-hans,ja,it,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko,zh-hant,ar,hi,th,sv,cs,uk,he
description: Experimente nossas APIs de documentos locais para binarizar arquivos PNG no .NET Framework, .NET Core, Windows Application, ASP.NET Web Application.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Binarize PNGs via C#" h2="Crie seus próprios aplicativos .NET para binarizar arquivos PNG usando APIs do lado do servidor." logoImageSrc="/imaging/images/imaging/aspose_imaging-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PNG" pfName="Aspose.Imaging" subTitlepfName="para .NET" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para binarizar PNGs via C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Binarize imagens PNG - .NET" offSpacer="" %}}
