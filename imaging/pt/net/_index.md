---
title: API de biblioteca de imagens de plataforma cruzada C# .NET - Aspose 
weight: 960
url: /pt/net 
lang: pt
langdirlevel: 2
...
{{< blocks/products/pf/upper-banner h1="Biblioteca multiplataforma .NET - API para processamento de imagens" h2="Crie, carregue, manipule ou converta imagens sem precisar de nenhum editor de imagens." downloadFreeTrialText="Baixar Teste Gratuito" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/imaging/headers/aspose_imaging-for-net.svg"  pfName="Aspose.Imaging" subTitlepfName="for .NET" downloadUrl="https://downloads.aspose.com/imaging/net" >}}
...
<p align="justify">
 Aspose.Imaging for .NET é uma API flexível, estável e poderosa, capaz de processar os formatos mais usados ​​juntamente com alguns formatos especiais como DjVu, DICOM, WebP & DNG. Além disso, ele estende o suporte nativo para formatos de imagem e funções de processamento para .NET e .NET Core. Aspose.Imaging é uma biblioteca multiplataforma, compatível com Windows e Linux.
</p>
...
<div class="diagram1 d1-net">
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="API de imagem .NET" src="https://www.aspose.cloud/templates/aspose/img/products/imaging/aspose_imaging-for-net.svg"/>
  <header>
   Aspose.Imaging
  </header>
  <footer>
...
{{< blocks/products/pf/carousel-item h3="" description="Aspose.Imaging for .NET suporta o .NET framework e .NET Standard" >}}
<div class="diagram1 d1-net">
 <div class="d1-row">
  <div class="d1-col d1-left">
   <header>
  ...
  <div class="d1-col d1-right">
   ...
   <ul>
    ...
    <li>
     Aplicativo Linux baseado em .NET Core
    </li>
   </ul>
  </div>
  <!--/right-->
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt=".NET API de processamento de imagem" src="https://www.aspose.cloud/templates/aspose/img/products/imaging/aspose_imaging-for-net.svg"/>
  <header>
   Aspose.Imaging
  </header>
  <footer>
...
{{< blocks/products/pf/carousel-item h3="" description="Aspose.Imaging para .NET suporta uma variedade de imagens [formatos de arquivo](https://docs.aspose.com/imaging/net/supported-file-formats/)." >}}
<div class="diagram1 d2 d1-net">
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="Processador de imagem C# Editar foto Editar imagem" src="https://www.aspose.cloud/templates/aspose/img/products/imaging/aspose_imaging-for-net.svg"/>
  <header>
   Aspose.Imaging
  </header>
  <footer>
...
{{< blocks/products/pf/slr-element name="Notas de lançamento" href="https://docs.aspose.com/imaging/net/release-notes/" >}}
{{< /blocks/products/pf/slr-tab >}}

{{< blocks/products/pf/slr-tab tabTitle="Por que Aspose.Imaging for .NET" tabId="success-stories" >}}
...
{{< blocks/products/pf/download-section downloadFreeTrialLink="https://downloads.aspose.com/imaging/net" downloadFreeTrialText="Baixar Teste Gratuito" pricingInformationText="Informações sobre preços" pricingInformationLink="https://purchase.aspose.com/pricing/imaging/net" >}}
