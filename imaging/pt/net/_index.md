...
{{< blocks/products/pf/upper-banner h1="Biblioteca multiplataforma .NET - API para processamento de imagens" h2="Crie, carregue, manipule ou converta imagens sem precisar de nenhum editor de imagens." downloadFreeTrialText="Baixar Teste Gratuito" logoImageSrc="/imaging/images/imaging/headers/aspose_imaging-for-net.svg"  pfName="Aspose.Imaging" subTitlepfName="for .NET" downloadUrl="https://downloads.aspose.com/imaging/net/" >}}
...
<div class="diagram1 d1-net">
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="API de imagem .NET" src="/imaging/images/imaging/aspose_imaging-for-net.svg"/>
  <header>
   Aspose.Imaging
  </header>
  <footer>
...
<div class="diagram1 d1-net">
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt=".NET API de processamento de imagem" src="/imaging/images/imaging/aspose_imaging-for-net.svg"/>
  <header>
   Aspose.Imaging
  </header>
  <footer>
...
<div class="diagram1 d2 d1-net">
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="Processador de imagem C# Editar foto Editar imagem" src="/imaging/images/imaging/aspose_imaging-for-net.svg"/>
  <header>
   Aspose.Imaging
  </header>
  <footer>
