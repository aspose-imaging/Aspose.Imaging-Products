---
title: Documento de marca d'água EMF via C# 
weight: 3920
url: /pt/net/watermark/emf/ 
lang: pt
langdirlevel: 2
locales: zh-hans,ja,it,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko,zh-hant
description: Experimente nossas APIs de documentos no local para marcar o arquivo EMF com marca d'água no .NET Framework, .NET Core, aplicativo do Windows, aplicativo da Web ASP.NET.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Adicionar marca d'água de texto a EMF por meio de C#" h2="Crie seus próprios aplicativos .NET para marcar arquivos EMF com marca d'água usando APIs do lado do servidor." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/imaging/aspose_imaging-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="EMF" pfName="Aspose.Imaging" subTitlepfName="para .NET" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para adicionar marca d'água a EMF via C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Imagem de marca d'água EMF - .NET" offSpacer="" %}}
