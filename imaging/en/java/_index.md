...
<div class="diagram1 d1-java">
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="Image Java API" src="/imaging/images/imaging/aspose_imaging-for-java.svg"/>
  <header>
   Aspose.Imaging
  </header>
  <footer>
...
{{< blocks/products/pf/carousel-item h3="" description="Aspose.Imaging for Java supports the JDK 1.6 and above." >}}
<div class="diagram1 d1-java">
 <div class="d1-row">
  <div class="d1-col d1-left">
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="Java Image Processing API" src="/imaging/images/imaging/aspose_imaging-for-java.svg"/>
  <header>
   Aspose.Imaging
  </header>
  <footer>
...
{{< blocks/products/pf/carousel-item h3="" description="Aspose.Imaging for Java supports a variety of image [file formats](https://docs.aspose.com/imaging/java/supported-file-formats/)." >}}
<div class="diagram1 d2 d1-java">
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="Image Processor C# Edit photo Edit image" src="/imaging/images/imaging/aspose_imaging-for-java.svg"/>
  <header>
   Aspose.Imaging
  </header>
  <footer>
 ...
 <div class="row">
  <div class="container">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
    <a href="/imaging/en/java/conversion/">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
    <a href="/imaging/en/java/remove-background/">    
     Remove background
    </a>
    </p>
   </div>
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="/imaging/en/java/change-background/">
     Change background
     </a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="/imaging/en/java/watermark/">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="/imaging/en/java/compress/">
     Compress
     </a>
    </p>
   </div>
...
<div class="col-lg-12">
  <h2 class="h2title">Various image filters and effects</h2>
</div>
   <div class="col-lg-4">
    <em class="fa fa-compass ico-blue fa-2x col-lg-2">
    </em>
    <p class="col-lg-10">
     <a href="/imaging/en/java/dither/">
     Dither
     </a>
    </p>
   </div>
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="/imaging/en/java/grayscale/">
     Grayscale
     </a>
    </p>
   </div>
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="/imaging/en/java/cartoonify/">
     Cartoonify
     </a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="/imaging/en/java/binarize/">
     Binarize
     </a>
    </p>
   </div>
...
{{< gist "aspose-com-gists" "31dbd78f64c3a37b9a8ab10d33885214" "save-image-in-different-formats.java" >}}
   ...
   <div class="col-lg-12">
    ...
    <p>
     Java image library enables you to easily draw lines, curves, rectangles and other geometric shapes, fill closed shapes with solid colors or gradients &amp; textures, draw text with options for fine control over the font and draw images by loading existing image data.
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
...
<p>Another promising feature that Aspose.Imaging for Java provides is to register custom image formats. Aspose.Imaging for .NET allows developers to register new custom file formats to create, open or export to by using one of the Aspose.Imaging for .NET registry libraries for corresponding operation. This feature allows the addition of new file formats which can be used for drawing and export purposes.</p>
...
{{< blocks/products/pf/slr-element name="Release Notes" href="https://releases.aspose.com/imaging/java/release-notes/" >}}
{{< /blocks/products/pf/slr-tab >}}
...
{{< blocks/products/pf/download-section downloadFreeTrialLink="https://downloads.aspose.com/imaging/java/" downloadFreeTrialText="Download Free Trial" pricingInformationText="Pricing Information" pricingInformationLink="https://purchase.aspose.com/pricing/imaging/java/" >}}
