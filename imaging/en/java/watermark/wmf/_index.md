...
description: Java sample code to add or remove watermark to WMF file on Java Runtime Environment for JSP/JSF Application and Desktop Applications.
---
...
1.  Save image to disc in WMF format
...
{{% blocks/products/pf/agp/code-block title="Add Watermark to WMF - Java" offSpacer="" %}}
