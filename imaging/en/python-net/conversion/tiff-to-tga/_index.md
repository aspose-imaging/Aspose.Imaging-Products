---
title: Convert TIFF to TGA  using Python 
weight: 3920
url: /python-net/conversion/tiff-to-tga/ 
lang: en
langdirlevel: 2
locales: ja,it,zh-hant,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko,zh-hans,ar,hi,th,sv,cs,uk,he
description: Sample code for TIFF to TGA Python language conversion. Use presented API example code to process TIFF to TGA conversion using any Web or Desktop Python language based application.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert TIFF to TGA using Python language" h2="Transform TIFF to TGA using native Python language APIs and without need of any image editor or 3rd-party libraries." logoImageSrc="/imaging/images/imaging/aspose_imaging-for-python-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="TGA" pfName="Aspose.Imaging" subTitlepfName="for Python" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="APNG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Convert TIFF to TGA Using Python" %}}

In order to convert TIFF to TGA, we’ll use [Aspose.Imaging for Python via .NET](/imaging/en/python-net) API which is a feature-rich, powerful and easy to use image manipulation and conversion API for Python platform. You may install it using the following command from your system command.
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Convert TIFF to TGA via Python" %}}
...
{{% blocks/products/pf/agp/code-block title="Convert TIFF to TGA - Python" offSpacer="" %}}
