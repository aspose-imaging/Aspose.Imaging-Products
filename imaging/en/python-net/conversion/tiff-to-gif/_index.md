...
{{% blocks/products/pf/agp/content h2="How to Convert TIFF to GIF Using Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Convert TIFF to GIF via Python" %}}
...
{{% blocks/products/pf/agp/code-block title="Convert TIFF to GIF - Python" offSpacer="true" %}}
