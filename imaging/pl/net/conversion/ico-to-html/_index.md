---
title: Konwertuj ICO na HTML przez C# 
weight: 3920
url: /pl/net/conversion/ico-to-html/ 
lang: pl
langdirlevel: 2
locales: ja,it,zh-hant,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko,zh-hans,ar,hi,th,sv,cs,uk,he
description: Przykładowy kod konwersji ICO do HTML C#. Użyj przykładowego kodu API dla plików wsadowych ICO do konwersji HTML w ramach VB.NET, Asp.NET lub dowolnej aplikacji opartej na .NET.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Konwertuj ICO na HTML przez C#" h2="Przekształć ICO w HTML za pomocą natywnych interfejsów API .NET bez konieczności używania edytora obrazów lub bibliotek innych firm." logoImageSrc="/imaging/images/imaging/aspose_imaging-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="HTML" pfName="Aspose.Imaging" subTitlepfName="dla .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="APNG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować ICO na HTML za pomocą C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Konwertuj ICO na HTML - .NET" offSpacer="true" %}}
