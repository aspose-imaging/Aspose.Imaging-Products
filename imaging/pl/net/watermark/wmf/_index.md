---
title: Dokument ze znakiem wodnym WMF za pośrednictwem C# 
weight: 3920
url: /pl/net/watermark/wmf/ 
lang: pl
langdirlevel: 2
locales: zh-hans,ja,it,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko,zh-hant
description: Wypróbuj nasze lokalne interfejsy API dokumentów, aby dodać znak wodny do pliku WMF w .NET Framework, .NET Core, aplikacji Windows, aplikacji sieci Web ASP.NET.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Dodaj tekstowy znak wodny do WMF przez C#" h2="Twórz własne aplikacje .NET do znakowania plików w formacie WMF przy użyciu interfejsów API po stronie serwera." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/imaging/aspose_imaging-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="WMF" pfName="Aspose.Imaging" subTitlepfName="dla .NET" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby dodać znak wodny do WMF przez C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Obraz znaku wodnego WMF – .NET" offSpacer="" %}}
