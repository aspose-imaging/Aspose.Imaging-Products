---
title: Usuń tło w dokumentach CDR za pośrednictwem .NET 
weight: 3920
url: /pl/net/remove-background/cdr/ 
lang: pl
langdirlevel: 2
locales: ja,it,zh-hant,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko,zh-hans,ar,hi,th,sv,cs,uk,he
description: Wypróbuj nasze lokalne interfejsy API dokumentów, aby usunąć tło w plikach CDR w platformach .NET Framework, .NET Core, aplikacji systemu Windows i aplikacji sieci Web ASP.NET.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Usuń tło z formatu CDR przez C#" h2="Twórz własne aplikacje .NET, aby usunąć tło z plików CDR za pomocą interfejsów API po stronie serwera." logoImageSrc="/imaging/images/imaging/aspose_imaging-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="CDR" pfName="Aspose.Imaging" subTitlepfName="dla .NET" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby usunąć tło z formatu CDR za pomocą C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Usuń tło z obrazów w formacie CDR – .NET" offSpacer="" %}}
