...
<div class="diagram1 d1-java">
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="Obraz Java API" src="/imaging/images/imaging/aspose_imaging-for-java.svg"/>
  <header>
   Aspose.Imaging
  </header>
  <footer>
...
<div class="diagram1 d1-java">
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="Java Interfejs API przetwarzania obrazu" src="/imaging/images/imaging/aspose_imaging-for-java.svg"/>
  <header>
   Aspose.Imaging
  </header>
  <footer>
...
<div class="diagram1 d2 d1-java">
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="Procesor obrazu C# Edytuj zdjęcie Edytuj obraz" src="/imaging/images/imaging/aspose_imaging-for-java.svg"/>
  <header>
   Aspose.Imaging
  </header>
  <footer>
 ...
 <div class="row">
  <div class="container">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
    <a href="/imaging/pl/java/conversion/">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
    <a href="/imaging/pl/java/remove-background/">    
     Usuń tło
    </a>
    </p>
   </div>
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="/imaging/pl/java/change-background/">
     Zmień tło
     </a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="/imaging/pl/java/watermark/">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="/imaging/pl/java/compress/">
     Kompresja
     </a>
    </p>
   </div>
...
<div class="col-lg-12">
  <h2 class="h2title">Różne filtry i efekty obrazu</h2>
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="/imaging/pl/java/grayscale/">
     Skala szarości
     </a>
    </p>
   </div>
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="/imaging/pl/java/cartoonify/">
     Kreskówka
     </a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="/imaging/pl/java/binarize/">
     Binaryzuj
     </a>
    </p>
   </div>
...
<p>Inną obiecującą funkcją oferowaną przez Aspose.Imaging dla Java jest rejestracja niestandardowych formatów obrazu. Aspose.Imaging for .NET umożliwia deweloperom rejestrowanie nowych niestandardowych formatów plików do tworzenia, otwierania lub eksportowania przy użyciu jednej z bibliotek rejestru Aspose.Imaging for .NET do odpowiedniej operacji. Ta funkcja umożliwia dodawanie nowych formatów plików, które można wykorzystać do rysowania i eksportowania.</p>
...
{{< blocks/products/pf/slr-element name="Dokumentacja" href="https://docs.aspose.com/imaging/java/" >}}
...
{{< blocks/products/pf/slr-element name="Informacje o wydaniu" href="https://releases.aspose.com/imaging/java/release-notes/" >}}
{{< /blocks/products/pf/slr-tab >}}
