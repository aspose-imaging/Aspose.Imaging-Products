---
title: Usuń tło w dokumentach EMF za pośrednictwem Java 
weight: 3920
url: /pl/java/remove-background/emf/ 
lang: pl
langdirlevel: 2
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby usunąć tło z formatu EMF za pomocą Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Usuń tło z obrazów w formacie EMF – Java" offSpacer="" %}}
