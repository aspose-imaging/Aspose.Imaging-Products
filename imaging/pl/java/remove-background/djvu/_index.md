---
title: Usuń tło w dokumentach DJVU za pośrednictwem Java 
weight: 3920
url: /pl/java/remove-background/djvu/ 
lang: pl
langdirlevel: 2
...
{{% blocks/products/pf/agp/content h2="Jak usunąć tło w plikach DJVU za pomocą Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby usunąć tło z formatu DJVU za pomocą Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Usuń tło z obrazów w formacie DJVU – Java" offSpacer="" %}}
