---
title: Usuń tło w dokumentach BMP za pośrednictwem Java 
weight: 3920
url: /pl/java/remove-background/bmp/ 
lang: pl
langdirlevel: 2
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby usunąć tło z formatu BMP za pomocą Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Usuń tło z obrazów w formacie BMP – Java" offSpacer="" %}}
