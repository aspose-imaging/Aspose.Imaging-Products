---
title: Usuń tło w dokumentach PNG za pośrednictwem Java 
weight: 3920
url: /pl/java/remove-background/png/ 
lang: pl
langdirlevel: 2
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby usunąć tło z formatu PNG za pomocą Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Usuń tło z obrazów w formacie PNG – Java" offSpacer="" %}}
