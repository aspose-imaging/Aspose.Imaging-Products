...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby zmienić tło w ODGs przez Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Zmień tło w obrazach ODG – Java" offSpacer="" %}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="/imaging/pl/java/change-background/avif/" name="AVIF" description="" >}}
