---
title: Filtrar documentos JP2 a través de .NET 
weight: 3920
url: /es/net/filter/jp2/ 
lang: es
langdirlevel: 2
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para filtrar JP2 a través de C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Filtrar imágenes JP2 - .NET" offSpacer="" %}}
