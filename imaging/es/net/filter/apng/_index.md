---
title: Filtrar documentos APNG a través de .NET 
weight: 3920
url: /es/net/filter/apng/ 
lang: es
langdirlevel: 2
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para filtrar APNG a través de C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Filtrar imágenes APNG - .NET" offSpacer="" %}}
