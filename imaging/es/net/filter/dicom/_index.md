---
title: Filtrar documentos DICOM a través de .NET 
weight: 3920
url: /es/net/filter/dicom/ 
lang: es
langdirlevel: 2
locales: zh-hans,ja,it,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko,zh-hant,ar,hi,th,sv,cs,uk,he
description: Pruebe nuestras API de documentos locales para filtrar archivos DICOM en .NET Framework, .NET Core, aplicación de Windows, aplicación web ASP.NET.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Filtra DICOM a través de C#" h2="Cree sus propias aplicaciones .NET para filtrar archivos DICOM utilizando las API del lado del servidor." logoImageSrc="/imaging/images/imaging/aspose_imaging-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="DICOM" pfName="Aspose.Imaging" subTitlepfName="para .NET" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para filtrar DICOM a través de C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Filtrar imágenes DICOM - .NET" offSpacer="" %}}
