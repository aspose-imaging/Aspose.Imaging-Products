---
title: Filtrar documentos DNG a través de .NET 
weight: 3920
url: /es/net/filter/dng/ 
lang: es
langdirlevel: 2
...
{{% blocks/products/pf/agp/content h2="Cómo filtrar archivos DNG usando C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para filtrar DNG a través de C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Filtrar imágenes DNG - .NET" offSpacer="" %}}
