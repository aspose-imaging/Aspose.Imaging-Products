---
title: Filtrar documentos TIFF a través de .NET 
weight: 3920
url: /es/net/filter/tiff/ 
lang: es
langdirlevel: 2
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para filtrar TIFF a través de C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Filtrar imágenes TIFF - .NET" offSpacer="" %}}
