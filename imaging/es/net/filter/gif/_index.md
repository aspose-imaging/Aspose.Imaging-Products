---
title: Filtrar documentos GIF a través de .NET 
weight: 3920
url: /es/net/filter/gif/ 
lang: es
langdirlevel: 2
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para filtrar GIF a través de C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Filtrar imágenes GIF - .NET" offSpacer="" %}}
