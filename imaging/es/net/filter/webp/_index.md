---
title: Filtrar documentos WEBP a través de .NET 
weight: 3920
url: /es/net/filter/webp/ 
lang: es
langdirlevel: 2
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para filtrar WEBP a través de C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Filtrar imágenes WEBP - .NET" offSpacer="" %}}
