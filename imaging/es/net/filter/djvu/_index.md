---
title: Filtrar documentos DJVU a través de .NET 
weight: 3920
url: /es/net/filter/djvu/ 
lang: es
langdirlevel: 2
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para filtrar DJVU a través de C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Filtrar imágenes DJVU - .NET" offSpacer="" %}}
