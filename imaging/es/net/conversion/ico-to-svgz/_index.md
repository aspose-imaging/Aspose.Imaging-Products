...
{{% blocks/products/pf/agp/content h2="Cómo convertir ICO a SVGZ usando C#" %}}

Para convertir ICO a SVGZ, usaremos [Aspose.Imaging para .NET](https://products.aspose.com/imaging/net) API, que es una API de conversión y manipulación de imágenes rica en funciones, potente y fácil de usar para la plataforma C#. Abierto[NuGet](https://www.nuget.org/packages/aspose.imaging) administrador de paquetes, busque
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para convertir ICO a SVGZ a través de C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Convertir ICO a SVGZ - .NET" offSpacer="" %}}
