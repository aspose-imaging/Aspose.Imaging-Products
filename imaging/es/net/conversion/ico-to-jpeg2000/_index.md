---
title: Conviert ICO a JPEG2000 a través de C# 
weight: 3920
url: /es/net/conversion/ico-to-jpeg2000/ 
lang: es
langdirlevel: 2
locales: ja,it,zh-hant,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko,zh-hans,ar,hi,th,sv,cs,uk,he
description: Código de muestra para la conversión de C# de ICO a JPEG2000. Utilice el código de ejemplo de API para la conversión por lotes de archivos ICO a JPEG2000 dentro de VB.NET, Asp.NET o cualquier aplicación basada en .NET.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convierta ICO a JPEG2000 a través de C#" h2="Transforme ICO en JPEG2000 utilizando las API .NET nativas sin necesidad de ningún editor de imágenes o bibliotecas de terceros." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/imaging/aspose_imaging-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="JPEG2000" pfName="Aspose.Imaging" subTitlepfName="para .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="APNG" >}}
...
{{% blocks/products/pf/agp/content h2="Cómo convertir ICO a JPEG2000 usando C#" %}}

Para convertir ICO a JPEG2000, usaremos [Aspose.Imaging para .NET](https://products.aspose.com/imaging/net) API, que es una API de conversión y manipulación de imágenes rica en funciones, potente y fácil de usar para la plataforma C#. Abierto[NuGet](https://www.nuget.org/packages/aspose.imaging) administrador de paquetes, busque
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para convertir ICO a JPEG2000 a través de C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Convertir ICO a JPEG2000 - .NET" offSpacer="" %}}
