---
title: Documentos DICOM en escala de grises a través de .NET 
weight: 3920
url: /es/net/grayscale/dicom/ 
lang: es
langdirlevel: 2
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para DICOM en escala de grises a través de C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Imágenes en escala de grises DICOM - .NET" offSpacer="" %}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="/imaging/es/net/grayscale/ico/" name="ICO" description="icono de ventanas" >}}
