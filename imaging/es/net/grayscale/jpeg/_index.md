---
title: Documentos JPEG en escala de grises a través de .NET 
weight: 3920
url: /es/net/grayscale/jpeg/ 
lang: es
langdirlevel: 2
locales: zh-hans,ja,it,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko,zh-hant,ar,hi,th,sv,cs,uk,he
description: Pruebe nuestras API de documentos locales para archivos JPEG en escala de grises en .NET Framework, .NET Core, aplicación de Windows, aplicación web ASP.NET.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Escala de grises JPEG a través de C#" h2="Cree sus propias aplicaciones .NET para archivos en escala de grises JPEG usando las API del lado del servidor." logoImageSrc="/imaging/images/imaging/aspose_imaging-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="JPEG" pfName="Aspose.Imaging" subTitlepfName="para .NET" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para JPEG en escala de grises a través de C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Imágenes en escala de grises JPEG - .NET" offSpacer="" %}}
