...
description: Usando Aspose.Imaging.Heic.Adapter con imágenes de código de muestra y conversión de documentos a través de C#. Código de ejemplo API para conversión por lotes de archivos HEIC a DXF con cualquier aplicación basada en .NET.
---
