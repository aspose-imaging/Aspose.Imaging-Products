...
description: Usando Aspose.Imaging.Pdf.Adapter con imágenes de código de muestra y conversión de documentos a través de C#. Código de ejemplo API para conversión por lotes de archivos PDF a PICTURE con cualquier aplicación basada en .NET.
---
