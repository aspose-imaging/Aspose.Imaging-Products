---
title: Convierta PNG a WORD mediante C# 
weight: 3920
url: /es/adapters/net/png-to-word/ 
lang: es
langdirlevel: 2
locales: ja,it,zh-hant,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko,zh-hans,ar,hi,th,sv,cs,uk,he
description: Usando Aspose.Imaging.Pdf.Adapter con imágenes de código de muestra y conversión de documentos a través de C#. Código de ejemplo API para conversión por lotes de archivos PNG a WORD con cualquier aplicación basada en .NET.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convierta archivos PNG a WORD usando el adaptador a través de C#" h2="Transforme PNG en documentos WORD utilizando las API nativas de .NET sin necesidad de ningún editor de imágenes." logoImageSrc="/imaging/images/imaging/aspose_imaging-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="WORD" pfName="Aspose.Imaging" subTitlepfName="para .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="APNG" >}}
...
{{% blocks/products/pf/agp/content h2="Cómo convertir PNG a WORD usando C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para convertir PNG a WORD mediante C#" %}}

{{% blocks/products/pf/agp/text %}}

Los desarrolladores pueden cargar y convertir fácilmente archivos PNG a WORD con solo unas pocas líneas de código.

{{% /blocks/products/pf/agp/text %}}

+ Inicialice el adaptador con el método Register(), una operación única.
+ Cargue el archivo PNG necesario usando el método Aspose.Imaging.Image.Load().
...
{{% blocks/products/pf/agp/code-block title="Convertir PNG a WORD - .NET" offSpacer="true" %}}
