---
title: Filtrar documentos WMF a través de Python 
weight: 3920
url: /es/python-net/filter/wmf/ 
lang: es
langdirlevel: 2
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para filtrar WMF a través de Python" %}}
...
{{% blocks/products/pf/agp/code-block title="Filtrar imágenes WMF - Python" offSpacer="" %}}
