---
title: C# aracılığıyla HEIC'ı SVGZ'ye dönüştürün 
weight: 3920
url: /tr/adapters/net/heic-to-svgz/ 
lang: tr
langdirlevel: 2
...
{{% blocks/products/pf/agp/content h2="C# Kullanarak HEIC'ı SVGZ'ye Dönüştürme" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="C# aracılığıyla HEIC'ı SVGZ'ye Dönüştürme Adımları" %}}

{{% blocks/products/pf/agp/text %}}

Geliştiriciler, yalnızca birkaç satır kodla HEIC dosyalarını kolayca yükleyebilir ve SVGZ biçimine dönüştürebilir.
...
+ SVGZ formatı için gerekli kaydetme seçenekleri sınıfı örneğini oluşturun ve gerekli özellikleri ayarlayın.
+ Aspose.Imaging.Image.Save() yöntemini kullanarak, seçeneklerle birlikte dosya yolunu veya akışını belirterek SVGZ'yi kaydedin.
...
{{% blocks/products/pf/agp/code-block title="HEIC'ı SVGZ - .NET'a dönüştürün" offSpacer="true" %}}
