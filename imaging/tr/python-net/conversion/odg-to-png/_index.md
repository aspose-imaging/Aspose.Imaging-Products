---
title: Python kullanarak ODG öğesini PNG biçimine dönüştürün 
weight: 3920
url: /tr/python-net/conversion/odg-to-png/ 
lang: tr
langdirlevel: 2
locales: ja,it,zh-hant,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko,zh-hans,ar,hi,th,sv,cs,uk,he
description: ODG'den PNG'ye Python dil dönüşümü için örnek kod. Herhangi bir Web veya Masaüstü Python dili tabanlı uygulamayı kullanarak ODG'den PNG'ye dönüştürmeyi işlemek için sunulan API örnek kodunu kullanın.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Python dilini kullanarak ODG öğesini PNG biçimine dönüştürün" h2="Yerel Python dil API'lerini kullanarak ve herhangi bir resim düzenleyiciye veya 3. taraf kitaplıklara ihtiyaç duymadan ODG'i PNG'ye dönüştürün." logoImageSrc="/imaging/images/imaging/aspose_imaging-for-python-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PNG" pfName="Aspose.Imaging" subTitlepfName="Python için" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="APNG" >}}
...
{{% blocks/products/pf/agp/content h2="Python Kullanarak ODG'i PNG'ye Dönüştürme" %}}

ODG'i PNG'ye dönüştürmek için kullanacağız Python platformu için zengin özelliklere sahip, güçlü ve kullanımı kolay bir görüntü işleme ve dönüştürme API'si olan [Aspose.Imaging for Python via .NET](/imaging/tr/python-net) API. Sistem komutunuzdan aşağıdaki komutu kullanarak kurabilirsiniz.
...
{{% blocks/products/pf/agp/feature-section-col title="Python aracılığıyla ODG'i PNG'e Dönüştürme Adımları" %}}
...
{{% blocks/products/pf/agp/code-block title="ODG öğesini PNG - Python biçimine dönüştürün" offSpacer="true" %}}
