---
title: TGA belgelerini Java aracılığıyla ikili hale getirin 
weight: 3920
url: /tr/java/binarize/tga/ 
lang: tr
langdirlevel: 2
...
{{% blocks/products/pf/agp/feature-section-col title="TGA'leri Java aracılığıyla İkilileştirme Adımları" %}}
...
{{% blocks/products/pf/agp/code-block title="TGA görüntüleri ikili hale getirin - Java" offSpacer="" %}}
