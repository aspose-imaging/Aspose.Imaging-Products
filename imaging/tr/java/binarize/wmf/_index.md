---
title: WMF belgelerini Java aracılığıyla ikili hale getirin 
weight: 3920
url: /tr/java/binarize/wmf/ 
lang: tr
langdirlevel: 2
...
{{% blocks/products/pf/agp/feature-section-col title="WMF'leri Java aracılığıyla İkilileştirme Adımları" %}}
...
{{% blocks/products/pf/agp/code-block title="WMF görüntüleri ikili hale getirin - Java" offSpacer="" %}}
