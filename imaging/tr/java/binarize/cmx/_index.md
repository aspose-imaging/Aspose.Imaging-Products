---
title: CMX belgelerini Java aracılığıyla ikili hale getirin 
weight: 3920
url: /tr/java/binarize/cmx/ 
lang: tr
langdirlevel: 2
...
{{% blocks/products/pf/agp/feature-section-col title="CMX'leri Java aracılığıyla İkilileştirme Adımları" %}}
...
{{% blocks/products/pf/agp/code-block title="CMX görüntüleri ikili hale getirin - Java" offSpacer="" %}}
