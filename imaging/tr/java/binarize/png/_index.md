---
title: PNG belgelerini Java aracılığıyla ikili hale getirin 
weight: 3920
url: /tr/java/binarize/png/ 
lang: tr
langdirlevel: 2
...
{{% blocks/products/pf/agp/feature-section-col title="PNG'leri Java aracılığıyla İkilileştirme Adımları" %}}
...
{{% blocks/products/pf/agp/code-block title="PNG görüntüleri ikili hale getirin - Java" offSpacer="" %}}
