---
title: OTG belgelerini Java aracılığıyla ikili hale getirin 
weight: 3920
url: /tr/java/binarize/otg/ 
lang: tr
langdirlevel: 2
...
{{% blocks/products/pf/agp/feature-section-col title="OTG'leri Java aracılığıyla İkilileştirme Adımları" %}}
...
{{% blocks/products/pf/agp/code-block title="OTG görüntüleri ikili hale getirin - Java" offSpacer="" %}}
