---
title: ICO belgelerini Java aracılığıyla ikili hale getirin 
weight: 3920
url: /tr/java/binarize/ico/ 
lang: tr
langdirlevel: 2
...
{{% blocks/products/pf/agp/feature-section-col title="ICO'leri Java aracılığıyla İkilileştirme Adımları" %}}
...
{{% blocks/products/pf/agp/code-block title="ICO görüntüleri ikili hale getirin - Java" offSpacer="" %}}
