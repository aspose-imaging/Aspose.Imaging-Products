---
title: WEBP belgelerini Java aracılığıyla ikili hale getirin 
weight: 3920
...
{{% blocks/products/pf/agp/feature-section-col title="WEBP'leri Java aracılığıyla İkilileştirme Adımları" %}}
...
{{% blocks/products/pf/agp/code-block title="WEBP görüntüleri ikili hale getirin - Java" offSpacer="" %}}
