---
title: EMF belgelerini Java aracılığıyla ikili hale getirin 
weight: 3920
url: /tr/java/binarize/emf/ 
lang: tr
langdirlevel: 2
...
{{% blocks/products/pf/agp/feature-section-col title="EMF'leri Java aracılığıyla İkilileştirme Adımları" %}}
...
{{% blocks/products/pf/agp/code-block title="EMF görüntüleri ikili hale getirin - Java" offSpacer="" %}}
