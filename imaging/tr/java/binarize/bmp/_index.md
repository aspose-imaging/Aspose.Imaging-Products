---
title: BMP belgelerini Java aracılığıyla ikili hale getirin 
weight: 3920
url: /tr/java/binarize/bmp/ 
lang: tr
langdirlevel: 2
...
{{% blocks/products/pf/agp/feature-section-col title="BMP'leri Java aracılığıyla İkilileştirme Adımları" %}}
...
{{% blocks/products/pf/agp/code-block title="BMP görüntüleri ikili hale getirin - Java" offSpacer="" %}}
