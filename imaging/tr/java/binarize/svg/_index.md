---
title: SVG belgelerini Java aracılığıyla ikili hale getirin 
weight: 3920
url: /tr/java/binarize/svg/ 
lang: tr
langdirlevel: 2
...
{{% blocks/products/pf/agp/feature-section-col title="SVG'leri Java aracılığıyla İkilileştirme Adımları" %}}
...
{{% blocks/products/pf/agp/code-block title="SVG görüntüleri ikili hale getirin - Java" offSpacer="" %}}
