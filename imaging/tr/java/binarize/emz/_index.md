---
title: EMZ belgelerini Java aracılığıyla ikili hale getirin 
weight: 3920
url: /tr/java/binarize/emz/ 
lang: tr
langdirlevel: 2
...
{{% blocks/products/pf/agp/feature-section-col title="EMZ'leri Java aracılığıyla İkilileştirme Adımları" %}}
...
{{% blocks/products/pf/agp/code-block title="EMZ görüntüleri ikili hale getirin - Java" offSpacer="" %}}
