---
title: EPS belgelerini Java aracılığıyla ikili hale getirin 
weight: 3920
url: /tr/java/binarize/eps/ 
lang: tr
langdirlevel: 2
...
{{% blocks/products/pf/agp/feature-section-col title="EPS'leri Java aracılığıyla İkilileştirme Adımları" %}}
...
{{% blocks/products/pf/agp/code-block title="EPS görüntüleri ikili hale getirin - Java" offSpacer="" %}}
