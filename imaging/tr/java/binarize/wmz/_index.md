---
title: WMZ belgelerini Java aracılığıyla ikili hale getirin 
weight: 3920
url: /tr/java/binarize/wmz/ 
lang: tr
langdirlevel: 2
...
{{% blocks/products/pf/agp/feature-section-col title="WMZ'leri Java aracılığıyla İkilileştirme Adımları" %}}
...
{{% blocks/products/pf/agp/code-block title="WMZ görüntüleri ikili hale getirin - Java" offSpacer="" %}}
