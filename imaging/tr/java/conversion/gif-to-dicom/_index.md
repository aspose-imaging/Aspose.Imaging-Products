...
description: GIF - DICOM Java dönüşümü için örnek kod. Herhangi bir Web veya Masaüstü Java tabanlı uygulamada toplu GIF dosyalarını DICOM'ye dönüştürmek için API örnek kodunu kullanın.
---
...
{{< blocks/imaging-app-widget
        ...
        checkFreeAppLabel="GIF'i DICOM'ye dönüştürmek için [canlı demolarımızı] kontrol edin"
