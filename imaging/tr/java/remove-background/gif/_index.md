...
{{% blocks/products/pf/agp/feature-section-col title="Java aracılığıyla GIF'lerden arka planı kaldırma adımları" %}}
...
{{% blocks/products/pf/agp/code-block title="GIF resimlerdeki arka planı kaldırın - Java" offSpacer="" %}}
