---
title: BMP belgelerindeki arka planı Java aracılığıyla kaldırın 
weight: 3920
url: /tr/java/remove-background/bmp/ 
lang: tr
langdirlevel: 2
...
{{% blocks/products/pf/agp/feature-section-col title="Java aracılığıyla BMP'lerden arka planı kaldırma adımları" %}}
...
{{% blocks/products/pf/agp/code-block title="BMP resimlerdeki arka planı kaldırın - Java" offSpacer="" %}}
