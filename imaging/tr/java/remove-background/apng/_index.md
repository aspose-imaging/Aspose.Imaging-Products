---
title: APNG belgelerindeki arka planı Java aracılığıyla kaldırın 
weight: 3920
url: /tr/java/remove-background/apng/ 
lang: tr
langdirlevel: 2
...
{{% blocks/products/pf/agp/feature-section-col title="Java aracılığıyla APNG'lerden arka planı kaldırma adımları" %}}
...
{{% blocks/products/pf/agp/code-block title="APNG resimlerdeki arka planı kaldırın - Java" offSpacer="" %}}
