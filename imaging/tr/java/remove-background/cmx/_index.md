...
{{% blocks/products/pf/agp/content h2="Java Kullanarak CMX Dosyalarında arka plan nasıl kaldırılır" %}}

CMX dosyalarındaki arka planı kaldırmak için kullanacağız
...
{{% blocks/products/pf/agp/feature-section-col title="Java aracılığıyla CMX'lerden arka planı kaldırma adımları" %}}
...
{{% blocks/products/pf/agp/code-block title="CMX resimlerdeki arka planı kaldırın - Java" offSpacer="" %}}
