...
{{% blocks/products/pf/agp/feature-section-col title="Java aracılığıyla DIB'lerden arka planı kaldırma adımları" %}}
...
{{% blocks/products/pf/agp/code-block title="DIB resimlerdeki arka planı kaldırın - Java" offSpacer="" %}}
