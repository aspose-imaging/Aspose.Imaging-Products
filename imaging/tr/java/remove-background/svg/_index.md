...
{{% blocks/products/pf/agp/feature-section-col title="Java aracılığıyla SVG'lerden arka planı kaldırma adımları" %}}
...
{{% blocks/products/pf/agp/code-block title="SVG resimlerdeki arka planı kaldırın - Java" offSpacer="" %}}
