...
{{% blocks/products/pf/agp/feature-section-col title="OTG'leri Java ile Kırpma Adımları" %}}
...
{{% blocks/products/pf/agp/code-block title="OTG resimleri kırp - Java" offSpacer="" %}}
