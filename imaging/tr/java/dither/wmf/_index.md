---
title: Java aracılığıyla WMF belgelerini taklit edin 
weight: 3920
url: /tr/java/dither/wmf/ 
lang: tr
langdirlevel: 2
...
{{% blocks/products/pf/agp/feature-section-col title="Java aracılığıyla WMF'leri Taklit Etme Adımları" %}}
...
{{% blocks/products/pf/agp/code-block title="WMF görüntüleri taklidi - Java" offSpacer="" %}}
