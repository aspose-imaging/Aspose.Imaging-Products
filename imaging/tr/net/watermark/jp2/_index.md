---
title: C# aracılığıyla filigran JP2 belgesi 
weight: 3920
url: /tr/net/watermark/jp2/ 
lang: tr
langdirlevel: 2
locales: zh-hans,ja,it,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko,zh-hant,ar,hi,th,sv,cs,uk,he
description: .NET Framework, .NET Core, Windows Uygulaması, ASP.NET Web Uygulamasında JP2 dosyasını filigranlamak için Şirket İçi belge API'lerimizi deneyin.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="C# aracılığıyla JP2 öğesine Metin Filigranı ekleyin" h2="Sunucu tarafı API'lerini kullanarak JP2 dosyalarına filigran eklemek için kendi .NET uygulamalarınızı oluşturun." logoImageSrc="/imaging/images/imaging/aspose_imaging-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="JP2" pfName="Aspose.Imaging" subTitlepfName=".NET için" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C# aracılığıyla JP2'e Filigran Ekleme Adımları" %}}
...
{{% blocks/products/pf/agp/code-block title="Filigran JP2 resmi - .NET" offSpacer="" %}}
