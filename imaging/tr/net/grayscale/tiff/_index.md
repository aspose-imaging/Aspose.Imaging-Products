---
title: .NET aracılığıyla Gri Tonlamalı TIFF belgeler 
weight: 3920
url: /tr/net/grayscale/tiff/ 
lang: tr
langdirlevel: 2
...
{{% blocks/products/pf/agp/content h2="C# Kullanılarak TIFF Dosyaları Gri Tonlamalı Nasıl Yapılır?" %}}

TIFF dosyalarını gri tonlamak için kullanacağız [Aspose.Imaging for .NET](https://products.aspose.com/imaging/net) C# platformu için zengin özelliklere sahip, güçlü ve kullanımı kolay bir görüntü işleme ve dönüştürme API'si olan API. Açık [NuGet](https://www.nuget.org/packages/aspose.imaging) paket yöneticisi, ara **Aspose.Görüntüleme** ve yükleyin. Paket Yöneticisi Konsolundan aşağıdaki komutu da kullanabilirsiniz.
...
{{% blocks/products/pf/agp/feature-section-col title="C# aracılığıyla Gri Tonlamalı TIFF'lere yönelik adımlar" %}}
...
{{% blocks/products/pf/agp/code-block title="Gri tonlamalı TIFF resimler - .NET" offSpacer="" %}}
