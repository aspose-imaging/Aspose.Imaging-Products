---
title: .NET aracılığıyla Gri Tonlamalı ODG belgeler 
weight: 3920
url: /tr/net/grayscale/odg/ 
lang: tr
langdirlevel: 2
locales: zh-hans,ja,it,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko,zh-hant,ar,hi,th,sv,cs,uk,he
description: .NET Framework, .NET Core, Windows Uygulaması, ASP.NET Web Uygulamasında gri tonlamalı ODG dosyaları için Şirket İçi belge API'lerimizi deneyin.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="C# aracılığıyla Gri Tonlamalı ODG'ler" h2="Sunucu tarafı API'lerini kullanarak gri tonlamalı ODG dosyaları oluşturmak için kendi .NET uygulamalarınızı oluşturun." logoImageSrc="/imaging/images/imaging/aspose_imaging-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="ODG" pfName="Aspose.Imaging" subTitlepfName=".NET için" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C# aracılığıyla Gri Tonlamalı ODG'lere yönelik adımlar" %}}
...
{{% blocks/products/pf/agp/code-block title="Gri tonlamalı ODG resimler - .NET" offSpacer="" %}}
