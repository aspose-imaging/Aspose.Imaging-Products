---
title: .NET aracılığıyla Gri Tonlamalı JP2 belgeler 
weight: 3920
url: /tr/net/grayscale/jp2/ 
lang: tr
langdirlevel: 2
...
{{% blocks/products/pf/agp/content h2="C# Kullanılarak JP2 Dosyaları Gri Tonlamalı Nasıl Yapılır?" %}}

JP2 dosyalarını gri tonlamak için kullanacağız [Aspose.Imaging for .NET](https://products.aspose.com/imaging/net) C# platformu için zengin özelliklere sahip, güçlü ve kullanımı kolay bir görüntü işleme ve dönüştürme API'si olan API. Açık [NuGet](https://www.nuget.org/packages/aspose.imaging) paket yöneticisi, ara **Aspose.Görüntüleme** ve yükleyin. Paket Yöneticisi Konsolundan aşağıdaki komutu da kullanabilirsiniz.
...
{{% blocks/products/pf/agp/feature-section-col title="C# aracılığıyla Gri Tonlamalı JP2'lere yönelik adımlar" %}}
...
{{% blocks/products/pf/agp/code-block title="Gri tonlamalı JP2 resimler - .NET" offSpacer="" %}}
