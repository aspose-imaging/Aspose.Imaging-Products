---
title: C# aracılığıyla WEBP öğesini APNG biçimine dönüştürün 
weight: 3920
url: /tr/net/conversion/webp-to-apng/ 
lang: tr
langdirlevel: 2
locales: ja,it,zh-hant,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko,zh-hans,ar,hi,th,sv,cs,uk,he
description: WEBP - APNG C# dönüşümü için örnek kod. VB.NET, Asp.NET veya herhangi bir .NET tabanlı uygulama içinde toplu WEBP dosyalarını APNG'ye dönüştürmek için API örnek kodunu kullanın.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="C# aracılığıyla WEBP öğesini APNG biçimine dönüştürün" h2="Herhangi bir görüntü düzenleyiciye veya 3. taraf kitaplıklara ihtiyaç duymadan yerel .NET API'lerini kullanarak WEBP'i APNG'ye dönüştürün." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/imaging/aspose_imaging-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="APNG" pfName="Aspose.Imaging" subTitlepfName=".NET için" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="APNG" >}}
...
{{% blocks/products/pf/agp/content h2="C# Kullanarak WEBP'i APNG'ye Dönüştürme" %}}

WEBP'i APNG'ye dönüştürmek için kullanacağız [Aspose.Imaging for .NET](https://products.aspose.com/imaging/net) C# platformu için zengin özelliklere sahip, güçlü ve kullanımı kolay bir görüntü işleme ve dönüştürme API'si olan API. Açık [NuGet](https://www.nuget.org/packages/aspose.imaging) paket yöneticisi, ara **Aspose.Görüntüleme** ve yükleyin. Paket Yöneticisi Konsolundan aşağıdaki komutu da kullanabilirsiniz.
...
{{% blocks/products/pf/agp/feature-section-col title="C# aracılığıyla WEBP'i APNG'e Dönüştürme Adımları" %}}

{{% blocks/products/pf/agp/text %}}

Geliştiriciler, yalnızca birkaç satır kodla WEBP dosyalarını kolayca yükleyebilir ve APNG biçimine dönüştürebilir.
...
{{% blocks/products/pf/agp/code-block title="WEBP öğesini APNG - .NET biçimine dönüştürün" offSpacer="" %}}
...
{{< blocks/imaging-app-widget
        sectionTitle="WEBP'i APNG'e Dönüştürmek için Ücretsiz Uygulama"
        appName="Conversion"
        ...
        checkFreeAppLabel="WEBP'i APNG'ye dönüştürmek için [canlı demolarımızı] kontrol edin"
        checkFreeAppLabelUrl="(https://products.aspose.app/imaging/tr/conversion/WEBP-to-APNG)"
        showPreview="true">}}
