---
title: C# aracılığıyla PNG öğesini PDF biçimine dönüştürün 
weight: 3920
url: /tr/net/conversion/png-to-pdf/ 
lang: tr
langdirlevel: 2
locales: ja,it,zh-hant,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko,zh-hans,ar,hi,th,sv,cs,uk,he
description: PNG - PDF C# dönüşümü için örnek kod. VB.NET, Asp.NET veya herhangi bir .NET tabanlı uygulama içinde toplu PNG dosyalarını PDF'ye dönüştürmek için API örnek kodunu kullanın.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="C# aracılığıyla PNG öğesini PDF biçimine dönüştürün" h2="Herhangi bir görüntü düzenleyiciye veya 3. taraf kitaplıklara ihtiyaç duymadan yerel .NET API'lerini kullanarak PNG'i PDF'ye dönüştürün." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/imaging/aspose_imaging-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="Aspose.Imaging" subTitlepfName=".NET için" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="APNG" >}}
...
{{% blocks/products/pf/agp/content h2="C# Kullanarak PNG'i PDF'ye Dönüştürme" %}}

PNG'i PDF'ye dönüştürmek için kullanacağız [Aspose.Imaging for .NET](https://products.aspose.com/imaging/net) C# platformu için zengin özelliklere sahip, güçlü ve kullanımı kolay bir görüntü işleme ve dönüştürme API'si olan API. Açık [NuGet](https://www.nuget.org/packages/aspose.imaging) paket yöneticisi, ara **Aspose.Görüntüleme** ve yükleyin. Paket Yöneticisi Konsolundan aşağıdaki komutu da kullanabilirsiniz.
...
{{% blocks/products/pf/agp/feature-section-col title="C# aracılığıyla PNG'i PDF'e Dönüştürme Adımları" %}}
...
{{% blocks/products/pf/agp/code-block title="PNG öğesini PDF - .NET biçimine dönüştürün" offSpacer="" %}}
...
{{< blocks/imaging-app-widget
        sectionTitle="PNG'i PDF'e Dönüştürmek için Ücretsiz Uygulama"
        appName="Conversion"
        ...
        checkFreeAppLabel="PNG'i PDF'ye dönüştürmek için [canlı demolarımızı] kontrol edin"
        checkFreeAppLabelUrl="(https://products.aspose.app/imaging/tr/conversion/PNG-to-PDF)"
        showPreview="true">}}
