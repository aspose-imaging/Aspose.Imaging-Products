---
title: .NET के माध्यम से WMF दस्तावेज़ों में पृष्ठभूमि निकालें 
weight: 3920
url: /hi/net/remove-background/wmf/ 
lang: hi
langdirlevel: 2
locales: ja,it,zh-hant,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko,zh-hans,ar,hi,th,sv,cs,uk,he
description: .NET Framework, .NET Core, Windows एप्लिकेशन, ASP.NET वेब एप्लिकेशन पर WMF फाइलों में पृष्ठभूमि को हटाने के लिए हमारे ऑन-प्रिमाइसेस दस्तावेज़ API को आज़माएं।
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="C# के माध्यम से WMFs से पृष्ठभूमि निकालें" h2="सर्वर-साइड API का उपयोग करके WMF फ़ाइलों से पृष्ठभूमि निकालने के लिए अपने स्वयं के .NET ऐप्स बनाएं।" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/imaging/aspose_imaging-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="WMF" pfName="Aspose.Imaging" subTitlepfName=".NET के लिए" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/content h2="C# का उपयोग करके WMF फ़ाइलों में पृष्ठभूमि कैसे निकालें" %}}

WMF फ़ाइलों में पृष्ठभूमि को हटाने के लिए, हम उपयोग करेंगे [Aspose.Imaging for .NET](https://products.aspose.com/imaging/net) API जो एक सुविधा संपन्न, शक्तिशाली और उपयोग में आसान छवि हेरफेर और C# प्लेटफॉर्म के लिए रूपांतरण API है। [NuGet](https://www.nuget.org/packages/aspose.imaging) पैकेज मैनेजर खोलें, खोजें
...
{{% blocks/products/pf/agp/feature-section-col title="C# के माध्यम से WMFs से पृष्ठभूमि हटाने के चरण" %}}
...
{{% blocks/products/pf/agp/code-block title="WMF इमेज में बैकग्राउंड हटाएं - .NET" offSpacer="" %}}
