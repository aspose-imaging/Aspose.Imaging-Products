---
title: C# .NET क्रॉस-प्लेटफ़ॉर्म इमेज लाइब्रेरी API - Aspose 
weight: 960
url: /hi/net 
lang: hi
langdirlevel: 2
locales: zh-hans,ja,it,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko,zh-hant,ar,hi,th,sv,cs,uk,he
description: इमेज प्रोसेसिंग और मैनिपुलेशन लाइब्रेरी एपीआई, सी # एएसपी.नेट वीबी.नेट अनुप्रयोगों के भीतर PSD बीएमपी जेपीईजी पीएनजी टीआईएफएफ जीआईएफ में संपादन ड्रा या निर्यात छवियों को बनाने के लिए एपीआई
---

{{< blocks/products/pf/main-wrap-class>}}
{{< blocks/products/pf/upper-banner h1=".NET क्रॉस-प्लेटफ़ॉर्म लाइब्रेरी - इमेज प्रोसेसिंग के लिए एपीआई" h2="किसी भी छवि संपादक की आवश्यकता के बिना छवियों को बनाएं, लोड करें, हेरफेर करें या परिवर्तित करें।" downloadFreeTrialText="नि: शुल्क परीक्षण डाउनलोड करें" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/imaging/headers/aspose_imaging-for-net.svg"  pfName="Aspose.Imaging" subTitlepfName="for .NET" downloadUrl="https://downloads.aspose.com/imaging/net" >}}
...
<p align="justify">
 Aspose.Imaging for .NET एक पुस्तकालय है जो उन्नत छवि प्रसंस्करण सुविधाओं की पेशकश करता है। आप इस एपीआई का उपयोग करके आसानी से बना सकते हैं, लोड कर सकते हैं, हेरफेर कर सकते हैं, कनवर्ट कर सकते हैं, छवियों या तस्वीरों को संपीड़ित कर सकते हैं। असोसिएट भी करें। इमेजिंग लाइब्रेरी ग्राफिक प्राइमेटिव के साथ ड्राइंग और काम का समर्थन करती है। छवि निर्यात और रूपांतरण (समान बहु-पृष्ठ छवि प्रसंस्करण सहित) छवि परिवर्तन (आकार, फसल, फ्लिप और घुमाने, बिनराइजेशन, ग्रेस्केल, समायोजित), उन्नत छवि हेरफेर सुविधाओं (फ़िल्टरिंग, डिथरिंग, मास्किंग, डेस्क्यूइंग) के साथ एपीआई मुख्य विशेषताओं में से एक है। ) और स्मृति अनुकूलन रणनीतियाँ।
</p>

<p align="justify">
 Aspose.Imaging for .NET एक लचीला, स्थिर और शक्तिशाली एपीआई है, जो डीजेवीयू, डीआईसीओएम, वेबपी और डीएनजी जैसे कुछ विशेष प्रारूपों के साथ सबसे अधिक इस्तेमाल किए जाने वाले प्रारूपों को संसाधित करने में सक्षम है। इसके अलावा, यह .NET और .NET कोर के लिए छवि प्रारूपों और प्रसंस्करण कार्यों के लिए मूल समर्थन प्रदान करता है। Aspose.Imaging क्रॉस-प्लेटफ़ॉर्म लाइब्रेरी है, यह विंडोज और लिनक्स संगत है।
</p>
...
{{< blocks/products/pf/carousel-item h3="" description="एपीआई का अवलोकन।" >}}
<div class="diagram1 d1-net">
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="छवि .NET API" src="https://www.aspose.cloud/templates/aspose/img/products/imaging/aspose_imaging-for-net.svg"/>
  <header>
   Aspose.Imaging
  </header>
  <footer>
...
{{< blocks/products/pf/carousel-item h3="" description="Aspose.Imaging for .NET .NET ढांचे और .NET मानक का समर्थन करता है" >}}
<div class="diagram1 d1-net">
 <div class="d1-row">
  <div class="d1-col d1-left">
   <header>
  ...
  <div class="d1-col d1-right">
   ...
   <ul>
    ...
    <li>
     .NET कोर आधारित लिनक्स अनुप्रयोग
    </li>
   </ul>
  </div>
  <!--/right-->
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt=".NET इमेज प्रोसेसिंग एपीआई" src="https://www.aspose.cloud/templates/aspose/img/products/imaging/aspose_imaging-for-net.svg"/>
  <header>
   Aspose.Imaging
  </header>
  <footer>
...
{{< blocks/products/pf/carousel-item h3="" description="Aspose.Imaging for .NET विभिन्न प्रकार की छवियों का समर्थन करता है [फ़ाइल प्रारूप](https://docs.aspose.com/imaging/net/supported-file-formats/)." >}}
<div class="diagram1 d2 d1-net">
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="इमेज प्रोसेसर सी# फोटो संपादित करें छवि संपादित करें" src="https://www.aspose.cloud/templates/aspose/img/products/imaging/aspose_imaging-for-net.svg"/>
  <header>
   Aspose.Imaging
  </header>
  <footer>
 ...
 <div class="row">
  <div class="container">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
    <a href="/imaging/hi/net/conversion/">
     छवियों को विभिन्न स्वरूपों में बदलें
    </a>
    </p>
   </div>
   <div class="col-lg-4">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
    <a href="/imaging/hi/net/remove-background/">
     पृष्ठभूमि निकालें
    </a>
    </p>
   </div>
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="/imaging/hi/net/change-background/">
     पृष्ठिका बदलो
     </a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="/imaging/hi/net/watermark/">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="/imaging/hi/net/compress/">
     संकुचित करें
     </a>
    </p>
   </div>
...
<div class="col-lg-12">
  <h2 class="h2title">विभिन्न छवि फिल्टर और प्रभाव</h2>
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="/imaging/hi/net/grayscale/">
     स्केल
     </a>
    </p>
   </div>
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="/imaging/hi/net/cartoonify/">
     कार्टून बनाना
     </a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="/imaging/hi/net/binarize/">
     बिनाराइज
     </a>
    </p>
   </div>
...
<h2 class="h2title">कस्टम छवि फ़ाइल स्वरूपों को पंजीकृत करें</h2>

<p>एक और आशाजनक विशेषता जो .NET के लिए Aspose.Imaging प्रदान करती है, वह है कस्टम छवि प्रारूपों को पंजीकृत करना। Aspose.Imaging for .NET डेवलपर्स को संबंधित ऑपरेशन के लिए .NET रजिस्ट्री पुस्तकालयों के लिए Aspose.Imaging में से किसी एक का उपयोग करके बनाने, खोलने या निर्यात करने के लिए नए कस्टम फ़ाइल स्वरूपों को पंजीकृत करने की अनुमति देता है। यह सुविधा नए फ़ाइल स्वरूपों को जोड़ने की अनुमति देती है जिनका उपयोग ड्राइंग और निर्यात उद्देश्यों के लिए किया जा सकता है।</p>
...
{{< blocks/products/pf/slr-element name="प्रलेखन" href="https://docs.aspose.com/imaging/net" >}}
{{< blocks/products/pf/slr-element name="सोर्स कोड" href="https://github.com/aspose-imaging/Aspose.Imaging-for-.NET" >}}
{{< blocks/products/pf/slr-element name="एपीआई संदर्भ" href="https://apireference.aspose.com/net/imaging" >}}
...
{{< blocks/products/pf/slr-element name="रिलीज नोट्स" href="https://docs.aspose.com/imaging/net/release-notes/" >}}
{{< /blocks/products/pf/slr-tab >}}

{{< blocks/products/pf/slr-tab tabTitle="क्यों Aspose.इमेजिंग के लिए .NET" tabId="success-stories" >}}
...
{{< blocks/products/pf/download-section downloadFreeTrialLink="https://downloads.aspose.com/imaging/net" downloadFreeTrialText="नि: शुल्क परीक्षण डाउनलोड करें" pricingInformationText="लागत - निर्धारण संबंधी जानकारी" pricingInformationLink="https://purchase.aspose.com/pricing/imaging/net" >}}
