---
title: C# के माध्यम से J2K को WMZ में बदलें 
weight: 3920
url: /hi/net/conversion/j2k-to-wmz/ 
lang: hi
langdirlevel: 2
locales: ja,it,zh-hant,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko,zh-hans,ar,hi,th,sv,cs,uk,he
description: J2K से WMZ C# रूपांतरण के लिए नमूना कोड। VB.NET, Asp.NET या किसी भी .NET आधारित एप्लिकेशन के भीतर J2K फ़ाइलों को WMZ रूपांतरण में बैच के लिए API उदाहरण कोड का उपयोग करें।
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="C# के माध्यम से J2K को WMZ में बदलें" h2="किसी भी छवि संपादक या तृतीय-पक्ष लाइब्रेरी की आवश्यकता के बिना देशी .NET API का उपयोग करके J2K को WMZ में रूपांतरित करें।" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/imaging/aspose_imaging-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="WMZ" pfName="Aspose.Imaging" subTitlepfName=".NET के लिए" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="APNG" >}}
...
{{% blocks/products/pf/agp/content h2="C# का उपयोग करके J2K को WMZ में कैसे बदलें" %}}

J2K को WMZ में बदलने के लिए, हम उपयोग करेंगे [Aspose.Imaging for .NET](https://products.aspose.com/imaging/net) API जो एक सुविधा संपन्न, शक्तिशाली और उपयोग में आसान छवि हेरफेर और C# प्लेटफॉर्म के लिए रूपांतरण API है। [NuGet](https://www.nuget.org/packages/aspose.imaging) पैकेज मैनेजर खोलें, खोजें
...
{{% blocks/products/pf/agp/feature-section-col title="C# के माध्यम से J2K को WMZ में बदलने के चरण" %}}
...
{{% blocks/products/pf/agp/code-block title="J2K को WMZ में बदलें - .NET" offSpacer="" %}}
