---
title: CMX छवियाँ ग्रेस्केल Python के साथ 
weight: 3920
url: /hi/python-net/grayscale/cmx/ 
lang: hi
langdirlevel: 2
...
{{% blocks/products/pf/agp/feature-section-col title="Python के माध्यम से ग्रेस्केल CMXs के चरण" %}}
...
{{% blocks/products/pf/agp/code-block title="ग्रेस्केल CMX इमेज - Python" offSpacer="" %}}
