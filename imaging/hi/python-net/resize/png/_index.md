---
title: PNG छवियों का आकार Python के साथ बदलें 
weight: 3920
url: /hi/python-net/resize/png/ 
lang: hi
langdirlevel: 2
locales: ja,it,zh-hant,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko,zh-hans,ar,hi,th,sv,cs,uk,he
description: डेस्कटॉप और वेब एप्लिकेशन पर PNG छवियों और फ़ोटो के आकार बदलने के लिए Python का उपयोग कैसे करें।
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="PNG छवियों का आकार बदलने के लिए Python का उपयोग करें" h2="सर्वर एपीआई के माध्यम से PNG छवियों और फ़ोटो का आकार बदलने के लिए Python ऐप्स बनाएं" logoImageSrc="/imaging/images/imaging/aspose_imaging-for-python-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PNG" pfName="Aspose.Imaging" subTitlepfName="Python के लिए" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Python के माध्यम से PNGs का आकार बदलने के चरण" %}}
...
{{% blocks/products/pf/agp/code-block title="PNG छवियों का आकार बदलें - Python" offSpacer="" %}}
