---
title: TGA छवियाँ पृष्ठभूमि परिवर्तन Python के साथ 
weight: 3920
url: /hi/python-net/change-background/tga/ 
lang: hi
langdirlevel: 2
locales: ja,it,zh-hant,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko,zh-hans,ar,hi,th,sv,cs,uk,he
description: डेस्कटॉप और वेब अनुप्रयोगों पर TGA छवियों और फ़ोटो पृष्ठभूमि परिवर्तन के लिए Python का उपयोग कैसे करें।
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="TGA छवियों की पृष्ठभूमि में बदलाव के लिए Python का उपयोग करें" h2="सर्वर API के माध्यम से TGA छवियों और फ़ोटो की पृष्ठभूमि बदलने के लिए Python ऐप्स बनाएं" logoImageSrc="/imaging/images/imaging/aspose_imaging-for-python-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="TGA" pfName="Aspose.Imaging" subTitlepfName="Python के लिए" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Python के माध्यम से TGAs में पृष्ठभूमि बदलने के चरण" %}}
...
{{% blocks/products/pf/agp/code-block title="TGA छवियों में पृष्ठभूमि बदलें - Python" offSpacer="" %}}
