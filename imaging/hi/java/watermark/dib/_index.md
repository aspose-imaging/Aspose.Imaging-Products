---
title: Java के माध्यम से वॉटरमार्क DIB दस्तावेज़ 
weight: 3920
url: /hi/java/watermark/dib/ 
lang: hi
langdirlevel: 2
locales: zh-hans,ja,it,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko,zh-hant,ar,hi,th,sv,cs,uk,he
description: DIB प्रारूप के लिए  फ़ाइल के लिए नमूना जावा रूपांतरण कोड। किसी भी वेब या डेस्कटॉप जावा आधारित एप्लिकेशन में DIB को  में बदलने के लिए इस उदाहरण कोड का उपयोग करें।
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Java के माध्यम से टेक्स्ट वॉटरमार्क को DIB में जोड़ें" h2="सर्वर-साइड API का उपयोग करके DIB फ़ाइलों को वॉटरमार्क करने के लिए अपने स्वयं के Java ऐप्स बनाएं।" logoImageSrc="/imaging/images/imaging/aspose_imaging-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="DIB" pfName="Aspose.Imaging" subTitlepfName="Java के लिए" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/content h2="Java का उपयोग करके DIB फ़ाइल को वॉटरमार्क कैसे करें" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Java के माध्यम से DIB में वॉटरमार्क जोड़ने के चरण" %}}
...
{{% blocks/products/pf/agp/code-block title="वॉटरमार्क DIB इमेज - Java" offSpacer="" %}}
