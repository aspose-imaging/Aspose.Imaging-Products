---
title: Java के माध्यम से DJVU दस्तावेज़ों को फ़िल्टर करें 
weight: 3920
url: /hi/java/filter/djvu/ 
lang: hi
langdirlevel: 2
locales: zh-hans,ja,it,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko,zh-hant,ar,hi,th,sv,cs,uk,he
description: .NET Framework, .NET Core, Windows एप्लिकेशन, ASP.NET वेब एप्लिकेशन पर DJVU फ़ाइलों को फ़िल्टर करने के लिए हमारे ऑन-प्रिमाइसेस दस्तावेज़ API को आज़माएं।
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Java के माध्यम से DJVU को फ़िल्टर करें" h2="सर्वर-साइड API का उपयोग करके DJVU फ़ाइलों को फ़िल्टर करने के लिए अपने स्वयं के Java ऐप्स बनाएं।" logoImageSrc="/imaging/images/imaging/aspose_imaging-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="DJVU" pfName="Aspose.Imaging" subTitlepfName="Java के लिए" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/content h2="Java का उपयोग करके DJVU फ़ाइलों को कैसे फ़िल्टर करें" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Java के माध्यम से DJVU को फ़िल्टर करने के चरण" %}}
...
{{% blocks/products/pf/agp/code-block title="फ़िल्टर DJVU इमेज - Java" offSpacer="" %}}
