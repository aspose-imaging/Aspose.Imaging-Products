---
title: แปลง AVIF เป็น SVGZ ผ่าน Java 
weight: 3920
url: /th/java/conversion/avif-to-svgz/ 
lang: th
langdirlevel: 2
locales: ja,it,zh-hant,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko,zh-hans,ar,hi,th,sv,cs,uk,he
description: โค้ดตัวอย่างสำหรับการแปลง AVIF เป็น SVGZ Java ใช้โค้ดตัวอย่าง API สำหรับไฟล์แบทช์ AVIF เป็นการแปลง SVGZ ภายในแอปพลิเคชันที่ใช้ Java บนเว็บหรือเดสก์ท็อป
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="แปลง AVIF เป็น SVGZ ผ่าน Java" h2="เปลี่ยน AVIF เป็น SVGZ โดยใช้ API ดั้งเดิมของ Java โดยไม่ต้องใช้โปรแกรมแก้ไขรูปภาพหรือไลบรารีของบุคคลที่สาม" logoImageSrc="/imaging/images/imaging/aspose_imaging-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="SVGZ" pfName="Aspose.Imaging" subTitlepfName="สำหรับ Java" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="APNG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="ขั้นตอนในการแปลง AVIF เป็น SVGZ ผ่าน Java" %}}

{{% blocks/products/pf/agp/text %}}

นักพัฒนาสามารถโหลดและแปลงไฟล์ AVIF เป็น SVGZ ได้อย่างง่ายดายด้วยโค้ดเพียงไม่กี่บรรทัด
...
{{< blocks/imaging-app-widget
        sectionTitle="แอปฟรีเพื่อแปลง AVIF เป็น SVGZ"
        appName="Conversion"
        ...
        checkFreeAppLabel="ตรวจสอบ [การสาธิตสดเพื่อแปลง AVIF เป็น SVGZ]"
        checkFreeAppLabelUrl="(https://products.aspose.app/imaging/conversion/AVIF-to-SVGZ)"
        showPreview="true">}}

{{% blocks/products/pf/agp/code-block title="แปลง AVIF เป็น SVGZ - Java" offSpacer="true" %}}
