---
title: แปลง ODG เป็น JPEG2000 ผ่าน Java 
weight: 3920
url: /th/java/conversion/odg-to-jpeg2000/ 
lang: th
langdirlevel: 2
locales: ja,it,zh-hant,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko,zh-hans,ar,hi,th,sv,cs,uk,he
description: โค้ดตัวอย่างสำหรับการแปลง ODG เป็น JPEG2000 Java ใช้โค้ดตัวอย่าง API สำหรับไฟล์แบทช์ ODG เป็นการแปลง JPEG2000 ภายในแอปพลิเคชันที่ใช้ Java บนเว็บหรือเดสก์ท็อป
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="แปลง ODG เป็น JPEG2000 ผ่าน Java" h2="เปลี่ยน ODG เป็น JPEG2000 โดยใช้ API ดั้งเดิมของ Java โดยไม่ต้องใช้โปรแกรมแก้ไขรูปภาพหรือไลบรารีของบุคคลที่สาม" logoImageSrc="/imaging/images/imaging/aspose_imaging-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="JPEG2000" pfName="Aspose.Imaging" subTitlepfName="สำหรับ Java" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="APNG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="ขั้นตอนในการแปลง ODG เป็น JPEG2000 ผ่าน Java" %}}

{{% blocks/products/pf/agp/text %}}

นักพัฒนาสามารถโหลดและแปลงไฟล์ ODG เป็น JPEG2000 ได้อย่างง่ายดายด้วยโค้ดเพียงไม่กี่บรรทัด
...
{{< blocks/imaging-app-widget
        sectionTitle="แอปฟรีเพื่อแปลง ODG เป็น JPEG2000"
        appName="Conversion"
        ...
        checkFreeAppLabel="ตรวจสอบ [การสาธิตสดเพื่อแปลง ODG เป็น JPEG2000]"
        checkFreeAppLabelUrl="(https://products.aspose.app/imaging/conversion/ODG-to-JPEG2000)"
        showPreview="true">}}

{{% blocks/products/pf/agp/code-block title="แปลง ODG เป็น JPEG2000 - Java" offSpacer="true" %}}
