---
title: เปลี่ยนพื้นหลังในเอกสาร DIB ผ่าน Java 
weight: 3920
url: /th/java/change-background/dib/ 
lang: th
langdirlevel: 2
...
{{< blocks/products/pf/upper-banner h1="เปลี่ยนพื้นหลังใน DIB ผ่าน Java" h2="สร้างแอป Java ของคุณเองเพื่อเปลี่ยนพื้นหลังในไฟล์ DIB โดยใช้ API ฝั่งเซิร์ฟเวอร์" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/imaging/aspose_imaging-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="DIB" pfName="Aspose.Imaging" subTitlepfName="สำหรับ Java" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/feature-section-col title="ขั้นตอนในการเปลี่ยนพื้นหลังใน DIBs ผ่าน Java" %}}
...
{{% blocks/products/pf/agp/code-block title="เปลี่ยนพื้นหลังในรูปภาพ DIB - Java" offSpacer="" %}}
