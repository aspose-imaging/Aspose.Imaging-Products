---
title: แปลงเอกสาร TGA ผ่าน Java 
weight: 3920
url: /th/java/dither/tga/ 
lang: th
langdirlevel: 2
...
{{< blocks/products/pf/upper-banner h1="กำหนด TGA ผ่าน Java" h2="สร้างแอป Java ของคุณเองให้เป็นไฟล์  ปรับให้เรียบ TGA โดยใช้ API ฝั่งเซิร์ฟเวอร์" logoImageSrc="/imaging/images/imaging/aspose_imaging-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="TGA" pfName="Aspose.Imaging" subTitlepfName="สำหรับ Java" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/content h2="วิธีการ ปรับให้เรียบ TGA ไฟล์โดยใช้ Java" %}}
...
{{% blocks/products/pf/agp/code-block title="แปลงรูปภาพ TGA - Java" offSpacer="" %}}
