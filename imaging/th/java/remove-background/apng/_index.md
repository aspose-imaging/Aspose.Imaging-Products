---
title: ลบพื้นหลังในเอกสาร APNG ผ่าน Java 
weight: 3920
url: /th/java/remove-background/apng/ 
lang: th
langdirlevel: 2
...
{{% blocks/products/pf/agp/feature-section-col title="ขั้นตอนในการลบพื้นหลังจาก APNG ผ่าน Java" %}}
...
{{% blocks/products/pf/agp/code-block title="ลบพื้นหลังในรูปภาพ APNG - Java" offSpacer="" %}}
