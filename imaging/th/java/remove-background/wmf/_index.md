---
title: ลบพื้นหลังในเอกสาร WMF ผ่าน Java 
weight: 3920
url: /th/java/remove-background/wmf/ 
lang: th
langdirlevel: 2
...
{{% blocks/products/pf/agp/feature-section-col title="ขั้นตอนในการลบพื้นหลังจาก WMF ผ่าน Java" %}}
...
{{% blocks/products/pf/agp/code-block title="ลบพื้นหลังในรูปภาพ WMF - Java" offSpacer="" %}}
