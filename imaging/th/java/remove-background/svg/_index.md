---
title: ลบพื้นหลังในเอกสาร SVG ผ่าน Java 
weight: 3920
url: /th/java/remove-background/svg/ 
lang: th
langdirlevel: 2
locales: ja,it,zh-hant,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko,zh-hans,ar,hi,th,sv,cs,uk,he
description: ลองใช้ API เอกสารภายในองค์กรของเราเพื่อเปลี่ยนพื้นหลังจากไฟล์ SVG บนแอปพลิเคชัน Java
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="ลบพื้นหลังจาก SVG ผ่าน Java" h2="สร้างแอป Java ของคุณเองเพื่อลบพื้นหลังออกจากไฟล์ SVG โดยใช้ API ฝั่งเซิร์ฟเวอร์" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/imaging/aspose_imaging-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="SVG" pfName="Aspose.Imaging" subTitlepfName="สำหรับ Java" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/feature-section-col title="ขั้นตอนในการลบพื้นหลังจาก SVG ผ่าน Java" %}}
...
{{% blocks/products/pf/agp/code-block title="ลบพื้นหลังในรูปภาพ SVG - Java" offSpacer="" %}}
