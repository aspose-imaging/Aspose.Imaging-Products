---
title: ลบพื้นหลังในเอกสาร DICOM ผ่าน Java 
weight: 3920
url: /th/java/remove-background/dicom/ 
lang: th
langdirlevel: 2
...
{{% blocks/products/pf/agp/feature-section-col title="ขั้นตอนในการลบพื้นหลังจาก DICOM ผ่าน Java" %}}
...
{{% blocks/products/pf/agp/code-block title="ลบพื้นหลังในรูปภาพ DICOM - Java" offSpacer="" %}}
