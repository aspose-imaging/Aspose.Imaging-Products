---
title: แปลง CDR เป็น PSD ผ่าน C# 
weight: 3920
url: /th/net/conversion/cdr-to-psd/ 
lang: th
langdirlevel: 2
locales: ja,it,zh-hant,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko,zh-hans,ar,hi,th,sv,cs,uk,he
description: โค้ดตัวอย่างสำหรับการแปลง CDR ถึง PSD C# ใช้โค้ดตัวอย่าง API สำหรับไฟล์แบทช์ CDR เป็นการแปลง PSD ภายใน VB.NET, Asp.NET หรือแอปพลิเคชันที่ใช้ .NET
---
...
{{% blocks/products/pf/agp/content h2="วิธีแปลง CDR เป็น PSD โดยใช้ C#" %}}

ในการแปลง CDR เป็น PSD เราจะใช้ [Aspose.Imaging for .NET](https://products.aspose.com/imaging/net) API ซึ่งเป็น API การจัดการและการแปลงรูปภาพที่มีคุณลักษณะหลากหลาย มีประสิทธิภาพ และใช้งานง่ายสำหรับแพลตฟอร์ม C# เปิด [NuGet](https://www.nuget.org/packages/aspose.imaging) ตัวจัดการแพ็คเกจ ค้นหา
...
{{% blocks/products/pf/agp/feature-section-col title="ขั้นตอนในการแปลง CDR เป็น PSD ผ่าน C#" %}}
...
{{% blocks/products/pf/agp/code-block title="แปลง CDR เป็น PSD - .NET" offSpacer="true" %}}
