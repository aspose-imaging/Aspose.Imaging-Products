---
title: แปลงเอกสาร DICOM ผ่าน Python 
weight: 3920
url: /th/python-net/dither/dicom/ 
lang: th
langdirlevel: 2
...
{{% blocks/products/pf/agp/content h2="วิธีการ ปรับให้เรียบ DICOM ไฟล์โดยใช้ Python" %}}
...
{{% blocks/products/pf/agp/code-block title="แปลงรูปภาพ DICOM - Python" offSpacer="" %}}
