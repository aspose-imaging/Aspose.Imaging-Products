---
title: ลายน้ำ BMP เอกสารผ่าน Python 
weight: 3920
url: /th/python-net/watermark/bmp/ 
lang: th
langdirlevel: 2
...
{{< blocks/products/pf/upper-banner h1="เพิ่มลายน้ำข้อความใน BMP ผ่าน Python" h2="สร้างแอป Python ของคุณเองเพื่อใส่ลายน้ำไฟล์ BMP โดยใช้ API ฝั่งเซิร์ฟเวอร์" logoImageSrc="/imaging/images/imaging/aspose_imaging-for-python-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="BMP" pfName="Aspose.Imaging" subTitlepfName="สำหรับ Python" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/feature-section-col title="ขั้นตอนในการเพิ่มลายน้ำให้กับ BMP ผ่าน Python" %}}
...
{{% blocks/products/pf/agp/code-block title="ภาพลายน้ำ BMP - Python" offSpacer="" %}}
