---
title: การแปลงรูปภาพ JP2 เป็น APNG ด้วย Python 
weight: 3920
url: /th/python-net/conversion/jp2-to-apng/ 
lang: th
langdirlevel: 2
locales: ja,it,zh-hant,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko,zh-hans,ar,hi,th,sv,cs,uk,he
description: วิธีใช้ Python สำหรับการแปลงรูปภาพและภาพถ่ายจาก JP2 เป็น APNG บนเดสก์ท็อปและเว็บแอปพลิเคชัน
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="ใช้ Python สำหรับการแปลงรูปภาพจาก JP2 เป็น APNG" h2="สร้างแอป Python เพื่อแปลง JP2 เป็น APNG รูปภาพและรูปภาพผ่าน API ของเซิร์ฟเวอร์" logoImageSrc="/imaging/images/imaging/aspose_imaging-for-python-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="APNG" pfName="Aspose.Imaging" subTitlepfName="สำหรับ Python" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="APNG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="ขั้นตอนในการแปลง JP2 เป็น APNG ผ่าน Python" %}}
...
{{% blocks/products/pf/agp/code-block title="แปลง JP2 เป็น APNG - Python" offSpacer="true" %}}
