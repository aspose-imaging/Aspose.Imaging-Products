---
title: แปลง JP2 เป็น JPG โดยใช้ Python 
weight: 3920
url: /th/python-net/conversion/jp2-to-jpg/ 
lang: th
langdirlevel: 2
locales: ja,it,zh-hant,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko,zh-hans,ar,hi,th,sv,cs,uk,he
description: โค้ดตัวอย่างสำหรับการแปลงภาษา Python จาก JP2 เป็น JPG ใช้โค้ดตัวอย่าง API ที่นำเสนอเพื่อประมวลผลการแปลง JP2 เป็น JPG โดยใช้แอปพลิเคชันที่ใช้ภาษา Python ของเว็บหรือเดสก์ท็อป
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="แปลง JP2 เป็น JPG โดยใช้ภาษา Python" h2="แปลง JP2 เป็น JPG โดยใช้ API ภาษาดั้งเดิมของ Python และไม่จำเป็นต้องใช้โปรแกรมแก้ไขรูปภาพหรือไลบรารีของบุคคลที่สาม" logoImageSrc="/imaging/images/imaging/aspose_imaging-for-python-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="JPG" pfName="Aspose.Imaging" subTitlepfName="สำหรับ Python" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="APNG" >}}
...
{{% blocks/products/pf/agp/content h2="วิธีแปลง JP2 เป็น JPG โดยใช้ Python" %}}

ในการแปลง JP2 เป็น JPG เราจะใช้ [Aspose.Imaging สำหรับ Python ผ่าน .NET](/imaging/th/python-net) API ซึ่งเป็น API การจัดการรูปภาพและการแปลงที่มีคุณลักษณะหลากหลาย ทรงพลัง และใช้งานง่ายสำหรับแพลตฟอร์ม Python คุณสามารถติดตั้งได้โดยใช้คำสั่งต่อไปนี้จากคำสั่งระบบของคุณ
