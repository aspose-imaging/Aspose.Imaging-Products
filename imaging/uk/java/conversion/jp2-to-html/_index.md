...
{{% blocks/products/pf/agp/feature-section-col title="Кроки для перетворення JP2 у HTML за допомогою Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Перетворити JP2 на HTML - Java" offSpacer="" %}}
