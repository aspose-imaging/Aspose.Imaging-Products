---
title: Документи чорно-бiлi WEBP через Java 
weight: 3920
url: /uk/java/grayscale/webp/ 
lang: uk
langdirlevel: 2
locales: zh-hans,ja,it,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko,zh-hant,ar,hi,th,sv,cs,uk,he
description: Спробуйте наші локальні API документів для файлів у відтінках сірого WEBP у .NET Framework, .NET Core, Windows Application, ASP.NET Web Application.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Грейскейл WEBP через Java" h2="Створюйте власні програми Java для грейскейлу файлів WEBP за допомогою API на стороні сервера." logoImageSrc="/imaging/images/imaging/aspose_imaging-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="WEBP" pfName="Aspose.Imaging" subTitlepfName="для Java" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Кроки грейскейлу WEBP через Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Зображення у відтінках сірого WEBP - Java" offSpacer="" %}}
