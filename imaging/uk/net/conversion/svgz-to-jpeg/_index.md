...
{{% blocks/products/pf/agp/feature-section-col title="Кроки для перетворення SVGZ у JPEG за допомогою C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Перетворити SVGZ на JPEG - .NET" offSpacer="true" %}}
