---
title: Перетворіть DNG на PDF за допомогою C# 
weight: 3920
url: /uk/net/conversion/dng-to-pdf/ 
lang: uk
langdirlevel: 2
locales: ja,it,zh-hant,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko,zh-hans,ar,hi,th,sv,cs,uk,he
description: Зразок коду для перетворення DNG у PDF C#. Використовуйте приклад коду API для пакетного перетворення файлів DNG у PDF у VB.NET, Asp.NET або будь-якій програмі на основі .NET.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Перетворіть DNG на PDF за допомогою C#" h2="Перетворіть DNG у PDF за допомогою власних API .NET, не потребуючи будь-якого редактора зображень або сторонніх бібліотек." logoImageSrc="/imaging/images/imaging/aspose_imaging-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="Aspose.Imaging" subTitlepfName="для .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="APNG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Кроки для перетворення DNG у PDF за допомогою C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Перетворити DNG на PDF - .NET" offSpacer="true" %}}
