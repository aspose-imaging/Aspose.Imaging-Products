---
title: Перетворіть DICOM на SVG за допомогою C# 
weight: 3920
url: /uk/net/conversion/dicom-to-svg/ 
lang: uk
langdirlevel: 2
locales: ja,it,zh-hant,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko,zh-hans,ar,hi,th,sv,cs,uk,he
description: Зразок коду для перетворення DICOM у SVG C#. Використовуйте приклад коду API для пакетного перетворення файлів DICOM у SVG у VB.NET, Asp.NET або будь-якій програмі на основі .NET.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Перетворіть DICOM на SVG за допомогою C#" h2="Перетворіть DICOM у SVG за допомогою власних API .NET, не потребуючи будь-якого редактора зображень або сторонніх бібліотек." logoImageSrc="/imaging/images/imaging/aspose_imaging-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="SVG" pfName="Aspose.Imaging" subTitlepfName="для .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="APNG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Кроки для перетворення DICOM у SVG за допомогою C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Перетворити DICOM на SVG - .NET" offSpacer="true" %}}
