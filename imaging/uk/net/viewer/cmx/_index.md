---
title: Перегляд документів CMX через .NET 
weight: 3920
url: /uk/net/viewer/cmx/ 
lang: uk
langdirlevel: 2
...
{{< blocks/products/pf/upper-banner h1="Переглянути CMX через C#" h2="Створюйте власні програми .NET для перегляду файлів CMX за допомогою API на стороні сервера." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/imaging/aspose_imaging-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="CMX" pfName="Aspose.Imaging" subTitlepfName="для .NET" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/content h2="Як переглядати зображення CMX за допомогою C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Кроки для перегляду CMX через C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Переглянути зображення CMX - .NET" offSpacer="" %}}
