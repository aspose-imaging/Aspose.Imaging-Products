---
title: Перегляд документів TGA через .NET 
weight: 3920
url: /uk/net/viewer/tga/ 
lang: uk
langdirlevel: 2
...
{{< blocks/products/pf/upper-banner h1="Переглянути TGA через C#" h2="Створюйте власні програми .NET для перегляду файлів TGA за допомогою API на стороні сервера." logoImageSrc="/imaging/images/imaging/aspose_imaging-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="TGA" pfName="Aspose.Imaging" subTitlepfName="для .NET" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Кроки для перегляду TGA через C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Переглянути зображення TGA - .NET" offSpacer="" %}}
