---
title: Перетворіть HEIC на WEBP за допомогою C# 
weight: 3920
url: /uk/adapters/net/heic-to-webp/ 
lang: uk
langdirlevel: 2
locales: ja,it,zh-hant,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko,zh-hans,ar,hi,th,sv,cs,uk,he
description: Використання Aspose.Imaging.Pdf.Adapter із зразками зображень коду та перетворення документів за допомогою C#. Приклад коду API для пакетного перетворення файлів HEIC у WEBP за допомогою будь-якої програми на основі .NET.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Перетворіть файли HEIC у WEBP за допомогою адаптера через C#" h2="Перетворюйте документи HEIC у WEBP за допомогою власних API .NET без використання редактора зображень" logoImageSrc="/imaging/images/imaging/aspose_imaging-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="WEBP" pfName="Aspose.Imaging" subTitlepfName="для .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="APNG" >}}
...
{{% blocks/products/pf/agp/content h2="Як перетворити HEIC на WEBP за допомогою C#" %}}
...
<li>Підтримує популярні формати, зокрема HEIC і WEBP.</li>
</ul>

<p align="justify" style="font-size:18px;text-indent:50px;">Щоб перетворити HEIC на WEBP, ми використаємо Aspose.Imaging <a href="https://products.aspose.com/imaging/adapters/net">Aspose.Imaging.Heic.Adapter</a> API, який є багатофункціональним, потужним і простим у використанні API для обробки зображень і перетворення для платформи C#. ВІДЧИНЕНО <a href="https://www.nuget.org/packages/Aspose.Imaging.Pdf.Adapter">Nuget</a> менеджер пакетів, знайдіть «Aspose.Imaging Pdf.Adapter» і встановіть. Ви також можете використати наступну команду з консолі менеджера пакетів.</p>
...
{{% blocks/products/pf/agp/feature-section-col title="Кроки для перетворення HEIC у WEBP за допомогою C#" %}}

{{% blocks/products/pf/agp/text %}}

Розробники можуть легко завантажити та перетворити файли HEIC у WEBP лише за кілька рядків коду.
...
+ Створіть необхідний екземпляр класу параметрів збереження для формату WEBP і встановіть необхідні властивості.
+ Збережіть WEBP за допомогою методу Aspose.Imaging.Image.Save(), вказавши шлях до файлу або потік разом із параметрами.
...
{{% blocks/products/pf/agp/code-block title="Перетворити HEIC на WEBP - .NET" offSpacer="true" %}}
