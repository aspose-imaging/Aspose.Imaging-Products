...
description: Створюйте маніпуляції та конвертуйте зображення за допомогою відповідної бібліотеки в програмах .NET Java і SharePoint. Зберігайте зображення у форматах PhotoShop
---
...
Цільова програма Windows Forms, ASP.NET, WPF, WCF або будь-який тип програми на основі .NET Framework 2.0 або новішої версії.
...
Власні Java API для настільного комп’ютера, Інтернету чи будь-якої програми на основі Java SE або EE.
{{< /blocks/products/pf/product >}}
...
Перетворення зображень у SharePoint Foundation або Server.
{{< /blocks/products/pf/product >}}
...
Експорт звітів у кілька форматів зображень із JasperReports.
{{< /blocks/products/pf/product >}}

{{< blocks/products/pf/product pfName="Aspose.Imaging for" title="Python via .NET" imgSrc="/imaging/images/imaging/aspose_imaging-for-python-net.svg" productLink="/imaging/uk/python-net/" >}}
Завантажуйте, створюйте, зберігайте та маніпулюйте різними форматами файлів зображень за допомогою Python.
{{< /blocks/products/pf/product >}}
