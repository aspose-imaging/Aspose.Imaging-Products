...
{{< blocks/imaging-app-widget
        sectionTitle="Бесплатное приложение для конвертации изображений EMZ в CANVAS"
        appName="Conversion"
...
{{% blocks/products/pf/agp/code-block title="Преобразование EMZ в CANVAS - Python" offSpacer="true" %}}
