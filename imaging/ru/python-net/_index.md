---
title: API обработки изображений Python | Aspose.Imaging for Python через .NET — рисование, управление и преобразование изображений 
weight: 960
url: /ru/python-net/ 
lang: ru
langdirlevel: 2
locales: zh-hans,ja,it,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko,zh-hant,ar,hi,th,sv,cs,uk,he
description: Библиотека обработки и обработки изображений Python. Aspose.Imaging для Python через .NET позволяет создавать, загружать, просматривать, редактировать, рисовать или преобразовывать изображения в различные форматы в приложениях без какого-либо редактора изображений.
---

{{< blocks/products/pf/main-wrap-class>}}
{{< blocks/products/pf/upper-banner h1="Aspose.Imaging для Python via .NET и API для обработки изображений" h2="Создавайте, загружайте, манипулируйте или конвертируйте изображения, не требуя какого-либо редактора изображений." downloadFreeTrialText="Скачать бесплатную пробную версию" logoImageSrc="/imaging/images/imaging/headers/aspose_imaging-for-python-net.svg"  pfName="Aspose.Imaging" subTitlepfName="for Python" downloadUrl="https://downloads.aspose.com/imaging/python-net/" >}}
...
<p align="justify">
 Aspose.Imaging for Python via .NET — это библиотека, предлагающая расширенные функции обработки изображений. Вы можете легко создавать, загружать, манипулировать, конвертировать или сжимать изображения с помощью этого API. Также Aspose.Imaging for Python через .NET поддерживает рисование и работу с графическими примитивами. Экспорт и преобразование изображений — одна из основных функций API наряду с преобразованиями изображений (изменение размера, обрезка, переворачивание и поворот, бинаризация, оттенки серого, настройка), расширенными функциями обработки изображений (фильтрация, сглаживание, маскирование, выравнивание).
</p>

<p align="justify">
 Aspose.Imaging для Python via .NET — это API, способный обрабатывать часто используемые форматы изображений и поддерживающий некоторые специальные форматы, такие как DjVu, DICOM, WebP и DNG.
</p>
...
<div class="diagram1 d1-python">
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="API изображений Python" src="/imaging/images/imaging/aspose_imaging-for-python-net.svg"/>
  <header>
   Aspose.Imaging
  </header>
  <footer>
...
{{< blocks/products/pf/carousel-item h3="" description="Aspose.Imaging for Python via .NET доступен для:" >}}
<div class="diagram1 d1-python">
 <div class="d1-row">
  <div class="d1-col d1-left">
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="Python API обработки изображений" src="/imaging/images/imaging/aspose_imaging-for-python-net.svg"/>
  <header>
   Aspose.Imaging
  </header>
  <footer>
...
{{< blocks/products/pf/carousel-item h3="" description="Aspose.Imaging для Python поддерживает различные изображения [форматы файлов](https://docs.aspose.com/imaging/python-net/supported-file-formats/)." >}}
<div class="diagram1 d2 d1-python">
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="Процессор изображений C# Редактировать фото Редактировать изображение" src="/imaging/images/imaging/aspose_imaging-for-python-net.svg"/>
  <header>
   Aspose.Imaging
  </header>
  <footer>
 ...
 <div class="row">
  <div class="container">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
    <a href="/imaging/ru/python-net/conversion/">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
    <a href="/imaging/ru/python-net/crop/">
     Обрезать
    </a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
    <a href="/imaging/ru/python-net/resize/">
     Изменить размер
    </a>
    </p>
   </div>
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
    <a href="/imaging/ru/python-net/remove-background/">    
     Удалить фон
    </a>
    </p>
   </div>
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="/imaging/ru/python-net/change-background/">
     Изменить фон
     </a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="/imaging/ru/python-net/watermark/">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="/imaging/ru/python-net/viewer/">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="/imaging/ru/python-net/compress/">
     Сжатие
     </a>
    </p>
   </div>
<div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="/imaging/ru/python-net/merge/">
...
<div class="col-lg-12">
  <h2 class="h2title">Различные фильтры изображений и эффекты</h2>
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="/imaging/ru/python-net/dither/">
     Сглаживание
     </a>
    </p>
   </div>
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="/imaging/ru/python-net/grayscale/">
     Черно-белое
     </a>
    </p>
   </div>
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="/imaging/ru/python-net/filter/">
     Фильтрация
     </a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="/imaging/ru/python-net/cartoonify/">
     Мультипликация
     </a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="/imaging/ru/python-net/binarize/">
     Бинаризация
     </a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="/imaging/ru/python-net/adjust/">
...
<p>Еще одна многообещающая функция, которую предоставляет Aspose.Imaging for Python, — это регистрация пользовательских форматов изображений. Aspose.Imaging for .NET позволяет разработчикам регистрировать новые пользовательские форматы файлов для создания, открытия или экспорта с помощью одной из библиотек реестра Aspose.Imaging for .NET для соответствующей операции. Эта функция позволяет добавлять новые форматы файлов, которые можно использовать для рисования и экспорта.</p>
...
{{< blocks/products/pf/slr-element name="Документация" href="https://docs.aspose.com/imaging/python-net/" >}}
{{< blocks/products/pf/slr-element name="Исходный код" href="https://github.com/aspose-imaging/Aspose.Imaging-for-Python-net/" >}}
{{< blocks/products/pf/slr-element name="Ссылки на API" href="https://apireference.aspose.com/python-net/imaging/" >}}
...
{{< blocks/products/pf/slr-element name="Примечания к выпуску" href="https://releases.aspose.com/imaging/python-net/release-notes/" >}}
{{< /blocks/products/pf/slr-tab >}}

{{< blocks/products/pf/slr-tab tabTitle="Почему Aspose.Imaging для Python" tabId="success-stories" >}}
...
{{< blocks/products/pf/download-section downloadFreeTrialLink="https://downloads.aspose.com/imaging/python-net/" downloadFreeTrialText="Скачать бесплатную пробную версию" pricingInformationText="Информация о стоимости" pricingInformationLink="https://purchase.aspose.com/pricing/imaging/python-net/" >}}
