...
<li>
Реализуйте преобразование из или в желаемый формат изображения из <a href="https://docs.aspose.com/imaging/net/supported-file-formats/">списка форматов, поддерживаемых Aspose.Imaging</a>, используя примеры конверсий с этой и дочерних страниц;
</li>
<li>
Используйте приобретенную лицензию, чтобы <a href="https://docs.aspose.com/imaging/net/licensing/">установить лицензию</a>.
</li>
</ul>
<i><b>Какие платформы поддерживаются?</b></i> <br/>
Платформы NETStandard2.0 и выше подходят для лицензирования преобразования;<br/>
<i><b>Что произойдет, если я использую точки входа API, которые не лицензируются приобретенной лицензией на преобразование?</b></i><br/>
Библиотека будет работать в trial режиме.<br/>
<i><b>Как узнать, какие точки входа API подходят для моей лицензии по конверсиям?</b></i><br/>
Пожалуйста, изучите фрагменты кода на этой и дочерних страницах.<br/>
<i><b>Я не уверен, нужна ли мне лицензия для конверсий. Могу ли я посмотреть демонстрацию в реальном времени?</b></i><br/>
...
<li>
<a href="https://products.aspose.com/imaging/ru/net/resize/">Aspose.Imaging Image Resize</a> — позволяет изменять размер изображения, подгоняя его под нужные размеры, используя поддерживаемые алгоритмы изменения размера. Вы также можете уменьшить или увеличить свои изображения.
</li>
<li>
...
<i><b>Могу ли я использовать другие продукты Aspose таким же образом?</b></i><br/>
Обязательно посетите <a href="https://aspose.market">https://aspose.market</a>, чтобы узнать о доступных возможностях модульного лицензирования.
