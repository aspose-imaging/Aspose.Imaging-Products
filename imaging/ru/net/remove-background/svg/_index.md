---
title: Удалить фон в документах SVG с помощью .NET 
weight: 3920
...
{{< blocks/products/pf/upper-banner h1="Удалить фон из SVG с помощью C#" h2="Создавайте собственные приложения .NET для удаления фона из файлов SVG с помощью серверных API" logoImageSrc="/imaging/images/imaging/aspose_imaging-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="SVG" pfName="Aspose.Imaging" subTitlepfName="для .NET" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
