...
description: Использование Aspose.Imaging.Heic.Adapter для конвертации изображений и документов на C#. Пример кода API для пакетного преобразования файлов HEIC в JPG в любом приложении на основе .NET.
---
