---
title: Конвертируйте PNG в WORD с помощью C# 
weight: 3920
url: /ru/adapters/net/png-to-word/ 
lang: ru
langdirlevel: 2
locales: ja,it,zh-hant,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko,zh-hans,ar,hi,th,sv,cs,uk,he
description: Использование Aspose.Imaging.Pdf.Adapter для конвертации изображений и документов на C#. Пример кода API для пакетного преобразования файлов PNG в WORD в любом приложении на основе .NET.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Конвертация файлов PNG в WORD с помощью адаптера на C#" h2="Преобразуйте PNG в документы WORD с помощью собственных API-интерфейсов .NET без необходимости использования какого-либо редактора изображений" logoImageSrc="/imaging/images/imaging/aspose_imaging-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="WORD" pfName="Aspose.Imaging" subTitlepfName="для .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="APNG" >}}
...
{{% blocks/products/pf/agp/content h2="Как конвертировать PNG в WORD с помощью C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Действия по преобразованию PNG в WORD с помощью C#" %}}

{{% blocks/products/pf/agp/text %}}

Разработчики могут легко загружать и конвертировать файлы PNG в WORD всего за несколько строк кода.

{{% /blocks/products/pf/agp/text %}}

+ Выполните инициализацию адаптера, с помощью метода Register(), эта операция выполняется единоразово.
+ Загрузите требуемый PNG файл с помощью метода Aspose.Imaging.Image.Load().
...
{{% blocks/products/pf/agp/code-block title="Преобразование PNG в WORD – .NET" offSpacer="true" %}}
