---
title: Конвертируйте HEIC в TIFF с помощью C# 
weight: 3920
url: /ru/adapters/net/heic-to-tiff/ 
lang: ru
langdirlevel: 2
...
{{< blocks/products/pf/upper-banner h1="Конвертация файлов HEIC в TIFF с помощью адаптера на C#" h2="Преобразуйте HEIC в документы TIFF с помощью собственных API-интерфейсов .NET без необходимости использования какого-либо редактора изображений" logoImageSrc="/imaging/images/imaging/aspose_imaging-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="TIFF" pfName="Aspose.Imaging" subTitlepfName="для .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="APNG" >}}
...
{{% blocks/products/pf/agp/content h2="Как конвертировать HEIC в TIFF с помощью C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Действия по преобразованию HEIC в TIFF с помощью C#" %}}

{{% blocks/products/pf/agp/text %}}

Разработчики могут легко загружать и конвертировать файлы HEIC в TIFF всего за несколько строк кода.
...
+ Создайте необходимый экземпляр класса опций сохранения для формата TIFF и задайте необходимые свойства.
+ Выполните сохранение файла TIFF с помощью метода Aspose.Imaging.Image.Save(), в котором в качестве параметров необходимо задать путь к файлу или поток, а так же опции сохранения.
...
{{% blocks/products/pf/agp/code-block title="Преобразование HEIC в TIFF – .NET" offSpacer="true" %}}
