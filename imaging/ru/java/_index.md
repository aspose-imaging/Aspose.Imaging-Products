 ...
 <div class="row">
  <div class="container">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Различные фильтры и эффекты изображения (гаусс, размытие, медиана, оттенки серого, бинаризация, сглаживание и т. д.)
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Обрезать, изменить размер и повернуть-отразить
    </p>
   </div>
   <div class="col-lg-4">
...
{{< blocks/products/pf/slr-element name="Документация" href="https://docs.aspose.com/imaging/net/" >}}
