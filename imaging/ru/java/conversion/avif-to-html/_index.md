...
{{% blocks/products/pf/agp/content h2="Как преобразовать AVIF в HTML с помощью Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Действия по преобразованию AVIF в HTML через Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Преобразование AVIF в HTML - Java" offSpacer="true" %}}
