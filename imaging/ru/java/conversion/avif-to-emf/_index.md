...
{{% blocks/products/pf/agp/content h2="Как преобразовать AVIF в EMF с помощью Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Действия по преобразованию AVIF в EMF через Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Преобразование AVIF в EMF - Java" offSpacer="true" %}}
