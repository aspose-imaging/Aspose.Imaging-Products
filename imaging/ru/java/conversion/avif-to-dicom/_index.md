...
{{% blocks/products/pf/agp/content h2="Как преобразовать AVIF в DICOM с помощью Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Действия по преобразованию AVIF в DICOM через Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Преобразование AVIF в DICOM - Java" offSpacer="true" %}}
