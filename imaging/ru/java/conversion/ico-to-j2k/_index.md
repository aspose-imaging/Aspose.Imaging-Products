...
{{< blocks/imaging-app-widget
        sectionTitle="Бесплатное приложение для конвертации изображений ICO в J2K"
        appName="Conversion"
...
{{% blocks/products/pf/agp/code-block title="Преобразование ICO в J2K - Java" offSpacer="true" %}}
