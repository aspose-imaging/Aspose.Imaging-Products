...
{{% blocks/products/pf/agp/content h2="Как преобразовать AVIF в APNG с помощью Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Действия по преобразованию AVIF в APNG через Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Преобразование AVIF в APNG - Java" offSpacer="true" %}}
