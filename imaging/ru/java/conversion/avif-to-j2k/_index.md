...
{{% blocks/products/pf/agp/content h2="Как преобразовать AVIF в J2K с помощью Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Действия по преобразованию AVIF в J2K через Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Преобразование AVIF в J2K - Java" offSpacer="true" %}}
