---
title: Удалить фон в документах DNG с помощью Java 
weight: 3920
...
{{< blocks/products/pf/upper-banner h1="Удалить фон из DNG с помощью Java" h2="Создавайте собственные приложения Java для удаления фона из файлов DNG с помощью серверных API" logoImageSrc="/imaging/images/imaging/aspose_imaging-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="DNG" pfName="Aspose.Imaging" subTitlepfName="для Java" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
