...
{{% blocks/products/pf/agp/content h2="Cách chia thang độ xám cho hình ảnh và ảnh DICOM bằng Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước để có Thang độ xám DICOM qua Python" %}}
...
{{% blocks/products/pf/agp/code-block title="Hình ảnh thang độ xám DICOM - Python" offSpacer="" %}}
