...
Để chuyển đổi JPG thành JPEG2000, chúng tôi sẽ sử dụng [Aspose.Imaging for Python via .NET](/imaging/vi/python-net) API là API chuyển đổi và thao tác hình ảnh giàu tính năng, mạnh mẽ và dễ sử dụng cho nền tảng Python. Bạn có thể cài đặt nó bằng lệnh sau từ lệnh hệ thống của mình.
...
{{% blocks/products/pf/agp/code-block title="Chuyển đổi JPG thành JPEG2000 - Python" offSpacer="" %}}
