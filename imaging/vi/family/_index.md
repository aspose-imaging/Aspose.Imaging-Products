---
title: Các API vẽ và thao tác hình ảnh .NET Java và SharePoint 
weight: 10
url: /vi/family/ 
lang: vi
langdirlevel: 2
...
{{< blocks/products/pf/upper-banner h1="API hình ảnh để phát triển nền tảng chéo" h2="Các API gốc để vẽ, thao tác, biến đổi và chuyển đổi hình ảnh." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/imaging/aspose_imaging.svg" pfName="Aspose.Imaging" downloadUrl="https://downloads.aspose.com/imaging/" tryOnlineUrl="" downloadFreeTrialText="Tải xuống bản dùng thử miễn phí">}}
...
Chuyển đổi hình ảnh trong SharePoint Foundation hoặc Server.
{{< /blocks/products/pf/product >}}
...
{{< blocks/products/pf/slr-element name="Tài liệu" href="https://docs.aspose.com/imaging/" >}}
{{< blocks/products/pf/slr-element name="Mã nguồn" href="https://github.com/aspose-imaging?tab=repositories" >}}
...
{{< blocks/products/pf/slr-tab tabTitle="Tại sao lại sử dụng Aspose.Imaging Product Family?" tabId="success-stories" >}}
...
{{< blocks/products/pf/download-section downloadFreeTrialLink="https://downloads.aspose.com/imaging/" pricingInformationLink="https://purchase.aspose.com/pricing/imaging/family/" downloadFreeTrialText="Tải xuống bản dùng thử miễn phí" pricingInformationText="Thông tin giá cả">}}
