---
title: Lọc tài liệu J2K qua .NET 
weight: 3920
url: /vi/net/filter/j2k/ 
lang: vi
langdirlevel: 2
locales: zh-hans,ja,it,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko,zh-hant
description: Hãy thử các API tài liệu On-Premise của chúng tôi để lọc tệp J2K trên .NET Framework, .NET Core, Ứng dụng Windows, Ứng dụng web ASP.NET.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Lọc các J2K qua C#" h2="Tạo ứng dụng .NET của riêng bạn để Lọc tệp J2K bằng cách sử dụng API phía máy chủ." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/imaging/aspose_imaging-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="J2K" pfName="Aspose.Imaging" subTitlepfName="cho .NET" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
Để lọc các tệp J2K, chúng tôi sẽ sử dụng
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước để Lọc các J2K qua C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Lọc hình ảnh J2K - .NET" offSpacer="" %}}
