---
title: Hình mờ tài liệu DICOM qua C# 
weight: 3920
url: /vi/net/watermark/dicom/ 
lang: vi
langdirlevel: 2
locales: zh-hans,ja,it,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko,zh-hant
description: Hãy thử các API tài liệu On-Premise của chúng tôi để tạo hình mờ tệp DICOM trên .NET Framework, .NET Core, Ứng dụng Windows, Ứng dụng web ASP.NET.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Thêm hình mờ văn bản vào DICOM qua C#" h2="Tạo ứng dụng .NET của riêng bạn để tạo hình mờ cho tệp DICOM bằng cách sử dụng API phía máy chủ." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/imaging/aspose_imaging-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="DICOM" pfName="Aspose.Imaging" subTitlepfName="cho .NET" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
Để làm mờ tệp DICOM, chúng tôi sẽ sử dụng
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước để thêm hình mờ vào DICOM qua C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Hình mờ DICOM - .NET" offSpacer="" %}}
