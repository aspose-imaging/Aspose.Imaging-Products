...
<div class="diagram1 d1-net">
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="API hình ảnh .NET" src="/imaging/images/imaging/aspose_imaging-for-net.svg"/>
  <header>
   Aspose.Imaging
  </header>
  <footer>
...
<div class="diagram1 d1-net">
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt=".NET API xử lý hình ảnh" src="/imaging/images/imaging/aspose_imaging-for-net.svg"/>
  <header>
   Aspose.Imaging
  </header>
  <footer>
...
<div class="diagram1 d2 d1-net">
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="Bộ xử lý hình ảnh C # Chỉnh sửa ảnh Chỉnh sửa hình ảnh" src="/imaging/images/imaging/aspose_imaging-for-net.svg"/>
  <header>
   Aspose.Imaging
  </header>
  <footer>
...
<div class="col-lg-4">
    ...
    <p class="col-lg-10"><a href="/imaging/vi/net/adapters/">Adapters</a></p>
   </div>    
<div class="col-lg-12">
...
{{< blocks/products/pf/slr-element name="Ghi chú phát hành" href="https://releases.aspose.com/imaging/net/release-notes/" >}}
{{< /blocks/products/pf/slr-tab >}}
