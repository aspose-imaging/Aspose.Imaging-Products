...
{{% blocks/products/pf/agp/content h2="Cách tạo thang độ xám cho tệp AVIF bằng C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước để có Thang độ xám AVIF qua C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Hình ảnh thang độ xám AVIF - .NET" offSpacer="" %}}
