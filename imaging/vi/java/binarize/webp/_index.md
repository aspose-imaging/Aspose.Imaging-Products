---
title: Binarize tài liệu WEBP qua Java 
weight: 3920
url: /vi/java/binarize/webp/ 
lang: vi
langdirlevel: 2
...
{{< blocks/products/pf/upper-banner h1="Binarize WEBP s qua Java" h2="Tạo ứng dụng Java của riêng bạn để Binarize các tệp WEBP bằng cách sử dụng API phía máy chủ." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/imaging/aspose_imaging-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="WEBP" pfName="Aspose.Imaging" subTitlepfName="cho Java" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/content h2="Cách Binarize WEBP Tệp bằng Java" %}}

Để Binarize các tệp WEBP, chúng tôi sẽ sử dụng [Aspose.Imaging cho Java] (https://products.aspose.com/imaging/java) API là một API chuyển đổi và thao tác hình ảnh giàu tính năng, mạnh mẽ và dễ sử dụng cho nền tảng Java. Bạn có thể tải xuống phiên bản mới nhất của nó trực tiếp từ [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-imaging) và cài đặt nó trong dự án dựa trên Maven của bạn bằng cách thêm các cấu hình sau vào pom.xml.
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước để Binarize WEBP qua Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Binarize WEBP hình ảnh - Java" offSpacer="" %}}
