---
title: Xem tài liệu DICOM qua Java 
weight: 3920
url: /vi/java/viewer/dicom/ 
lang: vi
langdirlevel: 2
...
{{< blocks/products/pf/upper-banner h1="Xem DICOM s qua Java" h2="Tạo ứng dụng Java của riêng bạn để Xem các tệp DICOM bằng cách sử dụng API phía máy chủ." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/imaging/aspose_imaging-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="DICOM" pfName="Aspose.Imaging" subTitlepfName="cho Java" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/content h2="Cách xem hình ảnh DICOM bằng Java" %}}

Để xem các tệp DICOM, chúng tôi sẽ sử dụng [Aspose.Imaging cho Java] (https://products.aspose.com/imaging/java) API là một API chuyển đổi và thao tác hình ảnh giàu tính năng, mạnh mẽ và dễ sử dụng cho nền tảng Java. Bạn có thể tải xuống phiên bản mới nhất của nó trực tiếp từ [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-imaging) và cài đặt nó trong dự án dựa trên Maven của bạn bằng cách thêm các cấu hình sau vào pom.xml.
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước để xem DICOM s qua Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Xem hình ảnh DICOM - Java" offSpacer="" %}}
