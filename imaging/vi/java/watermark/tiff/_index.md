---
title: Hình mờ tài liệu TIFF qua Java 
weight: 3920
url: /vi/java/watermark/tiff/ 
lang: vi
langdirlevel: 2
locales: zh-hans,ja,it,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko,zh-hant,ar,hi,th,sv,cs,uk,he
description: Mã chuyển đổi Java mẫu cho định dạng TIFF thành tệp . Sử dụng mã ví dụ này để chuyển đổi TIFF thành  trong bất kỳ ứng dụng dựa trên Java trên Web hoặc Máy tính để bàn nào.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Thêm hình mờ văn bản vào TIFF qua Java" h2="Tạo ứng dụng Java của riêng bạn để tạo hình mờ cho tệp TIFF bằng cách sử dụng API phía máy chủ." logoImageSrc="/imaging/images/imaging/aspose_imaging-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="TIFF" pfName="Aspose.Imaging" subTitlepfName="cho Java" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước để thêm hình mờ vào TIFF qua Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Hình mờ TIFF - Java" offSpacer="" %}}
