---
title: Thay đổi kích thước tài liệu CDR qua Java 
weight: 3920
url: /vi/java/resize/cdr/ 
lang: vi
langdirlevel: 2
locales: ja,it,zh-hant,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko,zh-hans,ar,hi,th,sv,cs,uk,he
description: Hãy thử các API tài liệu On-Premise của chúng tôi để hợp nhất các tệp CDR trên Ứng dụng Java.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Thay đổi kích thước của CDR qua Java" h2="Tạo ứng dụng Java của riêng bạn để thay đổi kích thước tệp CDR bằng cách sử dụng API phía máy chủ." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/imaging/aspose_imaging-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="CDR" pfName="Aspose.Imaging" subTitlepfName="cho Java" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/content h2="Cách thay đổi kích thước tệp CDR bằng Java" %}}

Để thay đổi kích thước tệp CDR, chúng tôi sẽ sử dụng [Aspose.Imaging cho Java] (https://products.aspose.com/imaging/java) API là một API chuyển đổi và thao tác hình ảnh giàu tính năng, mạnh mẽ và dễ sử dụng cho nền tảng Java. Bạn có thể tải xuống phiên bản mới nhất của nó trực tiếp từ [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-imaging) và cài đặt nó trong dự án dựa trên Maven của bạn bằng cách thêm các cấu hình sau vào pom.xml.
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước để thay đổi kích thước của CDR qua Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Thay đổi kích thước hình ảnh CDR - Java" offSpacer="" %}}
