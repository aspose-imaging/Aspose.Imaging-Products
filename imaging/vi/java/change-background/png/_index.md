---
title: Thay đổi nền trong tài liệu PNG qua Java 
weight: 3920
url: /vi/java/change-background/png/ 
lang: vi
langdirlevel: 2
locales: ja,it,zh-hant,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko,zh-hans,ar,hi,th,sv,cs,uk,he
description: Hãy thử các API tài liệu On-Premise của chúng tôi để thay đổi nền từ các tệp PNG trên Ứng dụng Java.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Thay đổi nền trong PNG s qua Java" h2="Tạo ứng dụng Java của riêng bạn để Thay đổi nền trong tệp PNG bằng cách sử dụng API phía máy chủ." logoImageSrc="/imaging/images/imaging/aspose_imaging-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PNG" pfName="Aspose.Imaging" subTitlepfName="cho Java" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước để thay đổi nền trong PNG s qua Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Thay đổi nền trong hình ảnh PNG - Java" offSpacer="" %}}
