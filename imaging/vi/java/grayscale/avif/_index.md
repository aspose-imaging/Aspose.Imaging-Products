---
title: Tài liệu về thang độ xám AVIF qua Java 
weight: 3920
url: /vi/java/grayscale/avif/ 
lang: vi
langdirlevel: 2
...
{{% blocks/products/pf/agp/content h2="Cách tạo thang độ xám cho tệp AVIF bằng Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước để có Thang độ xám AVIF qua Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Hình ảnh thang độ xám AVIF - Java" offSpacer="" %}}
