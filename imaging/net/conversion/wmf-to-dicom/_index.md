---
title: Convert WMF to DICOM via .NET 
weight: 1510
...
{{% blocks/products/pf/agp/content h2="How to Convert WMF to DICOM Using C#" %}}
 ...
 In order to convert WMF to DICOM, we’ll use
...
{{% blocks/products/pf/agp/text %}}
 ...
 Aspose.Imaging makes it easy for the developers to load & convert WMF files to DICOM in just a few lines of code.
...
{{< gist "aspose-com-gists" "2d1bcb9853315458808ffbcd9e7e3e02" "convert-wmf-to-dicom.cs" >}}
{{% /blocks/products/pf/agp/code-block %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Free App to Convert WMF to DICOM" sectionDescription="Check our live demos for [WMF to DICOM conversion](https://products.aspose.app/imaging/conversion/wmf-to-dicom) with following benefits." >}}
