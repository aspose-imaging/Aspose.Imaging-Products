---
title: Convert DICOM to PNG via .NET 
weight: 2690
...
{{% blocks/products/pf/agp/text %}}
 ...
 Aspose.Imaging makes it easy for the developers to load & convert DICOM files to PNG in just a few lines of code.
...
{{< gist "aspose-com-gists" "2d1bcb9853315458808ffbcd9e7e3e02" "convert-dicom-to-png.cs" >}}
{{% /blocks/products/pf/agp/code-block %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Free App to Convert DICOM to PNG" sectionDescription="Check our live demos for [DICOM to PNG conversion](https://products.aspose.app/imaging/conversion/dicom-to-png) with following benefits." >}}
