---
title: Convert DICOM to TIFF via .NET 
weight: 1720
...
{{% blocks/products/pf/agp/content h2="How to Convert DICOM to TIFF Using C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Convert DICOM to TIFF via C#" %}}

{{% blocks/products/pf/agp/text %}}

 Aspose.Imaging makes it easy for the developers to load & convert DICOM files to TIFF in just a few lines of code.
...
{% blocks/products/pf/agp/code-block title="Convert dicom to tiff - .NET" offSpacer="" %}

{{< gist "aspose-com-gists" "2d1bcb9853315458808ffbcd9e7e3e02" "convert-dicom-to-tiff.cs" >}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Free App to Convert DICOM to TIFF" sectionDescription="Check our live demos for [DICOM to TIFF conversion](https://products.aspose.app/imaging/conversion/dicom-to-tiff) with following benefits." >}}
