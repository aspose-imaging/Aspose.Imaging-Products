---
title: Watermark PNG document via .NET 
weight: 2060
url: /net/watermark/png/ 
description: Try our On-Premise document APIs to add or remove watermark to PNG file on .NET Framework, .NET Core, Windows Application, ASP.NET Web Application.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Add Text Watermark to PNG via C#" h2="Build your own .NET apps to watermark PNG files using server-side APIs." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/imaging/aspose_imaging-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PNG" pfName="Aspose.Imaging" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/content h2="How to Watermark PNG File Using C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Add Watermark to PNG via C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Watermark png image - .NET" offSpacer="" %}}

{{< gist "aspose-com-gists" "2d1bcb9853315458808ffbcd9e7e3e02" "watermark-png-image.cs" >}}
