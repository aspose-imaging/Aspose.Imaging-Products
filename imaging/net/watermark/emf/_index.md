---
title: Watermark EMF document via .NET 
weight: 3420
url: /net/watermark/emf/ 
description: Try our On-Premise document APIs to add or remove watermark to EMF file on .NET Framework, .NET Core, Windows Application, ASP.NET Web Application.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Add Text Watermark to EMF via C#" h2="Build your own .NET apps to watermark EMF files using server-side APIs." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/imaging/aspose_imaging-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="EMF" pfName="Aspose.Imaging" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Add Watermark to EMF via C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Watermark emf image - .NET" offSpacer="" %}}

{{< gist "aspose-com-gists" "2d1bcb9853315458808ffbcd9e7e3e02" "watermark-emf-image.cs" >}}
