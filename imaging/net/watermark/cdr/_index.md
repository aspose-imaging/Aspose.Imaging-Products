---
title: Watermark CDR document via .NET 
weight: 2710
url: /net/watermark/cdr/ 
description: Try our On-Premise document APIs to add or remove watermark to CDR file on .NET Framework, .NET Core, Windows Application, ASP.NET Web Application.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Add Text Watermark to CDR via C#" h2="Build your own .NET apps to watermark CDR files using server-side APIs." logoImageSrc="https://www.aspose.com/templates/aspose/App_Themes/V3/images/imaging/272x272/aspose_imaging-for-net.png" sourceAdditionalConversionTag="" additionalConversionTag="CDR" pfName="Aspose.Imaging" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/content h2="How to Watermark CDR File Using C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Add Watermark to CDR via C#" %}}
...
+  Save image to disc in CDR format
...
{{% blocks/products/pf/agp/code-block title="Add Watermark to CDR - C#" offSpacer="" %}}

```cs

// load an existing CDR with Image.Load
