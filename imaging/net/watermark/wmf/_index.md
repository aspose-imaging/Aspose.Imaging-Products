---
title: Watermark WMF document via .NET 
weight: 2920
url: /net/watermark/wmf/ 
description: Try our On-Premise document APIs to add or remove watermark to WMF file on .NET Framework, .NET Core, Windows Application, ASP.NET Web Application.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Add Text Watermark to WMF via C#" h2="Build your own .NET apps to watermark WMF files using server-side APIs." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/imaging/aspose_imaging-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="WMF" pfName="Aspose.Imaging" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/content h2="How to Watermark WMF File Using C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Add Watermark to WMF via C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Watermark wmf image - .NET" offSpacer="" %}}

{{< gist "aspose-com-gists" "2d1bcb9853315458808ffbcd9e7e3e02" "watermark-wmf-image.cs" >}}
