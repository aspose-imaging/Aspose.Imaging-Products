...
{{% blocks/products/pf/agp/content h2="How to Convert CDR to J2K Using C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Convert CDR to J2K via C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Convert CDR to J2K - .NET" offSpacer="" %}}
...
<!-- aboutfile Starts -->
   {{< blocks/products/pf/agp/demobox sectionTitle="Convert CDRs via Online App" sectionDescription="Convert CDR to J2K documents by visiting our [Live Demos website](https://products.aspose.app/imaging/conversion). The live demo has the following benefits" >}}
